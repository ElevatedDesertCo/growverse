...
async function main(): Promise<void> {
          ...
          if (cfg.testChannelId && !announced) {
            ...
            void discord
              .createMessage(cfg.testChannelId, {
                content: `:satellite: Growverse bot online and connected. Two-way sync active. Try \`/whoami\` or \`/link\`. Play at ${cfg.gameUrl}`,
              })
  ...
  console.log('[bot] Growverse Discord bot started');
}
