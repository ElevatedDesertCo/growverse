// Murloc oracles (the Siltling's "Silt Hex") can briefly turn a victim
...
// Spawn a Siltling adjacent to the player, hostile and ready to swing.
...
describe('mob polymorph hex ("Silt Hex")', () => {
  it('seeds the hex mechanic on the Siltling', () => {
  ...
  it('applies a polymorph aura on a landed hit when it rolls', () => {
    ...
    expect(aura!.name).toBe('Silt Hex');
