...
describe('i18n whole-catalog completeness', () => {
  ...
  it('non-Latin locales ship no untranslated English (only brand/URL leaves stay identical)', () => {
    const BRAND_ALLOW = new Set([
      'footer.copyright', // "{year} Growverse" - brand
      'footer.githubLink', // repository URL
      'fiesta.bracket', // "Fiesta" event brand
      'serverUnavailable.logoAlt', // "Growverse" logo alt text - brand
      'guide.brand', // "Growverse" - brand (Guide)
      'guide.brandShort', // "Growverse" - brand (Guide)
      'guide.home.title', // "Growverse" - brand (Guide hero)
      'guide.footer.rights', // "Growverse" - brand (Guide footer)
      'hudChrome.discord.title', // "Discord" - brand
      'hudChrome.discord.open', // "Discord" - brand
      'hudChrome.discord.panelTitle', // "Growverse" - brand
