...
// it lands the matching edit here in the SAME commit. The count pins (155 / 38 / 117)
...
// Partition: 38 `data` + 117 `method` (read-returning + command-void + 3 async).
...
export const IWORLD_MEMBERS = [
  ...
  // IWorldCultivation: the garden read + plant/harvest commands.
