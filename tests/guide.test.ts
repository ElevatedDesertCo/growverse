...
describe('Guide entry wiring', () => {
  ...
  it('lists the guide in the sitemap', () => {
    expect(sitemapXml).toContain('<loc>https://growverse.vercel.app/wiki</loc>');
  });
...
describe('guide.html shell', () => {
  ...
  it('ships crawlable canonical + social metadata for /wiki', () => {
    expect(guideHtml).toContain(
      '<link rel="canonical" href="https://growverse.vercel.app/wiki" />',
    );
    expect(guideHtml).toContain(
      '<meta property="og:url" content="https://growverse.vercel.app/wiki" />',
    );
