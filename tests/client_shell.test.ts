...
describe('client HTML shell', () => {
  ...
  it('ships crawlable SEO metadata and sitemap hints', () => {
    ...
    expect(html).toContain('<link rel="canonical" href="https://growverse-iota.vercel.app/" />');
    ...
    expect(robotsTxt.trim()).toBe(
      'User-agent: *\nAllow: /\n\nSitemap: https://growverse-iota.vercel.app/sitemap.xml\nSitemap: https://growverse-iota.vercel.app/sitemap-characters.xml',
    );
    expect(robotsTxt).toContain('Sitemap: https://growverse-iota.vercel.app/sitemap.xml');
    // The dynamic per-character sitemap (served by the game server) is advertised too.
    expect(robotsTxt).toContain(
      'Sitemap: https://growverse-iota.vercel.app/sitemap-characters.xml',
    );
    expect(sitemapXml).toContain('<loc>https://growverse-iota.vercel.app/</loc>');
    expect(sitemapXml).toContain('<loc>https://growverse-iota.vercel.app/links</loc>');
    expect(sitemapXml).toContain('<loc>https://growverse-iota.vercel.app/play</loc>');
    expect(playHtml).toContain(
      '<link rel="canonical" href="https://growverse-iota.vercel.app/play" />',
    );
    expect(playHtml).toContain(
      '<meta property="og:url" content="https://growverse-iota.vercel.app/play" />',
    );
    expect(playHtml).toContain('"url": "https://growverse-iota.vercel.app/play"');
    expect(sitemapXml).toContain('<loc>https://growverse-iota.vercel.app/privacy</loc>');
    expect(sitemapXml).toContain('<loc>https://growverse-iota.vercel.app/terms</loc>');
    expect(sitemapXml).toContain('<loc>https://growverse-iota.vercel.app/data-deletion</loc>');
    expect(sitemapXml).toContain('<loc>https://growverse-iota.vercel.app/support</loc>');
    expect(privacyHtml).toContain(
      '<link rel="canonical" href="https://growverse-iota.vercel.app/privacy" />',
    );
    ...
    expect(termsHtml).toContain(
      '<link rel="canonical" href="https://growverse-iota.vercel.app/terms" />',
    );
    ...
    expect(dataDeletionHtml).toContain(
      '<link rel="canonical" href="https://growverse-iota.vercel.app/data-deletion" />',
    );
    ...
    expect(supportHtml).toContain(
      '<link rel="canonical" href="https://growverse-iota.vercel.app/support" />',
    );
