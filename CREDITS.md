...
| Forest Nature Pack (grass tuft ground-dressing, short + tall clumps) | Kay Lousberg (KayKit) | https://kaylousberg.itch.io/kaykit-forest-nature-pack | CC0 1.0 |
...
| Medieval Village Pack (houses, inn, blacksmith, well, fence) | Quaternius | https://quaternius.com/packs/medievalvillage.html | CC0 1.0 |
...
| Growverse brand art (growverse-logo.png, growverse-logo-hero.webp, growverse-logo-guide.webp, growverse_logo_square.webp, home-bg.png, home-bg.mp4, loading-screen.jpg) | Elevated Desert Co. | AI-generated (gpt-image-2) for the Growverse fork, 2026; video derived with ffmpeg | Project asset |
| Growverse emblem icons (favicon.ico, favicon-16x16.png, favicon-32x32.png, apple-touch-icon.png, icon-192.png, icon-512.png) | Elevated Desert Co. | Project-generated vector art, `scripts/brand/render_logo.mjs` | Project asset |
...
| Growverse procedural props (Ashen Maw ward-totems, war-standard, raider cookfires, raider tents, the churchyard/grave-plot headstones, the Bloomhaven market booths, the mine ore cart, and the ruin-ring columns/statues, generated at runtime in `src/render/props.ts`) | Elevated Desert Co. | Project-generated procedural geometry (Three.js primitives, deterministic) for the Growverse fork, 2026; no source file | Project asset |
