...
if (box && box.width > 0)
  await page.screenshot({ path: 'tmp/interface_settings_panel.png', clip: box });
...
console.log(
  'wrote tmp/interface_settings_panel.png, tmp/interface_settings_full.png, tmp/interface_settings_inworld.png',
);
await browser.close();
