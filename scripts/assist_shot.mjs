...
check(
  after.meTarget === scene.mobId,
  `/assist switched caster's target to ${scene.mobName} (${scene.mobId}) -> got ${after.meTarget}`,
);
await sleep(700);
