...
const expectedAlternates = [
  { hreflang: 'en', href: 'https://growverse-iota.vercel.app/' },
  { hreflang: 'es', href: 'https://growverse-iota.vercel.app/?lang=es' },
  { hreflang: 'es-ES', href: 'https://growverse-iota.vercel.app/?lang=es_ES' },
  { hreflang: 'fr-FR', href: 'https://growverse-iota.vercel.app/?lang=fr_FR' },
  { hreflang: 'fr-CA', href: 'https://growverse-iota.vercel.app/?lang=fr_CA' },
  { hreflang: 'en-CA', href: 'https://growverse-iota.vercel.app/?lang=en_CA' },
  { hreflang: 'it-IT', href: 'https://growverse-iota.vercel.app/?lang=it_IT' },
  { hreflang: 'de-DE', href: 'https://growverse-iota.vercel.app/?lang=de_DE' },
  { hreflang: 'zh-CN', href: 'https://growverse-iota.vercel.app/?lang=zh_CN' },
  { hreflang: 'zh-TW', href: 'https://growverse-iota.vercel.app/?lang=zh_TW' },
  { hreflang: 'ko-KR', href: 'https://growverse-iota.vercel.app/?lang=ko_KR' },
  { hreflang: 'ja-JP', href: 'https://growverse-iota.vercel.app/?lang=ja_JP' },
  { hreflang: 'pt-BR', href: 'https://growverse-iota.vercel.app/?lang=pt_BR' },
  { hreflang: 'ru-RU', href: 'https://growverse-iota.vercel.app/?lang=ru_RU' },
  { hreflang: 'x-default', href: 'https://growverse-iota.vercel.app/' },
];

function audit() {
  console.log('--- Growverse: Local SEO & A11y Audit ---');
  ...
  const hasCanonical =
    html.includes('rel="canonical"') && html.includes('href="https://growverse-iota.vercel.app/"');
  checks.push({
    category: 'SEO',
    ...
    details: hasCanonical
      ? 'Found rel="canonical" pointing to growverse-iota.vercel.app.'
  ...
  const ogImage =
    html.includes('property="og:image"') && html.includes('growverse_logo_square.webp');
