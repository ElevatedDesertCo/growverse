...
# Contribuindo com o Growverse

Antes de tudo, obrigado por estar aqui. O Growverse é construído por
...
pergunte no [Discord](https://discord.gg/KSTJkrCq3) e alguém terá o maior prazer
em ajudar.
...
- **Código.** Corrija um bug, adicione um recurso ou melhore o desempenho. As
  ...
  e [`help wanted`](https://github.com/ElevatedDesertCo/growverse/labels/help%20wanted)
...
- **Relatos de bug e ideias de recursos.** Abra uma [issue](https://github.com/ElevatedDesertCo/growverse/issues/new/choose).
...
O Growverse está disponível em vários idiomas, e nós mantemos as coisas
...
inicie uma thread no [Discord](https://discord.gg/KSTJkrCq3) e nós te ajudamos a
...
Por favor, use os [modelos de issue](https://github.com/ElevatedDesertCo/growverse/issues/new/choose):

- **Relato de bug.** Pesquise antes nas
  [issues existentes](https://github.com/ElevatedDesertCo/growverse/issues)
...
[Discord da comunidade](https://discord.gg/KSTJkrCq3). Nenhuma pergunta é pequena
...
Obrigado por contribuir com o Growverse. Mal podemos esperar para ver o
