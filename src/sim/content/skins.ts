...
export const SKIN_COUNTS: Record<PlayerClass, number> = {
  ...
  rogue: 4,
  priest: 4,
  // mage rides the 1-of-1 custom Meshy "Azure Wizard" body (one baked texture; the
  // KayKit mage alt skins do not map to its UVs), so it has a single canonical look.
  mage: 1,
  warlock: 4,
  shaman: 4,
  druid: 4,
