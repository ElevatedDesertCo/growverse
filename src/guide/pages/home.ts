  ...
  return `
    <section class="guide-section guide-community" aria-labelledby="guide-community-h">
      ...
      <div class="guide-community-cta">
        ...
        <a class="guide-cta guide-cta-ghost" href="https://discord.gg/KSTJkrCq3" target="_blank" rel="noopener">${esc(t('guide.home.community.discord'))}</a>
        <a class="guide-cta guide-cta-ghost" href="https://github.com/ElevatedDesertCo/growverse" target="_blank" rel="noopener">${esc(t('guide.home.community.github'))}</a>
      </div>
    </section>`;
}
