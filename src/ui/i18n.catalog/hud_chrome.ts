...
export const hudChromeStrings = {
  ...
  dailyRewards: {
    ...
    intro:
      'Hold enough GROW in your verified wallet to unlock daily rewards. Earn points with one daily spin and rotating tasks, then climb the daily leaderboard for a share of the prize pool.',
    prize: 'Prize Pool',
    reset: 'Reset',
    endsIn: 'Ends in {time}',
  ...
  nativeUpdate: {
    ...
    body: 'A new version of Growverse is available. Update now for the latest fixes and improvements.',
    bodyWithVersion:
      'Version {version} of Growverse is available. Update now for the latest fixes and improvements.',
    notNow: 'Not now',
    update: 'Update',
  },
