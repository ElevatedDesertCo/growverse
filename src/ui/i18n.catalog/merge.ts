...
const mergeStringsEn = {
  abilityUi: {
    ...
    cast: { fishing: 'Fishing', demonHeal: 'Demon Heal', harvest: 'Harvesting' },
    actionBar: {
...
export const mergeStrings = {
  ...
  es: {
    abilityUi: {
      ...
      cast: { fishing: 'Pesca', demonHeal: 'Sanación demoníaca', harvest: 'Recolectando' },
      actionBar: {
  ...
  fr_FR: {
    abilityUi: {
      ...
      cast: { fishing: 'Pêche', demonHeal: 'Soin démoniaque', harvest: 'Récolte' },
      actionBar: {
  ...
  it_IT: {
    abilityUi: {
      ...
      cast: { fishing: 'Pesca', demonHeal: 'Cura demoniaca', harvest: 'Raccolta' },
      actionBar: {
  ...
  de_DE: {
    abilityUi: {
      ...
      cast: { fishing: 'Angeln', demonHeal: 'Dämonenheilung', harvest: 'Ernten' },
      actionBar: {
  ...
  zh_CN: {
    abilityUi: {
      ...
      cast: { fishing: '钓鱼', demonHeal: '恶魔治疗', harvest: '采集中' },
      actionBar: {
  ...
  zh_TW: {
    abilityUi: {
      ...
      cast: { fishing: '釣魚', demonHeal: '惡魔治療', harvest: '採集中' },
      actionBar: {
  ...
  ko_KR: {
    abilityUi: {
      ...
      cast: { fishing: '낚시', demonHeal: '악마 치유', harvest: '채집 중' },
      actionBar: {
  ...
  ja_JP: {
    abilityUi: {
      ...
      cast: { fishing: '釣り', demonHeal: '悪魔の治癒', harvest: '採集中' },
      actionBar: {
  ...
  pt_BR: {
    abilityUi: {
      ...
      cast: { fishing: 'Pesca', demonHeal: 'Cura demoníaca', harvest: 'Coletando' },
      actionBar: {
  ...
  ru_RU: {
    abilityUi: {
      ...
      cast: { fishing: 'Рыбная ловля', demonHeal: 'Исцеление демона', harvest: 'Сбор' },
      actionBar: {
...
const mergeEntitiesEn = {
  items: mergeNameTranslations(
    ...
    [
      ...
      'Mirejaw Scale Vest',
      "Burrowking's Copper Cudgel",
      'Rift-Gorged Shiv',
      'Rift-Gorged Stompers',
  ...
  quests: {
    q_mogger: {
      ...
      objectives: { 0: { label: 'Grulmaw slain' } },
    },
  },
};
  ...
  es: {
    items: mergeNameTranslations(
      ...
      [
        ...
        'Riendas de la alpaca de Campoalto',
        'Riendas del toro Pielhierro',
        'Riendas del jabalí Lomoespina',
        'Riendas del Zancaflor Verdeante',
      ],
      'item',
    ),
    mobs: mergeNameTranslations(
  ...
  fr_FR: {
    items: mergeNameTranslations(
      ...
      [
        ...
        'Rênes de l’alpaga des Hauts-Champs',
        'Rênes du taureau Peau-de-Fer',
        'Rênes du sanglier Dos-Épineux',
        'Rênes de l’Arpenteur-Fleuri verdoyant',
      ],
      'item',
    ),
    mobs: mergeNameTranslations(
  ...
  it_IT: {
    items: mergeNameTranslations(
      ...
      [
        ...
        'Redini dell’alpaca di Campoalto',
        'Redini del toro Pellediferro',
        'Redini del cinghiale Dorsospino',
        'Redini del Fiorapassi Verdeggiante',
      ],
      'item',
    ),
    mobs: mergeNameTranslations(
  ...
  de_DE: {
    items: mergeNameTranslations(
      ...
      [
        ...
        'Verlans Eidklinge',
        'Zügel des Hochfeld-Alpakas',
        'Zügel des Eisenhautbullen',
        'Zügel des Dornrückenebers',
        'Zügel des Grünen Blütenschreiters',
      ],
      'item',
    ),
    mobs: mergeNameTranslations(
  ...
  pt_BR: {
    items: mergeNameTranslations(
      ...
      [
        ...
        'Rédeas da alpaca de Campoalto',
        'Rédeas do touro Couro-de-Ferro',
        'Rédeas do javali Dorso-Espinhoso',
        'Rédeas do Andarilho-Florido Verdejante',
      ],
      'item',
    ),
    mobs: mergeNameTranslations(
  ...
  ru_RU: {
    items: mergeNameTranslations(
      ...
      [
        ...
        'Поводья альпаки с Верхних полей',
        'Поводья железношкурого быка',
        'Поводья тернистого вепря',
        'Поводья Цветущего Странника',
      ],
      'item',
    ),
    mobs: mergeNameTranslations(
