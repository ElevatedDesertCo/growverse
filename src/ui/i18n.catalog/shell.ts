...
export const shellStrings = {
  en: {
    ...
    a11y: {
      ...
      githubProject: 'Open the Growverse GitHub project',
      discordCommunity: 'Join the Growverse Discord community',
      donateProject: 'Donate to support Growverse',
    },
    loading: {
      world: 'Loading world...',
    ...
    mobilePreflight: {
      ...
      iosOpenStep: 'Open Growverse from the new Home Screen icon.',
      ...
      androidOpenStep: 'Open Growverse from the new icon.',
    ...
    serverUnavailable: {
      title: 'Growverse - Realm Unavailable',
      logoAlt: 'Growverse',
  ...
  es: {
    ...
    a11y: {
      ...
      githubProject: 'Abrir el proyecto de Growverse en GitHub',
      discordCommunity: 'Unirse a la comunidad de Growverse en Discord',
      donateProject: 'Donar para apoyar Growverse',
    },
    loading: {
    ...
    mobilePreflight: {
      ...
      iosOpenStep: 'Abre Growverse desde el nuevo icono de la pantalla de inicio.',
      ...
      androidOpenStep: 'Abre Growverse desde el nuevo icono.',
    ...
    serverUnavailable: {
      title: 'Growverse - Reino no disponible',
      logoAlt: 'Growverse',
  ...
  es_ES: {
    ...
    a11y: {
      ...
      githubProject: 'Abrir el proyecto Growverse en GitHub',
      discordCommunity: 'Unirse a la comunidad de Growverse en Discord',
      donateProject: 'Donar para apoyar Growverse',
    },
    loading: {
  ...
  fr_FR: {
    ...
    a11y: {
      ...
      githubProject: 'Ouvrir le projet Growverse sur GitHub',
      discordCommunity: 'Rejoindre la communauté Growverse sur Discord',
      donateProject: 'Faire un don pour soutenir Growverse',
    },
    loading: {
    ...
    mobilePreflight: {
      ...
      iosOpenStep: "Ouvrez Growverse depuis la nouvelle icône de l'écran d'accueil.",
      androidStandaloneDetail:
      ...
      androidOpenStep: 'Ouvrez Growverse depuis la nouvelle icône.',
    ...
    serverUnavailable: {
      title: 'Growverse - Royaume indisponible',
      logoAlt: 'Growverse',
  ...
  it_IT: {
    seo: {
      ...
      description:
        "Parti per un'avventura epica in Growverse, un micro-MMO in stile classico giocabile direttamente dal browser. Entra in un reame condiviso, fai crescere le classi e sconfiggi i nemici.",
      genre: 'MMORPG',
    ...
    a11y: {
      ...
      githubProject: 'Apri il progetto Growverse su GitHub',
      discordCommunity: 'Entra nella community Discord di Growverse',
      donateProject: 'Fai una donazione per sostenere Growverse',
    },
    loading: {
    ...
    mobilePreflight: {
      ...
      iosOpenStep: 'Apri Growverse dalla nuova icona nella schermata Home.',
      androidStandaloneDetail:
      ...
      androidOpenStep: 'Apri Growverse dalla nuova icona.',
    ...
    serverUnavailable: {
      title: 'Growverse - Reame non disponibile',
      logoAlt: 'Growverse',
  ...
  de_DE: {
    seo: {
      ...
      description:
        'Begib dich in Growverse auf ein episches Abenteuer, ein Micro-MMO im klassischen Stil direkt im Browser. Betritt einen gemeinsamen Realm, steigere Klassen und besiege Gegner.',
      genre: 'MMORPG',
    ...
    a11y: {
      ...
      githubProject: 'Growverse-Projekt auf GitHub öffnen',
      discordCommunity: 'Der Growverse-Community auf Discord beitreten',
      donateProject: 'Spenden, um Growverse zu unterstützen',
    },
    loading: {
    ...
    mobilePreflight: {
      ...
      iosOpenStep: 'Öffne Growverse über das neue Symbol auf dem Home-Bildschirm.',
      ...
      androidOpenStep: 'Öffne Growverse über das neue Symbol.',
    ...
    serverUnavailable: {
      title: 'Growverse - Realm nicht verfügbar',
      logoAlt: 'Growverse',
  ...
  zh_CN: {
    ...
    a11y: {
      ...
      githubProject: '打开 Growverse 的 GitHub 项目',
      discordCommunity: '加入 Growverse 的 Discord 社区',
      donateProject: '捐赠支持 Growverse',
    },
    loading: {
      world: '正在加载世界...',
    ...
    mobilePreflight: {
      ...
      iosOpenStep: '从新的主屏幕图标打开 Growverse。',
  ...
  zh_TW: {
    ...
    a11y: {
      ...
      characterActions: '角色操作',
      githubProject: '開啟 Growverse 的 GitHub 專案',
      discordCommunity: '加入 Growverse 的 Discord 社群',
      donateProject: '捐贈支持 Growverse',
    },
    loading: {
      world: '正在載入世界...',
    ...
    mobilePreflight: {
      ...
      iosOpenStep: '從新的主畫面圖示開啟 Growverse。',
  ...
  ko_KR: {
    ...
    a11y: {
      ...
      githubProject: 'GitHub에서 Growverse 프로젝트 열기',
      discordCommunity: 'Growverse Discord 커뮤니티 참여',
      donateProject: 'Growverse 후원하기',
    },
    loading: {
      world: '세계 불러오는 중...',
    ...
    mobilePreflight: {
      ...
      iosOpenStep: '새 홈 화면 아이콘에서 Growverse를 여세요.',
  ...
  ja_JP: {
    ...
    a11y: {
      ...
      githubProject: 'GitHubでGrowverseプロジェクトを開く',
      discordCommunity: 'GrowverseのDiscordコミュニティに参加',
      donateProject: 'Growverseを支援するために寄付',
    },
    loading: {
      world: '世界を読み込み中...',
    ...
    mobilePreflight: {
      ...
      iosOpenStep: '新しいホーム画面アイコンからGrowverseを開きます。',
  ...
  pt_BR: {
    seo: {
      ...
      description:
        'Embarque em uma aventura épica em Growverse, um micro-MMO de estilo clássico jogável diretamente no navegador. Entre em um reino compartilhado, evolua classes e derrote inimigos.',
      genre: 'MMORPG',
    ...
    a11y: {
      ...
      githubProject: 'Abrir o projeto Growverse no GitHub',
      discordCommunity: 'Entrar na comunidade Growverse no Discord',
      donateProject: 'Doar para apoiar Growverse',
    },
    loading: {
    ...
    mobilePreflight: {
      ...
      iosOpenStep: 'Abra Growverse pelo novo ícone na tela inicial.',
      androidStandaloneDetail:
      ...
      androidOpenStep: 'Abra Growverse pelo novo ícone.',
    ...
    serverUnavailable: {
      title: 'Growverse - Reino indisponível',
      logoAlt: 'Growverse',
