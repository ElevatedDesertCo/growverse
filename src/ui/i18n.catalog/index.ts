...
export const en = {
  ...
  wallet: {
    ...
    holderTiers: {
      ember: { name: 'Seedling', flavor: 'The first seed takes root.' },
      coinbearer: { name: 'Sprout', flavor: 'Green shoots break the soil.' },
      coppercrest: { name: 'Sapling', flavor: 'Roots deepen, branches reach.' },
      silverbound: { name: 'Gardener', flavor: 'A plot of your own, tended daily.' },
      gilded: { name: 'Tender of the Grove', flavor: 'The grove knows your hands.' },
      vaultwarden: { name: 'Cultivator', flavor: 'A cultivator in earnest: 0.01% of all $GROW.' },
      whale: { name: 'Harvester', flavor: 'Your harvests feed the realm: 0.1% of supply.' },
      leviathan: { name: 'Grovekeeper', flavor: 'A living grove answers to you: 1% of supply.' },
      tidelord: { name: 'Bloomwarden', flavor: 'The bloom answers your call: 2% of supply.' },
      stormcaller: { name: 'Verdant', flavor: 'Life gathers at your name: 3% of supply.' },
      krakencrown: { name: 'Sunblessed', flavor: 'Crowned by the sun itself: 4% of supply.' },
      titanforged: { name: 'Rootlord', flavor: 'Roots run beneath the realm: 5% of supply.' },
      starhoard: { name: 'Wildbloom', flavor: 'A bloom that bends starlight: 6% of supply.' },
      voidwarden: { name: 'Evergreen', flavor: 'Seasons turn, you remain: 7% of supply.' },
      realmshaper: { name: 'Groveshaper', flavor: 'You reshape the living realm: 8% of supply.' },
      worldforger: {
        name: 'Worldtree',
  ...
  playerCard: {
    ...
    defaultRealm: 'Growverse',
    brandWordmark: 'GROWVERSE',
    ...
    shareText:
      "I'm forging my legend in Growverse: Level {level} {className}{tierBit}. Join my realm:",
  ...
  // Growverse guild disciplines. Internal ids (warrior/paladin/...) stay stable for
  // the sim; only the displayed discipline name changes. Each maps to a guild energy
  // from the Worldbuilding Bible (Thorn, Bloom, Ember, Spore, Water/Flow, Roots, Desert).
  classes: {
    warrior: 'Thornguard',
    paladin: 'Bloomward',
    hunter: 'Spiritcaller',
    ...
    warlock: 'Sporebinder',
    druid: 'Bloomshaper',
    warriorAria: 'Thornguard discipline',
    paladinAria: 'Bloomward discipline',
    hunterAria: 'Spiritcaller discipline',
    rogueAria: 'Sandrunner discipline',
    priestAria: 'Tidemystic discipline',
    shamanAria: 'Rootspeaker discipline',
    mageAria: 'Embercaster discipline',
    warlockAria: 'Sporebinder discipline',
    druidAria: 'Bloomshaper discipline',
  },
  controls: {
