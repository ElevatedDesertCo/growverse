...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  'seo.officialLabel': 'Growverse 官方網站',
  'seo.officialBody':
  ...
  'hudChrome.professions.title': '專業技能',
  'hudChrome.professions.mining': '採礦',
  'hudChrome.professions.herbalism': '草藥學',
  'hudChrome.professions.logging': '伐木',
  'hudChrome.professions.cultivation': '栽培',
  'hudChrome.professions.fishing': '釣魚',
  'hudChrome.professions.cooking': '烹飪',
  'hudChrome.professions.alchemy': '煉金術',
  'hudChrome.professions.smithing': '鍛造',
  'hudChrome.professions.enchanting': '附魔',
  'hudChrome.professions.extraction': '萃取',
  'hudChrome.professions.breeding': '育種',
  'hudChrome.professions.lockpicking': '開鎖',
  'hudChrome.loadouts.title': '配裝',
  'hudChrome.loadouts.hint': '在天賦面板中儲存裝備與天賦套裝。',
  'hudChrome.loadouts.applyAria': '套用配裝：{name}',
  'hudChrome.overview.tablistAria': '角色面板檢視',
  'hudChrome.overview.gearTab': '角色',
  'hudChrome.overview.overviewTab': '總覽',
  'hudChrome.overview.commune': '公社聲望',
  'hudChrome.overview.sessions': '綻放療程',
  'hudChrome.overview.strains': '品系庫',
  'hudChrome.overview.noSessions': '目前沒有綻放療程。前往煉金實驗室調製一份藥劑。',
  'character.sortBy': '排序',
  ...
  'playerCard.shareText':
    '我正在 Growverse 中鑄就傳說：{level}級 {className}{tierBit}。加入我的伺服器：',
  ...
  'controls.chat': '開啟對話框',
  'seo.title': 'Growverse：經典風格網頁 MMO',
  'seo.description':
    '在 Growverse 展開史詩冒險。這是一款可直接在瀏覽器中遊玩的經典風格微型 MMO。加入持續共享的伺服器，提升職業等級並擊敗敵人。',
  'seo.genre': 'MMORPG',
  'seo.playMode': '多人遊戲',
  ...
  'a11y.githubProject': '開啟 Growverse 的 GitHub 專案',
  'a11y.discordCommunity': '加入 Growverse 的 Discord 社群',
  'a11y.donateProject': '捐贈支持 Growverse',
  ...
  'mobilePreflight.iosOpenStep': '從新的主畫面圖示開啟 Growverse。',
  ...
  'entities.items.bloom_extract.name': '綻放萃取物',
  'entities.items.swirling_healing_draught.name': '漩渦治療藥水',
  'entities.items.swirling_mana_draught.name': '漩渦法力藥水',
  'entities.items.elixir_of_the_bloom.name': '綻放靈藥',
  'entities.items.restful_bloom_tonic.name': '安神綻放藥劑',
  ...
  'entities.npcs.glyphwright_orrin.name': '奧林',
  'entities.npcs.cup_steward_wilder.name': '懷爾德',
  'entities.npcs.cup_steward_wilder.title': '山谷盃司儀',
  'entities.npcs.cup_steward_wilder.greeting':
    '山谷盃開賽了，{className}。帶一個品系和十枚花苞來，我就把你的名字寫上榜。評的是基因、你帶來的品級，還有你對這株植物有多熟。三樣齊全，不然你只是來湊數的。',
  'entities.npcs.extractor_rell.name': '雷爾',
  'entities.npcs.extractor_rell.title': '萃取師',
  'entities.npcs.extractor_rell.greeting':
    '花只是起點，{className}，不是終點。把花苞帶來，我能洗成大麻脂、脆片或鑽石。要是剛從苗床上摘下、還帶著水氣，我們能做出更好的東西。',
  'entities.npcs.glyphwright_orrin.title': '符文匠',
  'entities.npcs.glyphwright_orrin.greeting':
    '任何種植者都能燒掉自己最好的花，{className}。把你的上等花苞和一塊裂隙碎片帶來，我會把兩者綁成一枚可維持半小時的符文。',
  'entities.npcs.alchemist_sable.name': '塞布爾',
  'entities.npcs.alchemist_sable.title': '煉金術士',
  'entities.npcs.alchemist_sable.greeting':
    '{className}，從山谷裡給我採來花蕾，我便能提煉出其中的精華：治癒血肉的藥水、令心神敏捷的藥劑，還有一瓶磨礪神智的靈藥。',
  'hudChrome.crafting.alchemyTitle': '煉金實驗室',
  'hudChrome.crafting.enchantTitle': '注靈台',
  'hudChrome.crafting.extractTitle': '萃取實驗室',
  'hudChrome.crafting.extractHint': '把收穫的花苞洗煉成大麻脂、脆片、鮮活樹脂與鑽石。',
  'hudChrome.crafting.errors.budsNotFresh': '這些花苞已經乾了。鮮活樹脂要在收穫後立刻萃取。',
  'hudChrome.crafting.errors.processRunning': '這道工序還在進行中。等它完成後再來。',
  'hudChrome.crafting.enchantHint': '將上等花苞與腐化碎片結合，鑄成可持續半小時的符文。',
  'hudChrome.crafting.alchemyHint': '將採集的花蕾釀成治療藥水、法力藥水和一瓶戰鬥靈藥。',
  ...
  'entities.npcs.rowan_sawtooth.name': '羅恩·鋸齒',
  'entities.npcs.rowan_sawtooth.title': '水閘看守',
  'entities.npcs.rowan_sawtooth.greeting':
    '岸邊生面孔啊，{className}。歡迎來到水閘，這是群落的前哨營地。真正的大壩在南邊，路遠著呢，可活兒就從這兒開始。保持嗨著，當心水。',
  'entities.npcs.hazel_timbers.name': '黑茲爾·廷伯斯',
  'entities.npcs.hazel_timbers.title': '大壩軍需官',
  'entities.npcs.hazel_timbers.greeting':
    '工具、馬具，還有路上吃的乾糧，給新來的都是公道價。海狸把營地管得緊巴巴的，{className}。你要點什麼？',
  ...
  'entities.quests.q_sluice_welcome.title': '歡迎來到水閘',
  'entities.quests.q_sluice_welcome.text':
    '在岸邊你要學的第一件事，{playerName}：海狸靠幹活掙位置，不是靠站著看熱鬧。枯萎狼從北邊的坡道下來，糟蹋我們的柴堆，驚嚇幼崽。清掉六隻，回來到木屋篝火邊暖暖身子。然後你就是我們的人了。',
  'entities.quests.q_sluice_welcome.completion':
    '林線上少了六隻狼，你一句怨言都沒有。這就是水閘的規矩，{playerName}。篝火歸你，免費。保持嗨著，亞利桑那。',
  'entities.quests.q_sluice_welcome.objectives.0.label': '枯萎狼已清剿',
  'entities.quests.q_sluice_pilings.title': '木樁的麻煩',
  'entities.quests.q_sluice_pilings.text':
    '正因為有大壩，才有這片可以圍著建的水塘，可東邊草甸的硬鬃獠牙野豬老是拱開樁基去啃裡頭的甜泥。海狸把這事當成私仇，{playerName}。放倒六頭掘地的傢伙，水閘就欠你一件像樣的紀念物，直接從大壩那兒捎來。',
  'entities.quests.q_sluice_pilings.completion':
    '樁基穩住了，水塘留住了，幼崽睡得安穩。給，{playerName}，一枚烤海狸信物，是在大壩那兒刻的。帶著它，無論你漂泊到哪兒，你都是群落的一員。保持嗨著，亞利桑那。',
  'entities.quests.q_sluice_pilings.objectives.0.label': '硬鬃獠牙已肅清',
  ...
  'entities.quests.q_greyrot.text':
    '在這裡，綻放不像旱原上那樣枯萎，{playerName}。它是被淹死的。先變灰、發軟，腐爛順著根鬚一路蔓延，一整片梯田都化成爛泥。哪一片開始變色，沼澤腫脹獸就已經飄在上頭了。去西岸淺灘戳破十隻，回來告訴我裡面流出的是什麼。',
  'entities.quests.q_greyrot.completion':
    '孢子，還是密密匝匝、大小一致的孢子。那不是天氣，{playerName}，也不是運氣。有人在養這種腐爛，並且把它對準了我們的園子。',
  'entities.quests.q_greyrot.objectives.0.label': '擊敗沼澤腫脹獸',
  'entities.quests.q_burn_the_beds.title': '燒掉溫床',
  'entities.quests.q_burn_the_beds.text':
    '雅拉想要一整季的時間，去育出能壓過腐爛的種。我沒有一整季。我有一條撐著兩百口人的堤道，還有一場正朝它走來的腐爛。把西岸淺灘的腫脹獸溫床燒了，{playerName}。十二隻應該就能斷掉那股漂流。沼澤會因此更貧瘠，而我照樣睡得著。',
  'entities.quests.q_burn_the_beds.completion':
    '淺灘成了灰燼，漂流在水邊徹底停住。這個決定是對的，雅拉會有一個月不跟我說話。拿上你的酬勞。',
  'entities.quests.q_burn_the_beds.objectives.0.label': '擊敗沼澤腫脹獸',
  'entities.quests.q_seed_the_shallows.title': '在淺灘播種',
  'entities.quests.q_seed_the_shallows.text':
    '火燒過的淺灘只剩光地，而光地正是腐爛下一步要去的地方。我寧可用綠意把它擠走。我手上有從布魯姆海文母株上育出的插條，能在死水裡生根，可深沼的鉗咬魚人不出一天就會把淺灘裡所有綠色的東西啃光。去東岸清掉十二隻，我就把插條種下去。',
  'entities.quests.q_seed_the_shallows.completion':
    '插條種下去了，水還沒把它們泡壞。這比守望者想要的慢，要證明它有用更慢。但只要撐得住，沼澤保住的就是綠色，而不是用綠色換來的灰燼。',
  'entities.quests.q_seed_the_shallows.objectives.0.label': '擊敗深沼鉗咬魚人',
  'entities.quests.q_ash_and_water.title': '灰與水',
  'entities.quests.q_ash_and_water.text':
    '火燒奏效了，也給我招來了新麻煩，這沼澤就是這麼還債的。煙把溺亡死者從淺水裡引了上來，如今它們就站在溫床燒剩的灰裡，什麼也不等。趁它們還沒摸到堤道，把十個放回去。',
  'entities.quests.q_ash_and_water.completion':
    '灰燼，還有站在灰裡的死人。是我選了火，{playerName}，再來一次我還是選火。但別讓誰告訴你這沒有代價。',
  'entities.quests.q_ash_and_water.objectives.0.label': '讓溺亡死者安息',
  'entities.quests.q_first_green.title': '第一抹綠',
  'entities.quests.q_first_green.text':
    '插條活了，{playerName}。自沼澤上漲以來，淺灘第一次有了綠色，而巨魔已經從墳丘上下來，成把成把地把它們扯走。把十隻趕回東邊去。那些根多撐一天，腐爛就得多繞一天路。',
  'entities.quests.q_first_green.completion':
    '還立著，還是綠的。今年它救不了這片沼澤。可我祖母種下布魯姆海文那片梯田時，也沒能親眼看它開花，所以我願意收下一淺灘插條，把這叫作一個好季節。',
  'entities.quests.q_first_green.objectives.0.label': '擊敗泥沼巨魔',
  ...
  'entities.zones.eastbrook_vale.pois.12.label': '種植台地',
  ...
  'entities.dungeons.blightroot_hollow.enterText': '你擠過垂落的根鬚，進入枯根空穴...',
  'entities.dungeons.blightroot_hollow.leaveText': '你穿過糾纏的根鬚，爬向開闊的天空。',
  'entities.dungeons.emberhold_keep.name': '燼堡',
  'entities.dungeons.emberhold_keep.enterText': '你穿過燒焦的閘門，進入燼堡...',
  'entities.dungeons.emberhold_keep.leaveText': '你穿過門樓，重新踏入開闊的荒漠。',
  ...
  'entities.items.bloom_essence.name': '綻放精華',
  'entities.items.ember_essence.name': '餘燼精華',
  'entities.items.flow_essence.name': '流動精華',
  'entities.items.spore_essence.name': '孢子精華',
  'entities.items.common_seed.name': '普通種子',
  'entities.items.corruption_shard.name': '腐蝕碎片',
  'entities.items.bloom_nutrient.name': '綻放養料',
  'entities.items.ember_nutrient.name': '餘燼養料',
  'entities.items.flow_nutrient.name': '流動養料',
  'entities.items.enriched_seed.name': '富集種子',
  'entities.items.prime_strain_seed.name': '原初品系種子',
  'entities.items.bloom_lamp.name': '綻放之燈',
  'entities.items.irrigation_coil.name': '灌溉盤管',
  ...
  'entities.mobs.spore_tick.name': '孢子蝨',
  'entities.mobs.blightroot_weaver.name': '枯根織網者',
  'entities.mobs.hollowed_husk.name': '空殼軀',
  'entities.mobs.rootwraith_the_hollowed.name': '根魅·空蝕者',
  'entities.mobs.ashfell_knight.name': '灰落騎士',
  'entities.mobs.emberbound_zealot.name': '縛燼狂徒',
  'entities.mobs.castellan_maldrek.name': '城主馬爾德雷克',
  'entities.mobs.lord_kaelen_ashbound.name': '縛燼領主凱倫',
  ...
  'hudChrome.questTracker.timeLabel': '剩餘時間：{time}',
  ...
  'guide.worldPage.intro':
    'Growverse 是一片你需徒步橫越的連綿大地，三大區域由南向北排列。沒有快速旅行，所以旅程本身就是冒險的一部分。',
  ...
  'desktop.crash.fatalBody': 'Growverse 發生未預期的錯誤，必須關閉。',
  ...
  'entities.npcs.cultivator_marlow.name': '馬洛',
  'entities.npcs.cultivator_marlow.title': '培植師',
  'entities.npcs.cultivator_marlow.greeting':
    '培育站隨你使用，朋友。營養劑、種子品系、種植裝備。這些植物需要什麼？',
  'entities.npcs.smith_draxa.name': '德拉克薩',
  'entities.npcs.smith_draxa.title': '裂隙鐵匠',
  'entities.npcs.smith_draxa.greeting':
    '升級台正熱著呢。給我帶來腐蝕碎片，我會把你的鋼鐵重鑄成裂隙也無法折斷的利器。',
  'hudChrome.crafting.growTitle': '培育站',
  'hudChrome.crafting.upgradeTitle': '升級台',
  'hudChrome.crafting.growHint': '製作營養劑、升級種子品系、打造種植裝備。',
  'hudChrome.crafting.upgradeHint': '重鑄裝備，並用腐蝕碎片切割戰鬥消耗品。',
  ...
  'hudChrome.crafting.close': '關閉',
  'hudChrome.trade.cutLabel': '插枝',
  'hudChrome.trade.hint': '插枝是複製品：你保留自己的母株，對方需要一個空的品系槽位。',
  'hudChrome.cup.title': '山谷盃',
  'hudChrome.cup.open': '參加山谷盃',
  'hudChrome.cup.hint': '評審看的是基因、你帶來的品級，以及你對這株植物的了解。',
  'hudChrome.cup.season': '第 {season} 賽季',
  'hudChrome.cup.remainingHours': '剩餘 {hours} 小時 {minutes} 分',
  'hudChrome.cup.remainingMinutes': '剩餘 {minutes} 分',
  'hudChrome.cup.best': '你的最高分：{score}',
  'hudChrome.cup.emptyBoard': '本賽季還沒有參賽作品。榜單由你來開啟。',
  'hudChrome.cup.gradeLabel': '花苞品級',
  'hudChrome.cup.strainLabel': '品系',
  'hudChrome.cup.noBuds': '沒有可參賽的花苞。先去收穫一季。',
  'hudChrome.cup.noStrains': '還沒有品系。收穫一季即可發現一個。',
  'hudChrome.cup.projected': '得分 {score}',
  'hudChrome.cup.enter': '參賽（{count} 枚花苞，得分 {score}）',
  'hudChrome.cup.posted': '{strain} 已上榜，得分 {score}，排名第 {rank}。',
  'hudChrome.garden.title': '花園',
  'hudChrome.garden.hint': '在地塊中種下種子，收穫綻放。',
  'hudChrome.garden.seedLabel': '要種植的種子',
  'hudChrome.garden.noSeeds': '沒有可種植的種子。在培育站製作。',
  'hudChrome.garden.empty': '空地塊',
  'hudChrome.garden.plant': '種植',
  'hudChrome.garden.harvest': '收穫',
  'hudChrome.garden.tend': '照料',
  'hudChrome.garden.tendCount': '已照料 {tends}/{total}',
  'hudChrome.garden.tendNudge': '有 {count} 株植物可以照料。',
  'hudChrome.garden.ready': '可收穫',
  'hudChrome.garden.locked': '已鎖定',
  'hudChrome.garden.unlockLevel': '等級 {level} 解鎖',
  'hudChrome.garden.open': '打理花園',
  'hudChrome.breeding.title': '品系遺傳學',
  'hudChrome.breeding.hint': '雜交兩個品系以組合它們的特性，或在花園種植一個。',
  'hudChrome.breeding.open': '培育品系',
  'hudChrome.breeding.empty': '還沒有品系。收穫綻放以發現你的第一個品系。',
  'hudChrome.breeding.landrace': '原生種',
  'hudChrome.breeding.potency': '效力',
  'hudChrome.breeding.vigor': '活力',
  'hudChrome.breeding.yield': '產量',
  'hudChrome.breeding.parentA': '親本A',
  'hudChrome.breeding.parentB': '親本B',
  'hudChrome.breeding.plant': '種植',
  'hudChrome.breeding.release': '釋放',
  'hudChrome.breeding.breed': '雜交',
  'hudChrome.breeding.full': '你的品系庫已滿。釋放一個品系以騰出空間。',
  'hudChrome.breeding.cost': '雜交花費：{count} 枚史詩花苞（你有 {held} 枚）',
  'hudChrome.breeding.needEpicBuds': '照料作物即可獲得史詩花苞。完美的一輪種植必定掉落一枚。',
  'hudChrome.breeding.refine': '精煉',
  'hudChrome.breeding.refineHint': '把第二個品系併入第一個，提升它並騰出一個槽位。',
  'hudChrome.breeding.fullRefine': '你的品系庫已滿。精煉或釋放一個品系以騰出空間。',
  'hudChrome.breeding.outlookTitle': '這次雜交可能出什麼',
  'hudChrome.breeding.outlookRow': '{trait}：至少 {chance}% 保住 {target}，最高可到 {ceiling}',
  'hudChrome.breeding.outlookLandrace': '這個組合有機會出地方種。',
  ...
  'hudChrome.crafting.categories.nutrient': '營養劑',
  'hudChrome.crafting.categories.seed': '種子品系',
  'hudChrome.crafting.categories.accessory': '種植配件',
  'hudChrome.crafting.categories.consumable': '消耗品',
  'hudChrome.crafting.categories.gear': '重鑄裝備',
  'hudChrome.crafting.errors.recipeUnavailable': '這裡沒有該配方。',
  ...
  'hudChrome.bank.none': '附近沒有銀行。',
  'hudChrome.bank.full': '你的銀行已滿。',
  'hudChrome.bank.notInBank': '你的銀行裡沒有那件物品。',
  'hudChrome.bank.open': '銀行',
  'hudChrome.bank.title': '{name}的金庫',
  'hudChrome.bank.close': '關閉銀行',
  'hudChrome.bank.bankedTitle': '金庫中',
  'hudChrome.bank.bankedEmpty': '你的金庫是空的。',
  ...
  'hudChrome.bank.clickWithdraw': '點擊取出',
  'hudChrome.bank.clickDeposit': '點擊存入',
  'hudChrome.bank.hint': '點擊背包物品將其存入，或點擊金庫物品將其取回。',
  'hudChrome.bank.fullHint': '金庫已滿。取出一些物品以騰出空間。',
  'hudChrome.bank.deposited': '已存入{name}。',
  'hudChrome.bank.withdrew': '已取出{name}。',
  'entities.npcs.banker_thistle.name': '金庫管理員西斯爾',
  ...
  'entities.items.epic_bud.name': '史詩花苞',
  'entities.items.vale_hash.name': '山谷大麻脂',
  'entities.items.golden_shatter.name': '黃金脆片',
  'entities.items.live_resin.name': '鮮活樹脂',
  'entities.items.bloom_diamonds.name': '花晶鑽石',
  'entities.items.resin_glyph_vigor.name': '活力樹脂符文',
  'entities.items.resin_glyph_focus.name': '專注樹脂符文',
  'entities.items.resin_glyph_warding.name': '守護樹脂符文',
  'entities.items.bud_fine.name': '優質花苞',
  'entities.items.bud_prime.name': '極品花苞',
  'entities.items.cured_flower_fine.name': '優質熟化花',
  'entities.items.cured_flower_prime.name': '極品熟化花',
  'entities.items.pressed_resin_fine.name': '優質壓製樹脂',
