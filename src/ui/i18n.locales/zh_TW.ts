...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.mounts.close': '關閉坐騎視窗',
  'hudChrome.mounts.summonAria': '召喚{name}',
  ...
  'entities.items.reins_verdant_bloomstrider.name': '翠綠綻放行者韁繩',
  'hudChrome.mounts.errors.alreadyHaveReins': '你已經擁有這副韁繩了。',
  'hudChrome.mounts.errors.fiestaBout': '嘉年華對局期間無法這麼做。',
  'entities.quests.q_riding_lessons.title': '騎術課程',
  'entities.quests.q_riding_lessons.text':
    '想學騎術嗎，{className}？那就先學會院場，再談上路。走一遍我的練習賽道：先是低欄，然後是乾草堆，最後再穿回木拱門。去吧！跳過每一道障礙，然後騎著穿過拱門回來。',
  'entities.quests.q_riding_lessons.completion':
    '手穩，坐姿也穩。你行的。這份酬勞拿去：應該夠你買下第一副韁繩了。挑一頭脾氣合你心意的坐騎吧，另外當心綻放行者，那傢伙是會挑選騎手的。',
  'entities.quests.q_riding_lessons.objectives.0.label': '已越過低欄',
  'entities.quests.q_riding_lessons.objectives.1.label': '已越過乾草堆',
  'entities.quests.q_riding_lessons.objectives.2.label': '已騎行穿過木拱門',
  'entities.mounts.mount_alpaca.name': '高地草原羊駝',
  'entities.mounts.mount_bull.name': '鐵皮公牛',
  'entities.mounts.mount_boar.name': '棘背野豬',
  'entities.mounts.mount_bloomstrider.name': '翠綠綻放行者',
  'entities.mounts.mount_swift_alpaca.name': '迅捷高地草原羊駝',
  'entities.mounts.mount_swift_bull.name': '迅捷鐵皮公牛',
  'entities.mounts.mount_swift_boar.name': '迅捷棘背野豬',
  'entities.mounts.mount_elder_bloomstrider.name': '長老綻放行者',
  'guide.nav.mounts': '坐騎',
  'guide.mountsPage.heading': '坐騎',
  'guide.mountsPage.intro':
    '坐騎載著你瀟灑地穿越大陸。到布魯姆海文馬廄學習騎術，挑一頭脾氣合你心意的夥伴，路途便會短上許多。',
  'guide.mountsPage.whatHeading': '騎術如何運作',
  'guide.mountsPage.whatBody':
    '每頭坐騎都是一次性解鎖：在馬廄買下牠的韁繩並學會騎乘，牠就永遠屬於你。只要你脫離戰鬥、身處旱地，隨時都能召喚；受到攻擊、開始施法或潛入水中都會讓你落地。',
  'guide.mountsPage.tiersHeading': '騎術與迅捷騎術',
  'guide.mountsPage.tiersBody':
    '馬廄養著兩批坐騎。騎術坐騎是入門之選，而迅捷坐騎則是同樣溫馴的坐騎養得更快。同一層級內的每頭坐騎速度完全相同，所以選擇只關乎性情與外觀，與速度無關。',
  'guide.mountsPage.exclusiveHeading': '綻放行者',
  'guide.mountsPage.exclusiveBody':
    '有兩頭坐騎，翠綠綻放行者與長老綻放行者，是長出來而非養出來的，也是馬廄以$GROW販售的專屬坐騎。牠們是身份的象徵：在各自層級內，速度與其他坐騎完全一致。',
  'guide.mountsPage.whereHeading': '在哪裡學習',
  'guide.mountsPage.whereBody':
    '達到{level}級後，前往起始山谷的布魯姆海文馬廄。馬廄長會先帶你在練習賽道上完成騎術課程，販售的韁繩則涵蓋兩個層級。',
  'guide.mountsPage.fromLevel': '從 {n} 級起',
  'guide.mountsPage.ridingTier': '騎術',
  'guide.mountsPage.swiftTier': '迅捷',
  'guide.mountsPage.exclusiveTag': '$GROW專屬',
  'entities.items.reins_swift_highfield_alpaca.name': '迅捷高地草原羊駝韁繩',
  'entities.items.reins_swift_ironhide_bull.name': '迅捷鐵皮公牛韁繩',
  'entities.items.reins_swift_thornback_boar.name': '迅捷棘背野豬韁繩',
  'entities.items.reins_elder_bloomstrider.name': '長老綻放行者韁繩',
  'entities.items.verdant_wardrobe_crate.name': '翠綠衣櫥箱',
  'entities.items.course_low_rail.name': '低欄障礙',
  'entities.items.course_hay_bales.name': '乾草堆障礙',
  'entities.items.course_timber_arch.name': '木拱門',
};
