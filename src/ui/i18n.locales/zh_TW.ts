...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  'seo.officialBody':
    'Growverse 是一款免費的大麻奇幻題材瀏覽器 MMORPG，故事發生在一個由傳送門相連的世界：與怪物戰鬥，完成任務，精通專業技能，培育魔法品種。在瀏覽器中即刻遊玩，單人探索世界，閱讀 wiki，並在本站關注開發動態。',
  ...
  'controls.chat': '開啟對話框',
  'seo.title': 'Growverse: The Portal Chronicles，免費瀏覽器 MMORPG',
  'seo.description':
    'Growverse 是一款免費的大麻奇幻題材瀏覽器 MMORPG。探索由傳送門相連的世界，與怪物戰鬥，完成任務，培育魔法品種，在不斷演變的國度中鑄就你的傳奇。無需下載，即點即玩。',
  'seo.genre': 'MMORPG',
  'seo.playMode': '多人遊戲',
  ...
  'hudChrome.account.sectionWallet': 'Growverse 錢包',
  ...
  'guide.tagline': '一款可在瀏覽器中免費遊玩的大麻奇幻題材MMORPG。',
  ...
  'guide.footer.blurb':
    '一款開放原始碼的大麻奇幻題材MMORPG。在你的瀏覽器中即可進行任務、組隊並探索一個由傳送門相連的世界。',
  ...
  'guide.home.eyebrow': '大麻奇幻題材瀏覽器MMORPG',
