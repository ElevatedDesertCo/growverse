...
export const fr_FR: Partial<Record<TranslationKey, string>> = {
  ...
  'auth.shareTab': 'Partager',
  'auth.shadeWarm': 'Chaud',
  'auth.shadeTeal': 'Sarcelle',
  'auth.shadeSmoke': 'Fumé',
  'auth.shadeRuby': 'Rubis',
  'auth.shadePlum': 'Prune',
  'auth.shadePeach': 'Pêche',
  'auth.shadeCoral': 'Corail',
  'auth.shadeBerry': 'Baie',
  'auth.resetShort': 'Réinitialiser',
  'auth.resetLook': "Réinitialiser l'apparence",
  'auth.randomizeShort': 'Aléatoire',
  'auth.randomize': 'Apparence aléatoire',
  'auth.outfitVerdigris': 'Vert-de-gris',
  'auth.outfitTeal': 'Sarcelle',
  'auth.outfitRoyal': 'Bleu royal',
  'auth.outfitObsidian': 'Obsidienne',
  'auth.outfitIvory': 'Ivoire',
  'auth.outfitGold': 'Or',
  'auth.outfitGilded': 'Doré',
  'auth.outfitForest': 'Forêt',
  'auth.outfitEmerald': 'Émeraude',
  'auth.outfitEmber': 'Braise',
  'auth.outfitCrimson': 'Carmin',
  'auth.outfitClassic': 'Classique',
  'auth.outfitBonewrought': "Forgé d'os",
  'auth.outfitBloodforged': 'Forgé de sang',
  'auth.outfitAzure': 'Azur',
  'auth.outfit': 'Couleur de la tenue',
  ...
  'auth.mouth': 'Bouche',
  'auth.makeupNone': 'Aucun',
  'auth.lipstick': 'Rouge à lèvres',
  'auth.lightnessAria': 'Luminosité {label}',
  'auth.lashes': 'Cils',
  'auth.lashColor': 'Couleur des cils',
  'auth.jewelSilver': 'Argent',
  'auth.jewelRuby': 'Rubis',
  'auth.jewelPearl': 'Perle',
  'auth.jewelObsidian': 'Obsidienne',
  'auth.jewelMaterial': 'Matériau des bijoux',
  'auth.jewelIron': 'Fer',
  'auth.jewelGold': 'Or',
  'auth.jewelDefault': 'Tel que forgé',
  'auth.jewelCopper': 'Cuivre',
  'auth.jewelBone': 'Os',
  'auth.jewelAmethyst': 'Améthyste',
  'auth.importCode': 'Importer',
  'auth.helmPreview': 'Afficher le casque',
  'auth.hairWavybob': 'Carré ondulé',
  'auth.hairWarriorbraid': 'Tresse de guerrier',
  'auth.hairTwinbraids': 'Deux tresses',
  'auth.hairTopknot': 'Chignon sommital',
  'auth.hairSweptpixie': 'Pixie balayée',
  'auth.hairSweptback': 'Mi-long plaqué en arrière',
  'auth.hairSidepony': 'Queue de cheval latérale',
  'auth.hairSidepart': 'Raie sur le côté classique',
  'auth.hairQuiff': 'Banane relevée',
  'auth.hairPompadour': 'Pompadour court',
  'auth.hairPixie': 'Coupe pixie',
  'auth.hairMullet': 'Mulet épais',
  'auth.hairMohawk': 'Mohawk complet',
  'auth.hairMessy': 'Épis courts décoiffés',
  'auth.hairLowpony': 'Queue de cheval basse',
  'auth.hairLowbun': 'Chignon bas',
  'auth.hairLongwavy': 'Longs ondulés',
  'auth.hairLongpart': 'Longs cheveux lisses, raie au milieu',
  'auth.hairLongcenterpart': 'Longue raie au milieu',
  'auth.hairLayered': 'Dégradé aux épaules',
  'auth.hairHighpony': 'Queue de cheval haute',
  'auth.hairHighbun': 'Chignon haut',
  'auth.hairHalfbun': 'Demi-chignon',
  'auth.hairFauxhawk': 'Faux mohawk',
  'auth.hairFantasybraid': 'Tresse fantaisie',
  'auth.hairCurtains': 'Frange rideau',
  'auth.hairCurlycap': 'Calotte bouclée courte',
  'auth.hairCurlyafro': 'Afro bouclé',
  'auth.hairCurls': 'Boucles souples',
  'auth.hairCrewcut': 'Coupe en brosse texturée',
  'auth.hairCrew': 'Coupe tondeuse',
  'auth.hairColor': 'Couleur des cheveux',
  'auth.hairChinbob': 'Carré court',
  'auth.hairBuzz': 'Coupe en brosse',
  'auth.hairBraidcrown': 'Couronne tressée',
  'auth.hairBluntbangs': 'Carré frange droite',
  'auth.hairBald': 'Chauve',
  'auth.hairAsymbob': 'Carré asymétrique',
  'auth.hairAfro': 'Afro arrondi',
  'auth.hair': 'Cheveux',
  ...
  'auth.face': 'Visage',
  'auth.eyeshadow': 'Fard à paupières',
  ...
  'auth.earWide': 'Large',
  'auth.earWarden': 'Fer du gardien',
  'auth.earStud': 'Clou',
  'auth.earSmall': 'Petit',
  'auth.earShape': 'Forme des oreilles',
  'auth.earSeptum': 'Anneau de nez',
  'auth.earRunic': 'Pierre runique',
  'auth.earRound': 'Rond',
  'auth.earPointed': 'Pointu',
  'auth.earNone': 'Aucun',
  'auth.earMoonstar': 'Étoile au clair de lune',
  'auth.earMoon': 'Croissant de lune',
  'auth.earHoop': 'Anneau',
  'auth.earFeather': 'Plume',
  'auth.earCuff': 'Manchette',
  'auth.earChain': 'Pendentif de perles',
  'auth.earBonehoop': 'Anneau en os',
  'auth.earBone': 'Breloque en os',
  'auth.designCodeImportedPartial':
    'Apparence importée. Les valeurs inconnues de cette version ont été ignorées.',
  'auth.designCodeImported': 'Apparence importée.',
  'auth.designCodeHint':
    'Copiez ce code pour enregistrer ou partager cette apparence. Collez un code ici et importez-le pour la charger.',
  'auth.designCodeErrVersion': "Ce code d'apparence provient d'une version plus récente du jeu.",
  'auth.designCodeErrMalformed':
    "Ce code d'apparence est endommagé. Copiez le code en entier et réessayez.",
  'auth.designCodeErrHeader': "Cela ne ressemble pas à un code d'apparence.",
  'auth.designCodeErrEmpty': "Collez d'abord un code d'apparence.",
  'auth.designCodeCopyManual':
    'La copie automatique est bloquée ici. Le code est sélectionné, copiez-le avec votre clavier.',
  'auth.designCodeCopied': "Code d'apparence copié.",
  'auth.designCode': "Code d'apparence",
  'auth.customColor': 'Personnalisé',
  'auth.copyCode': 'Copier le code',
  'auth.colorWheelAria':
    'Roue chromatique {label} : faites glisser pour choisir la teinte et la saturation',
  'auth.colorPresetAria': 'Préréglage {label} {n}',
  'auth.brows': 'Sourcils',
  ...
  'auth.body': 'Corps',
  'auth.blush': 'Fard à joues',
  'auth.beardWizard': 'De sorcier',
  'auth.beardVikingb': 'Tressée',
  'auth.beardStubbleBeard': 'Barbe de trois jours dense',
  'auth.beardStubble': 'Barbe de trois jours',
  'auth.beardShortbox': 'Carrée',
  'auth.beardScruff': 'Barbe hirsute',
  'auth.beardNone': 'Aucune',
  'auth.beardMutton': 'Rouflaquettes',
  'auth.beardHorseshoe': 'Fer à cheval',
  'auth.beardGoatee': 'Bouc',
  ...
  'seo.officialLabel': 'Site officiel de Growverse',
  'seo.officialBody':
  ...
  'playerCard.defaultRealm': 'Monde de Growverse',
  ...
  'playerCard.shareText':
    'Je forge ma légende dans Growverse: niveau {level} {className}{tierBit}. Rejoignez mon royaume:',
  'playerCard.nativeShareTitle': 'Monde de Growverse',
  ...
  'seo.description':
    'Partez pour une aventure épique dans Growverse, un micro-MMO au style classique jouable directement dans votre navigateur. Rejoignez un royaume persistant, progressez en classe et terrassez vos ennemis.',
  'seo.genre': 'MMORPG',
  ...
  'a11y.githubProject': 'Ouvrir le projet Growverse sur GitHub',
  'a11y.discordCommunity': 'Rejoindre la communauté Growverse sur Discord',
  'a11y.donateProject': 'Faire un don pour soutenir Growverse',
  ...
  'mobilePreflight.androidOpenStep': 'Ouvrez Growverse depuis la nouvelle icône.',
  ...
  'serverUnavailable.title': 'Growverse - Royaume indisponible',
  ...
  'entities.items.cooked_mirror_trout.name': 'Truite miroir grillée',
  'entities.items.cooked_river_perch.name': 'Perche de rivière poêlée',
  'entities.items.cooked_marsh_pike.name': 'Brochet des marais rôti',
  'entities.items.cooked_bog_eel.name': 'Anguille des tourbières fumée',
  'entities.items.cooked_frostgill_trout.name': 'Truite ouïe-givre grillée',
  'entities.items.cooked_stonescale_carp.name': 'Carpe écaille-de-pierre au four',
  'entities.items.bloom_extract.name': 'Extrait floral',
  ...
  'entities.items.restful_bloom_tonic.name': 'Tonique Floral Reposant',
  'entities.items.lively_bloom_tonic.name': 'Tonique Floral Vif',
  'entities.items.balanced_bloom_tonic.name': 'Tonique Floral Équilibré',
  'entities.items.slow_bloom_lozenge.name': 'Pastille de Floraison Lente',
  'entities.items.purple_petal.name': 'Pétale pourpre',
  'entities.items.golden_petal.name': 'Pétale doré',
  'entities.items.rough_timber.name': 'Bois brut',
  ...
  'entities.items.bloom_essence.name': 'Essence de Floraison',
  'entities.items.ember_essence.name': 'Essence de Braise',
  'entities.items.flow_essence.name': 'Essence de Flux',
  'entities.items.spore_essence.name': 'Essence de Spore',
  'entities.items.common_seed.name': 'Graine Commune',
  'entities.items.corruption_shard.name': 'Éclat de Corruption',
  'entities.items.bloom_nutrient.name': 'Nutriment de Floraison',
  'entities.items.ember_nutrient.name': 'Nutriment de Braise',
  'entities.items.flow_nutrient.name': 'Nutriment de Flux',
  'entities.items.enriched_seed.name': 'Graine Enrichie',
  'entities.items.prime_strain_seed.name': 'Graine de Souche Primordiale',
  'entities.items.bloom_lamp.name': 'Lampe de Floraison',
  'entities.items.irrigation_coil.name': "Serpentin d'Irrigation",
  'entities.items.shard_whetstone.name': "Pierre à Aiguiser d'Éclats",
  ...
  'guide.worldPage.intro':
    "Growverse est une seule terre continue que l'on traverse à pied, trois zones disposées du sud au nord. Il n'y a pas de voyage rapide, alors le trajet fait partie de l'aventure.",
  ...
  'hudChrome.nativeUpdate.body':
    'Une nouvelle version de Growverse est disponible. Mettez à jour maintenant pour les derniers correctifs et améliorations.',
  'hudChrome.nativeUpdate.bodyWithVersion':
    'La version {version} de Growverse est disponible. Mettez à jour maintenant pour les derniers correctifs et améliorations.',
  ...
  'entities.items.epic_bud.name': 'Bourgeon épique',
  'entities.items.vale_hash.name': 'Haschich du val',
  'entities.items.golden_shatter.name': "Ambre d'or",
  'entities.items.live_resin.name': 'Résine vivante',
  'entities.items.bloom_diamonds.name': 'Diamants de floraison',
  'entities.items.resin_glyph_vigor.name': 'Glyphe de résine de vigueur',
  'entities.items.resin_glyph_focus.name': 'Glyphe de résine de concentration',
  'entities.items.resin_glyph_warding.name': 'Glyphe de résine de protection',
