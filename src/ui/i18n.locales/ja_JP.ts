...
export const ja_JP: Partial<Record<TranslationKey, string>> = {
  ...
  'playerCard.defaultRealm': 'Growverseの世界',
  ...
  'playerCard.shareText':
    'Growverseで伝説を鍛えています: レベル{level} {className}{tierBit}。私のレルムに参加してください:',
  'playerCard.nativeShareTitle': 'Growverseの世界',
  ...
  'a11y.githubProject': 'GitHubでGrowverseプロジェクトを開く',
  'a11y.discordCommunity': 'GrowverseのDiscordコミュニティに参加',
  'a11y.donateProject': 'Growverseを支援するために寄付',
  ...
  'mobilePreflight.iosOpenStep': '新しいホーム画面アイコンからGrowverseを開きます。',
  ...
  'mobilePreflight.androidOpenStep': '新しいアイコンからGrowverseを開きます。',
  ...
  'serverUnavailable.title': 'Growverse - レルム利用不可',
  ...
  'entities.items.restful_bloom_tonic.name': '安息の花蕾強壮剤',
  ...
  'entities.items.bloom_essence.name': '開花の精華',
  'entities.items.ember_essence.name': '残り火の精華',
  'entities.items.flow_essence.name': '流動の精華',
  'entities.items.spore_essence.name': '胞子の精華',
  'entities.items.common_seed.name': '普通の種',
  'entities.items.corruption_shard.name': '汚染の破片',
  'entities.items.bloom_nutrient.name': '開花の養分',
  'entities.items.ember_nutrient.name': '残り火の養分',
  'entities.items.flow_nutrient.name': '流動の養分',
  'entities.items.enriched_seed.name': '濃縮された種',
  'entities.items.prime_strain_seed.name': '原種の種',
  'entities.items.bloom_lamp.name': '開花のランプ',
  'entities.items.irrigation_coil.name': '灌漑コイル',
  'entities.items.shard_whetstone.name': '破片の砥石',
  ...
  'guide.worldPage.intro':
    'Growverseは、自らの足で歩いて渡る一続きの大地です。南から北へと3つのゾーンが連なっています。ファストトラベルはなく、その旅路こそが冒険の一部です。',
  ...
  'hudChrome.nativeUpdate.body':
    'Growverse の新しいバージョンが利用可能です。今すぐアップデートして最新の修正と改善を入手しましょう。',
  'hudChrome.nativeUpdate.bodyWithVersion':
    'Growverse のバージョン {version} が利用可能です。今すぐアップデートして最新の修正と改善を入手しましょう。',
  ...
  'desktop.crash.fatalBody': 'Growverse で予期しないエラーが発生したため、終了します。',
  ...
  'entities.npcs.cultivator_marlow.name': 'マーロウ',
  'entities.npcs.cultivator_marlow.title': '栽培師',
  'entities.npcs.cultivator_marlow.greeting':
    '栽培ステーションは自由に使ってくれ、友よ。栄養剤、種子品種、栽培用の装備。植物には何が必要かな？',
  'entities.npcs.smith_draxa.name': 'ドラクサ',
  'entities.npcs.smith_draxa.title': 'リフト鍛冶',
  'entities.npcs.smith_draxa.greeting':
    'アップグレード台は熱く燃えている。腐敗の欠片を持ってこい。お前の鋼をリフトさえ砕けぬ一振りに鍛え直してやろう。',
  'hudChrome.crafting.growTitle': '栽培ステーション',
  'hudChrome.crafting.upgradeTitle': 'アップグレード台',
  'hudChrome.crafting.growHint': '栄養剤の作成、種子品種の強化、栽培装備の製作。',
  'hudChrome.crafting.upgradeHint': '装備を鍛え直し、腐敗の欠片から戦闘用消耗品を削り出す。',
  'hudChrome.crafting.craftButton': '作成',
  ...
  'hudChrome.garden.title': '菜園',
  'hudChrome.garden.hint': '区画に種をまき、ブルームを収穫しましょう。',
  'hudChrome.garden.seedLabel': '植える種',
  'hudChrome.garden.noSeeds': '植えられる種がありません。栽培所で作りましょう。',
  'hudChrome.garden.empty': '空き区画',
  ...
  'hudChrome.breeding.open': '品種を交配',
  'hudChrome.breeding.empty': 'まだ品種がありません。花蕾を収穫して最初の品種を発見しましょう。',
  'hudChrome.breeding.landrace': '在来種',
  'hudChrome.breeding.potency': '効力',
  'hudChrome.breeding.vigor': '活力',
  'hudChrome.breeding.yield': '収量',
  'hudChrome.breeding.parentA': '親A',
  'hudChrome.breeding.parentB': '親B',
  'hudChrome.breeding.plant': '植える',
  ...
  'hudChrome.reputation.tier.friendly': '友好',
  'hudChrome.reputation.tier.honored': '尊敬',
  'hudChrome.reputation.tier.revered': '崇敬',
  'hudChrome.reputation.tier.exalted': '崇拝',
  'hudChrome.crafting.categories.nutrient': '栄養剤',
  'hudChrome.crafting.categories.seed': '種子品種',
  'hudChrome.crafting.categories.accessory': '栽培アクセサリー',
  'hudChrome.crafting.categories.consumable': '消耗品',
  'hudChrome.crafting.categories.gear': '再鍛造装備',
  'hudChrome.crafting.errors.recipeUnavailable': 'ここではそのレシピは利用できない。',
  ...
  'hudChrome.mounts.close': 'マウントウィンドウを閉じる',
  'hudChrome.mounts.summonAria': '{name}を召喚',
  'hudChrome.mounts.dismissAria': '{name}を解除',
  ...
  'entities.items.reins_verdant_bloomstrider.name': '翠緑のブルームストライダーの手綱',
  'hudChrome.mounts.errors.alreadyHaveReins': 'その手綱はすでに持っています。',
  'hudChrome.mounts.errors.fiestaBout': 'フィエスタの試合中にはできません。',
  'entities.quests.q_riding_lessons.title': '騎乗レッスン',
  'entities.quests.q_riding_lessons.text':
    '乗りたいのですか、{className}？なら道に出る前に、まずこの庭で学ぶことです。私の練習コースを回ってきなさい。低い横木、干し草の山、そして最後に木のアーチをくぐって戻るのです。さあ！すべての障害を跳び越えたら、アーチを抜けて騎乗のまま戻ってきなさい。',
  'entities.quests.q_riding_lessons.completion':
    '手綱さばきも座りも安定していますね。合格です。これは骨折り賃に。最初の手綱を買うには十分なはずです。気性の合うマウントを選びなさい。ただしブルームストライダーには気をつけて。あれは乗り手を選ぶのですから。',
  'entities.quests.q_riding_lessons.objectives.0.label': '低い横木を越えた',
  'entities.quests.q_riding_lessons.objectives.1.label': '干し草の山を越えた',
  'entities.quests.q_riding_lessons.objectives.2.label': '木のアーチをくぐり抜けた',
  'entities.mounts.mount_alpaca.name': 'ハイフィールド・アルパカ',
  'entities.mounts.mount_bull.name': 'アイアンハイド・ブル',
  'entities.mounts.mount_boar.name': 'ソーンバック・ボア',
  'entities.mounts.mount_bloomstrider.name': '翠緑のブルームストライダー',
  'entities.mounts.mount_swift_alpaca.name': '俊足のハイフィールド・アルパカ',
  'entities.mounts.mount_swift_bull.name': '俊足のアイアンハイド・ブル',
  'entities.mounts.mount_swift_boar.name': '俊足のソーンバック・ボア',
  'entities.mounts.mount_elder_bloomstrider.name': '長老ブルームストライダー',
  'guide.nav.mounts': 'マウント',
  'guide.mountsPage.heading': 'マウント',
  'guide.mountsPage.intro':
    'マウントは、あなたを乗せて颯爽と大地を駆けます。ブルームヘイヴンの厩舎で騎乗を習い、気性の合う相棒を選べば、道のりはずっと短くなります。',
  'guide.mountsPage.whatHeading': '騎乗の仕組み',
  'guide.mountsPage.whatBody':
    'マウントは一度きりの解放です。厩舎で手綱を買って習得すれば、ずっとあなたのものです。戦闘外で乾いた地面にいればいつでも召喚できます。攻撃を受ける、詠唱を始める、水に潜る、のいずれかで自分の足に戻ります。',
  'guide.mountsPage.tiersHeading': '騎乗と俊足の騎乗',
  'guide.mountsPage.tiersBody':
    '厩舎は二種の群れを育てています。騎乗マウントは最初の一歩、俊足マウントは同じ穏やかな群れを速く育てたものです。同じ段階の中ではどのマウントも同じ速さなので、選ぶ基準は気性と見た目であって、速さではありません。',
  'guide.mountsPage.exclusiveHeading': 'ブルームストライダー',
  'guide.mountsPage.exclusiveBody':
    '翠緑のブルームストライダーと長老ブルームストライダーの2頭は、育てられたのではなく生い育ったもので、厩舎が$GROWで販売する限定マウントです。あくまで名誉の乗り物であり、同じ段階の中では他のどのマウントともまったく同じ速さです。',
  'guide.mountsPage.whereHeading': '習得できる場所',
  'guide.mountsPage.whereBody':
    'レベル{level}に達したら、始まりの谷にあるブルームヘイヴンの厩舎を訪れましょう。厩舎長がまず練習コースで騎乗レッスンをつけてくれます。売られている手綱は両方の段階をカバーしています。',
  'guide.mountsPage.fromLevel': 'レベル{n}から',
  'guide.mountsPage.ridingTier': '騎乗',
  'guide.mountsPage.swiftTier': '俊足',
  'guide.mountsPage.exclusiveTag': '$GROW限定',
  'entities.items.reins_swift_highfield_alpaca.name': '俊足のハイフィールド・アルパカの手綱',
  'entities.items.reins_swift_ironhide_bull.name': '俊足のアイアンハイド・ブルの手綱',
  'entities.items.reins_swift_thornback_boar.name': '俊足のソーンバック・ボアの手綱',
  'entities.items.reins_elder_bloomstrider.name': '長老ブルームストライダーの手綱',
  'entities.items.verdant_wardrobe_crate.name': '翠緑の衣装箱',
  'entities.items.course_low_rail.name': '低い横木の障害',
  'entities.items.course_hay_bales.name': '干し草の山の障害',
  'entities.items.course_timber_arch.name': '木のアーチ',
};
