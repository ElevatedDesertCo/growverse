...
export const ja_JP: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.professions.mining': '採掘',
  'hudChrome.professions.herbalism': '薬草学',
  'hudChrome.professions.logging': '伐採',
  'hudChrome.professions.cultivation': '栽培',
  'hudChrome.professions.fishing': '釣り',
  ...
  'hudChrome.overview.tablistAria': 'キャラクターシート表示',
  'hudChrome.overview.gearTab': 'キャラクター',
  'hudChrome.overview.overviewTab': '概要',
  ...
  'entities.npcs.cup_steward_wilder.name': 'ワイルダー',
  'entities.npcs.cup_steward_wilder.title': 'ヴェイル・カップ世話役',
  'entities.npcs.cup_steward_wilder.greeting':
    'カップは開いている、{className}。品種一つと、そこから採れた花蕾を十個持ってこい。板に名前を載せてやる。審査は遺伝、持ち込んだ品級、そして株をどれだけ知っているか。三つ揃わなければ、ただ出しただけだ。',
  ...
  'hudChrome.questTracker.timeLabel': '残り時間: {time}',
  ...
  'hudChrome.cup.season': '第 {season} シーズン',
  'hudChrome.cup.remainingHours': '残り {hours} 時間 {minutes} 分',
  'hudChrome.cup.remainingMinutes': '残り {minutes} 分',
  'hudChrome.cup.best': '自己最高得点：{score}',
  'hudChrome.cup.emptyBoard': '今季はまだ出品がない。板を開くのは君だ。',
  'hudChrome.cup.gradeLabel': '花蕾の品級',
  'hudChrome.cup.strainLabel': '品種',
  'hudChrome.cup.noBuds': '出品できる花蕾がない。まず収穫しろ。',
  'hudChrome.cup.noStrains': '品種がまだない。収穫すれば一つ見つかる。',
  'hudChrome.cup.projected': '{score} 点',
  'hudChrome.cup.enter': '出品（花蕾 {count} 個、{score} 点）',
  'hudChrome.cup.posted': '{strain} が {score} 点で board に載り、順位は {rank} 位。',
  ...
  'hudChrome.garden.tend': '世話',
  'hudChrome.garden.tendCount': '世話 {tends}/{total}',
  'hudChrome.garden.tendNudge': '{count} 株が世話を待っている。',
  ...
  'entities.items.cured_flower_prime.name': '極上の乾燥花',
  'entities.items.pressed_resin_fine.name': '上質な圧搾樹脂',
  ...
  'entities.quests.q_first_harvest.completion':
    'これは見事だ。丁寧に刈り込まれていて、急いだ跡がどこにもない。君はこの仕事に向いた手をしている。',
  'entities.quests.q_first_harvest.objectives.0.label': '並の花芽',
  'entities.quests.q_fine_supply.title': 'もう少し良いものを',
  'entities.quests.q_fine_supply.text':
    '並の品でも灯りは灯せるが、それで誰かを唸らせることはできん。もっと上質な材料が要る。どこで手に入れたかは大して気にしない。辛抱強く自分で交配してもいいし、やり遂げた者から買ってもいい。金を持つ育て手も、やはり育て手だ。',
  'entities.quests.q_fine_supply.completion':
    'これならきちんと熟成させる価値がある。これを育てた者は分かっている。それが君なら、なお良い。',
  'entities.quests.q_fine_supply.objectives.0.label': '上質な花芽',
  'entities.quests.q_prime_order.title': '栽培者の注文書',
  'entities.quests.q_prime_order.text':
    '一度も満たせたことのない常時注文がある。極上の材料、それ以下は受け付けん。そのためには最後まで正しく交配された系統が要る。つまり自分で何年も交配を重ねるか、すでにやり遂げた誰かと良い関係を築くかだ。どちらにせよ、これを満たせばロッジの誰もが君の名を覚えるだろう。',
  'entities.quests.q_prime_order.completion':
    '極上が六つ。長い季節を待った。ロッジは君に借りができた。私もだ。',
  'entities.quests.q_prime_order.objectives.0.label': '極上の花芽',
};
