...
export const ja_JP: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.quests.q_first_harvest.text': '育てる者は皆こうして始めるものだ。畝がひとつ、種がひとつ、そして手を出さずに待つ辛抱強さ。何かを植え、最後まで育て切って、そこから採れたものを持ってきてくれ。もっと良い種を預ける前に、君が作物をどう扱うか見ておきたい。',
  'entities.quests.q_first_harvest.completion': 'これは見事だ。丁寧に刈り込まれていて、急いだ跡がどこにもない。君はこの仕事に向いた手をしている。',
  'entities.quests.q_first_harvest.objectives.0.label': '並の花芽',
  'entities.quests.q_fine_supply.title': 'もう少し良いものを',
  'entities.quests.q_fine_supply.text': '並の品でも灯りは灯せるが、それで誰かを唸らせることはできん。もっと上質な材料が要る。どこで手に入れたかは大して気にしない。辛抱強く自分で交配してもいいし、やり遂げた者から買ってもいい。金を持つ育て手も、やはり育て手だ。',
  'entities.quests.q_fine_supply.completion': 'これならきちんと熟成させる価値がある。これを育てた者は分かっている。それが君なら、なお良い。',
  'entities.quests.q_fine_supply.objectives.0.label': '上質な花芽',
  'entities.quests.q_prime_order.title': '栽培者の注文書',
  'entities.quests.q_prime_order.text': '一度も満たせたことのない常時注文がある。極上の材料、それ以下は受け付けん。そのためには最後まで正しく交配された系統が要る。つまり自分で何年も交配を重ねるか、すでにやり遂げた誰かと良い関係を築くかだ。どちらにせよ、これを満たせばロッジの誰もが君の名を覚えるだろう。',
  'entities.quests.q_prime_order.completion': '極上が六つ。長い季節を待った。ロッジは君に借りができた。私もだ。',
