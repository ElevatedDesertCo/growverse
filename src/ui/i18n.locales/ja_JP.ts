...
export const ja_JP: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.items.glassscale_mail.name': 'ガラス鱗の鎖帷子',
  'entities.items.sunbleached_leathers.name': '陽に晒された革鎧',
  'entities.items.sunspun_robes.name': '陽紡ぎのローブ',
  'entities.items.sunforged_blade.name': '陽鍛えの刃',
  'entities.items.sunforged_dagger.name': '陽鍛えの短剣',
  'entities.items.sunforged_scepter.name': '陽鍛えの笏',
