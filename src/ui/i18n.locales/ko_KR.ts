...
export const ko_KR: Partial<Record<TranslationKey, string>> = {
  ...
  'seo.officialLabel': 'Growverse 공식 웹사이트',
  'seo.officialBody':
  ...
  'playerCard.defaultRealm': 'Growverse의 세계',
  ...
  'playerCard.shareText':
    'Growverse에서 제 전설을 벼리고 있습니다: {level}레벨 {className}{tierBit}. 제 렐름에 합류하세요:',
  'playerCard.nativeShareTitle': 'Growverse의 세계',
  ...
  'seo.title': 'Growverse: 클래식 스타일 웹 MMO',
  'seo.description':
    '브라우저에서 바로 즐기는 클래식 스타일 마이크로 MMO, Growverse에서 장대한 모험을 시작하세요. 지속되는 공유 렐름에 접속해 직업을 성장시키고 적을 물리치세요.',
  'seo.genre': 'MMORPG',
  'seo.playMode': '멀티플레이어',
  ...
  'a11y.githubProject': 'GitHub에서 Growverse 프로젝트 열기',
  'a11y.discordCommunity': 'Growverse Discord 커뮤니티 참여',
  'a11y.donateProject': 'Growverse 후원하기',
  ...
  'mobilePreflight.iosOpenStep': '새 홈 화면 아이콘에서 Growverse를 여세요.',
  ...
  'mobilePreflight.androidOpenStep': '새 아이콘에서 Growverse를 여세요.',
  ...
  'serverUnavailable.title': 'Growverse - 렐름 이용 불가',
  ...
  'entities.items.restful_bloom_tonic.name': '안식의 개화 강장제',
  'entities.items.lively_bloom_tonic.name': '활력의 개화 강장제',
  'entities.items.balanced_bloom_tonic.name': '균형의 개화 강장제',
  ...
  'entities.items.bloom_essence.name': '개화 정수',
  'entities.items.ember_essence.name': '잉걸불 정수',
  'entities.items.flow_essence.name': '흐름 정수',
  'entities.items.spore_essence.name': '포자 정수',
  'entities.items.common_seed.name': '일반 씨앗',
  'entities.items.corruption_shard.name': '부패 파편',
  'entities.items.bloom_nutrient.name': '개화 양분',
  'entities.items.ember_nutrient.name': '잉걸불 양분',
  'entities.items.flow_nutrient.name': '흐름 양분',
  'entities.items.enriched_seed.name': '강화 씨앗',
  'entities.items.prime_strain_seed.name': '원종 씨앗',
  'entities.items.bloom_lamp.name': '개화 등불',
  'entities.items.irrigation_coil.name': '관개 코일',
  'entities.items.shard_whetstone.name': '파편 숫돌',
  ...
  'guide.worldPage.intro':
    'Growverse는 두 발로 가로지르는 하나로 이어진 대지이며, 남에서 북으로 펼쳐진 세 개의 지역으로 이루어져 있습니다. 빠른 이동이 없으니, 여정 자체가 모험의 일부입니다.',
  ...
  'hudChrome.nativeUpdate.body':
    'Growverse의 새 버전을 사용할 수 있습니다. 지금 업데이트하여 최신 수정 사항과 개선 사항을 받으세요.',
  'hudChrome.nativeUpdate.bodyWithVersion':
    'Growverse 버전 {version}을(를) 사용할 수 있습니다. 지금 업데이트하여 최신 수정 사항과 개선 사항을 받으세요.',
  ...
  'desktop.crash.fatalBody': 'Growverse에 예기치 않은 오류가 발생하여 종료해야 합니다.',
  ...
  'entities.npcs.cultivator_marlow.name': '말로우',
  'entities.npcs.cultivator_marlow.title': '재배가',
  'entities.npcs.cultivator_marlow.greeting':
    '재배 시설은 자유롭게 쓰게, 친구. 영양제, 씨앗 품종, 재배 장비. 식물에게 무엇이 필요한가?',
  'entities.npcs.smith_draxa.name': '드락사',
  'entities.npcs.smith_draxa.title': '균열 대장장이',
  'entities.npcs.smith_draxa.greeting':
    '개조 작업대가 뜨겁게 달아올랐네. 부패의 파편을 가져오게. 자네의 강철을 균열조차 부수지 못할 물건으로 다시 벼려주지.',
  'hudChrome.crafting.growTitle': '재배 시설',
  'hudChrome.crafting.upgradeTitle': '개조 작업대',
  'hudChrome.crafting.growHint': '영양제 제작, 씨앗 품종 강화, 재배 장비 제작.',
  'hudChrome.crafting.upgradeHint': '장비를 다시 벼리고, 부패의 파편으로 전투 소모품을 깎아낸다.',
  ...
  'hudChrome.garden.title': '정원',
  'hudChrome.garden.hint': '밭에 씨앗을 심고 블룸을 수확하세요.',
  'hudChrome.garden.seedLabel': '심을 씨앗',
  'hudChrome.garden.noSeeds': '심을 수 있는 씨앗이 없습니다. 재배소에서 만드세요.',
  'hudChrome.garden.empty': '빈 밭',
  ...
  'hudChrome.breeding.open': '품종 교배',
  'hudChrome.breeding.empty': '아직 품종이 없습니다. 블룸을 수확해 첫 품종을 발견하세요.',
  'hudChrome.breeding.landrace': '재래종',
  'hudChrome.breeding.potency': '효능',
  'hudChrome.breeding.vigor': '활력',
  'hudChrome.breeding.yield': '수확량',
  'hudChrome.breeding.parentA': '부모 A',
  'hudChrome.breeding.parentB': '부모 B',
  'hudChrome.breeding.plant': '심기',
  ...
  'hudChrome.reputation.tier.friendly': '우호적',
  'hudChrome.reputation.tier.honored': '존경',
  'hudChrome.reputation.tier.revered': '숭배',
  'hudChrome.reputation.tier.exalted': '추앙',
  'hudChrome.crafting.categories.nutrient': '영양제',
  'hudChrome.crafting.categories.seed': '씨앗 품종',
  'hudChrome.crafting.categories.accessory': '재배 장신구',
  'hudChrome.crafting.categories.consumable': '소모품',
  'hudChrome.crafting.categories.gear': '재련 장비',
  'hudChrome.crafting.errors.recipeUnavailable': '여기서는 그 제조법을 쓸 수 없습니다.',
  'hudChrome.crafting.errors.tooFarFromStation': '작업대에서 너무 멀리 있습니다.',
  'hudChrome.crafting.errors.levelTooLow': '아직 그것을 제작할 만한 실력이 안 됩니다.',
  'hudChrome.crafting.errors.missingMaterials': '제작에 필요한 재료가 부족합니다.',
  // Hollowmere (zone 2 haunted fen) + harvest channel label
  'abilityUi.cast.harvest': '수확하는 중',
  'entities.mobs.grinning_jack.name': '히죽이는 잭',
  'entities.mobs.marsh_hag.name': '습지 마녀',
  'entities.mobs.wispford_dead.name': '위스프포드의 망자',
  'entities.mobs.fen_revenant.name': '늪지 망령',
  'entities.mobs.hexbound_crone.name': '저주에 묶인 노파',
  'entities.mobs.grave_sentinel.name': '무덤 파수꾼',
  'entities.mobs.mausoleum_shambler.name': '영묘의 비틀걸음이',
  'entities.mobs.crypt_hexward.name': '납골당 주술파수꾼',
  'entities.mobs.bonepile_horror.name': '뼈무더기 공포',
  'entities.mobs.pumpkin_spriteling.name': '호박 정령',
  'entities.mobs.grinning_king.name': '호박 왕',
  'entities.npcs.morvenna_hedgewitch.name': '모르베나',
  'entities.npcs.morvenna_hedgewitch.title': '산울타리 마녀',
  'entities.npcs.morvenna_hedgewitch.greeting':
    '등불 빛에서 벗어나지 마시오, {className}. 늪은 해질녘이면 제 망자들을 토해내고, 내가 엮은 결계는 짐승 기름이 타는 동안에만 버티지요. 내가 청하는 것을 가져다주면, 위스프포드를 하룻밤 더 숨 쉬게 해드리리다.',
  'entities.npcs.gravewarden_holt.title': '무덤지기',
  'entities.npcs.gravewarden_holt.greeting':
    '이 사람들 대부분을 내 손으로 묻었소, {playerName}. 그런데 이제 그들을 두 번째로 땅에 묻고 있구려. 북쪽 끝의 무덤문은 한평생 봉인된 적이 없소. 그 아래 무언가가 죽은 자들을 일으키고 있소.',
  'entities.dungeons.sunken_mausoleum.name': '가라앉은 영묘',
  'entities.dungeons.sunken_mausoleum.enterText':
    '그대는 무덤문을 지나 축축한 돌과 짐승 기름 악취 속으로 내려가고, 저 아래 어딘가에서 무언가가 어둠 속에서 히죽이고 있다.',
  'entities.dungeons.sunken_mausoleum.leaveText':
    '그대는 무덤문 계단을 올라 등불이 밝혀진 늪으로 돌아온다.',
  'entities.quests.q_hollowmere_risen.title': '잠들지 못하는 늪',
  'entities.quests.q_hollowmere_risen.text':
    '이제 해질녘마다 그들이 늪에서 기어 나오고 있소, {playerName}. 위스프포드의 망자들이, 우리가 묻어준 그 누더기를 그대로 걸친 채로. 그들이 마을 울타리에 닿기 전에 열을 다시 뉘어주시오. 참혹한 일이나, 자비이기도 하오.',
  'entities.quests.q_hollowmere_risen.completion':
    '열이 진흙 속으로 돌아갔소. 그들은 싸우지 않소, {playerName}, 진정 그렇지 않지. 그저 불빛을 향해 걸을 뿐이오. 그들을 부르는 것이 무엇이든, 무덤문 아래에서 부르고 있소.',
  'entities.quests.q_hollowmere_risen.objectives.0.label': '처치한 위스프포드의 망자',
  'entities.quests.q_hollowmere_revenants.title': '모르베나의 결계',
  'entities.quests.q_hollowmere_revenants.text':
    '내 결계를 엮는 창백한 무덤 이끼는 늪에 닿은 망자가 쓰러진 자리에만 뿌리를 내린다오, {playerName}. 늪지 망령들은 지나는 곳마다 그 이끼를 짓밟아 뭉개버리지요. 묘지 가장자리를 따라 여덟을 베어 넘기면, 이끼가 그들이 차지했던 땅 위로 다시 기어들 것이오.',
  'entities.quests.q_hollowmere_revenants.completion':
    '그들이 쓰러진 자리에 벌써 이끼가 푸르러지고 있소. 됐군요. 마을을 두른 결계가 하룻밤 더 버틸 것이고, 그것을 태울 짐승 기름도 있소. 그대가 이 사람들에게 시간을 벌어주었소, {playerName}.',
  'entities.quests.q_hollowmere_revenants.objectives.0.label': '쓰러뜨린 늪지 망령',
  'entities.quests.q_hollowmere_crones.title': '기나긴 어둠을 밝혀라',
  'entities.quests.q_hollowmere_crones.text':
    '오래된 결계 등불들이 무덤문으로 향하는 길을 따라 늘어서 있소, {playerName}. 저주에 묶인 노파들은 해질녘이면 그 길을 기어다니며 지나는 불꽃마다 꺼뜨려, 망자들이 어두운 길을 걷게 하지요. 그들 여섯을 베어 넘기면, 결계 등불이 다시 밤새도록 타오를 것이오.',
  'entities.quests.q_hollowmere_crones.completion':
    '길이 다시 빛나고, 되살아난 것들이 쉭쉭거리며 물러서 있소. 영원히 버티지는 못하오, {playerName}. 저 아래 무언가는 참을성이 깊고, 불꽃은 그저 짐승 기름일 뿐이니.',
  'entities.quests.q_hollowmere_crones.objectives.0.label': '침묵시킨 저주에 묶인 노파',
  'entities.quests.q_hollowmere_sentinel.title': '무덤 파수꾼',
  'entities.quests.q_hollowmere_sentinel.text':
    '이 늪에서 되살아난 시체가 아닌 것이 하나 있소, {playerName}. 바로 무덤 파수꾼, 저 아래 그것이 무덤문 길을 지키라고 세운 화톳불 머리의 감시자요. 그것이 서 있는 한, 누구도 산 채로 문에 닿지 못하오. 칼 하나로 쓰러뜨리기엔 벅찬 상대지만, 깊은 곳의 망자가 파수를 세울 만큼 두려워하는 것이 무엇인지 엿볼 드문 기회요. 끝내주시오.',
  'entities.quests.q_hollowmere_sentinel.completion':
    '히죽이던 웃음이 스러지고, 마침내 문으로 가는 길이 열렸소. 저 파수꾼에게 왕관을 씌운 것이 무엇이든, {playerName}, 이제 가까이 있소. 홀트가 내려가는 길이 뚫렸다는 걸 알고 싶어할 것이오.',
  'entities.quests.q_hollowmere_sentinel.objectives.0.label': '파괴한 무덤 파수꾼',
  'entities.quests.q_hollowmere_pumpkin_king.title': '호박 왕',
  'entities.quests.q_hollowmere_pumpkin_king.text':
    '파수꾼이 쓰러지고 문으로 가는 길이 열리니, 저 아래 무엇이 기다리는지 알겠소, {playerName}. 가라앉은 영묘 안에서, 옛 노랫말이 호박 왕이라 부르던 화톳불 머리의 것이 스스로 망자의 왕으로 즉위하여, 제 궁정을 채우려 늪의 모든 시체를 일으키고 있소. 동료들을 이끌고 무덤문 아래로 내려가 그 머리를 베어버리시오. 이건 홀로 든 칼이 감당할 일이 아니오.',
  ...
  'hudChrome.bank.none': '근처에 은행이 없습니다.',
  'hudChrome.bank.full': '은행이 가득 찼습니다.',
  'hudChrome.bank.notInBank': '그 아이템은 은행에 없습니다.',
  'hudChrome.bank.open': '은행',
  'hudChrome.bank.title': '{name}의 금고',
  'hudChrome.bank.close': '은행 닫기',
  'hudChrome.bank.bankedTitle': '금고 안',
  'hudChrome.bank.bankedEmpty': '금고가 비어 있습니다.',
  'hudChrome.bank.bagsTitle': '가방',
  'hudChrome.bank.bagsEmpty': '가방이 비어 있습니다.',
  'hudChrome.bank.withdrawAria': '{item} 인출',
  'hudChrome.bank.depositAria': '{item} 예치',
  'hudChrome.bank.clickWithdraw': '클릭하여 인출',
  'hudChrome.bank.clickDeposit': '클릭하여 예치',
  'hudChrome.bank.hint': '가방 아이템을 클릭하여 보관하거나 금고 아이템을 클릭하여 되찾으세요.',
  'hudChrome.bank.fullHint': '금고가 가득 찼습니다. 무언가를 인출하여 공간을 만드세요.',
  'hudChrome.bank.deposited': '{name}을(를) 예치했습니다.',
  'hudChrome.bank.withdrew': '{name}을(를) 인출했습니다.',
  'entities.npcs.banker_thistle.name': '금고지기 시슬',
  ...
  'hudChrome.mounts.active': '사용 중',
  'hudChrome.mounts.close': '탈것 창 닫기',
  'hudChrome.mounts.summonAria': '{name} 소환',
  'hudChrome.mounts.dismissAria': '{name} 해제',
  ...
  'entities.npcs.stablemaster_marla.greeting':
    '마구간 문은 열려 있습니다, {className}. 여기 있는 탈것들은 모두 정성껏 길러져 온순하게 잘 달립니다. 다만 블룸스트라이더는... 그건 길러진 것이 아니라 자라난 것이라, 한 번도 길들여진 적이 없지요.',
  ...
  'hudChrome.mounts.errors.alreadyHaveReins': '이미 그 고삐를 가지고 있습니다.',
  'hudChrome.mounts.errors.fiestaBout': '피에스타 경기 중에는 할 수 없습니다.',
  'entities.quests.q_riding_lessons.title': '승마 수업',
  'entities.quests.q_riding_lessons.text':
    '타고 싶다고요, {className}? 그렇다면 길에 나서기 전에 먼저 마당부터 배워야 합니다. 제 연습 코스를 돌아 보세요. 낮은 가로대, 건초 더미, 그리고 마지막으로 나무 아치를 다시 통과하는 겁니다. 자, 가세요! 모든 장애물을 넘은 다음 아치를 지나 타고 돌아오세요.',
  'entities.quests.q_riding_lessons.completion':
    '손도 안정되고 자세도 안정적이군요. 되겠습니다. 수고했으니 이걸 받으세요. 첫 고삐를 사기에 충분할 겁니다. 성미가 맞는 탈것을 고르시고, 블룸스트라이더는 조심하세요. 그 녀석은 제 기수를 직접 고르니까요.',
  'entities.quests.q_riding_lessons.objectives.0.label': '낮은 가로대 통과',
  'entities.quests.q_riding_lessons.objectives.1.label': '건초 더미 통과',
  'entities.quests.q_riding_lessons.objectives.2.label': '나무 아치를 타고 통과',
  'entities.mounts.mount_alpaca.name': '하이필드 알파카',
  'entities.mounts.mount_bull.name': '무쇠가죽 황소',
  'entities.mounts.mount_boar.name': '가시등 멧돼지',
  'entities.mounts.mount_bloomstrider.name': '신록의 블룸스트라이더',
  'entities.mounts.mount_swift_alpaca.name': '날쌘 하이필드 알파카',
  'entities.mounts.mount_swift_bull.name': '날쌘 무쇠가죽 황소',
  'entities.mounts.mount_swift_boar.name': '날쌘 가시등 멧돼지',
  'entities.mounts.mount_elder_bloomstrider.name': '원로 블룸스트라이더',
  'guide.nav.mounts': '탈것',
  'guide.mountsPage.heading': '탈것',
  'guide.mountsPage.intro':
    '탈것은 당신을 태우고 멋지게 대륙을 누빕니다. 블룸헤이븐 마구간에서 타는 법을 배우고 성미가 맞는 동반자를 고르면 길이 한결 짧아집니다.',
  'guide.mountsPage.whatHeading': '승마 방식',
  'guide.mountsPage.whatBody':
    '탈것은 한 번만 해금하면 됩니다. 마구간에서 고삐를 사서 배우면 영원히 당신의 것입니다. 전투 중이 아니고 마른 땅 위라면 언제든 소환할 수 있으며, 공격을 받거나 시전을 시작하거나 물에 잠기면 다시 두 발로 서게 됩니다.',
  'guide.mountsPage.tiersHeading': '승마와 날쌘 승마',
  'guide.mountsPage.tiersBody':
    '마구간은 두 무리를 기릅니다. 일반 탈것이 첫걸음이고, 날쌘 탈것은 같은 온순한 무리를 더 빠르게 길러낸 것입니다. 같은 단계 안에서는 모든 탈것의 속도가 같으므로, 선택 기준은 성미와 겉모습이지 속도가 아닙니다.',
  'guide.mountsPage.exclusiveHeading': '블룸스트라이더',
  'guide.mountsPage.exclusiveBody':
    '신록의 블룸스트라이더와 원로 블룸스트라이더 두 마리는 길러진 것이 아니라 자라난 것으로, 마구간이 $GROW로 판매하는 한정 탈것입니다. 어디까지나 명예의 상징일 뿐, 같은 단계 안에서는 다른 모든 탈것과 정확히 같은 속도입니다.',
  'guide.mountsPage.whereHeading': '배우는 곳',
  'guide.mountsPage.whereBody':
    '{level}레벨에 도달하면 시작의 골짜기에 있는 블룸헤이븐 마구간을 찾아가세요. 마구간지기가 먼저 연습 코스에서 승마 수업을 해 주고, 판매하는 고삐는 두 단계를 모두 아우릅니다.',
  'guide.mountsPage.fromLevel': '{n} 레벨부터',
  'guide.mountsPage.ridingTier': '승마',
  'guide.mountsPage.swiftTier': '날쌘',
  'guide.mountsPage.exclusiveTag': '$GROW 한정',
  'entities.items.reins_swift_highfield_alpaca.name': '날쌘 하이필드 알파카의 고삐',
  'entities.items.reins_swift_ironhide_bull.name': '날쌘 무쇠가죽 황소의 고삐',
  'entities.items.reins_swift_thornback_boar.name': '날쌘 가시등 멧돼지의 고삐',
  'entities.items.reins_elder_bloomstrider.name': '원로 블룸스트라이더 고삐',
  'entities.items.verdant_wardrobe_crate.name': '신록의 의상 상자',
  'entities.items.course_low_rail.name': '낮은 가로대 장애물',
  'entities.items.course_hay_bales.name': '건초 더미 장애물',
  'entities.items.course_timber_arch.name': '나무 아치',
};
