...
export const ko_KR: Partial<Record<TranslationKey, string>> = {
  ...
  'seo.officialBody':
    'Growverse는 포털로 이어진 세계를 배경으로 한 칸나비스 판타지 무료 브라우저 MMORPG입니다. 괴물과 싸우고, 퀘스트를 완료하고, 전문 기술을 연마하고, 마법의 품종을 재배하세요. 브라우저에서 즉시 플레이하고, 혼자서 세계를 탐험하고, 위키를 읽고, 이 사이트에서 개발 소식을 확인할 수 있습니다.',
  ...
  'seo.title': 'Growverse: The Portal Chronicles, 무료 브라우저 MMORPG',
  'seo.description':
    'Growverse는 칸나비스 판타지 세계관의 무료 브라우저 MMORPG입니다. 포털로 이어진 세계를 탐험하고, 괴물과 싸우고, 퀘스트를 완료하고, 마법의 품종을 재배하며, 끊임없이 진화하는 렐름에서 자신만의 전설을 만들어 보세요. 다운로드 없이 즉시 플레이할 수 있습니다.',
  'seo.genre': 'MMORPG',
  'seo.playMode': '멀티플레이어',
  ...
  'hudChrome.account.sectionWallet': 'Growverse 지갑',
  ...
  'guide.tagline': '브라우저에서 무료로 즐기는 칸나비스 판타지 MMORPG입니다.',
  ...
  'guide.footer.blurb':
    '오픈 소스로 만든 칸나비스 판타지 MMORPG입니다. 퀘스트를 수행하고, 파티를 맺고, 포털로 이어진 세계를 브라우저에서 바로 탐험하세요.',
  ...
  'guide.home.eyebrow': '칸나비스 판타지 브라우저 MMORPG',
