...
export const ko_KR: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.quests.q_first_harvest.text': '재배자는 누구나 같은 자리에서 시작하지. 이랑 하나, 씨앗 하나, 그리고 건드리지 않고 기다리는 인내심. 무언가를 심고, 끝까지 자라게 둔 다음, 거기서 나온 것을 내게 가져오게. 더 좋은 종자를 맡기기 전에 자네가 작물을 어떻게 다루는지부터 봐야겠어.',
  'entities.quests.q_first_harvest.completion': '이것 좀 보게. 깔끔하게 손질했고 서두른 티가 하나도 없군. 자네는 이 일에 맞는 손을 가졌어.',
  'entities.quests.q_first_harvest.objectives.0.label': '평범한 꽃봉오리',
  'entities.quests.q_fine_supply.title': '조금 더 좋은 것',
  'entities.quests.q_fine_supply.text': '평범한 물건으로도 등불은 밝히지만, 그걸로 누군가를 감탄시키지는 못하지. 나는 더 좋은 재료가 필요하고, 자네가 그걸 어디서 구해오든 별로 상관하지 않네. 참을성이 있으면 직접 교배해서 얻고, 없으면 그렇게 해낸 사람에게서 사 오게. 돈을 쥔 재배자도 여전히 재배자니까.',
  'entities.quests.q_fine_supply.completion': '이 정도면 제대로 건조할 값어치가 있군. 이걸 길러낸 자는 뭘 아는 사람이야. 그게 자네라면 더 좋고.',
  'entities.quests.q_fine_supply.objectives.0.label': '상급 꽃봉오리',
  'entities.quests.q_prime_order.title': '재배자의 주문서',
  'entities.quests.q_prime_order.text': '한 번도 채워본 적 없는 상시 주문이 하나 있네. 최상급 재료, 그 아래로는 안 돼. 그러려면 끝까지 제대로 교배된 품종이 있어야 하고, 그건 몇 해에 걸쳐 직접 교배하거나 이미 해낸 누군가와 좋은 관계를 맺어야 한다는 뜻이지. 어느 쪽이든 이걸 채워주면 오두막 전체가 자네 이름을 기억할 걸세.',
  'entities.quests.q_prime_order.completion': '최상급 여섯. 긴 계절을 기다렸네. 오두막이 자네에게 빚을 졌고, 나도 마찬가지야.',
