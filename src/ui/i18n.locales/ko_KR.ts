...
export const ko_KR: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.items.glassscale_mail.name': '유리비늘 사슬갑옷',
  'entities.items.sunbleached_leathers.name': '햇볕에 바랜 가죽갑옷',
  'entities.items.sunspun_robes.name': '햇살로 자은 로브',
  'entities.items.sunforged_blade.name': '태양으로 벼린 검',
  'entities.items.sunforged_dagger.name': '태양으로 벼린 단검',
  'entities.items.sunforged_scepter.name': '태양으로 벼린 셉터',
