...
export const ko_KR: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.professions.mining': '채광',
  'hudChrome.professions.herbalism': '약초 채집',
  'hudChrome.professions.logging': '벌목',
  'hudChrome.professions.cultivation': '재배',
  'hudChrome.professions.fishing': '낚시',
  'hudChrome.professions.cooking': '요리',
  ...
  'hudChrome.loadouts.hint': '특성 패널에서 장비 + 특성 세트를 저장하세요.',
  'hudChrome.loadouts.applyAria': '장비 세트 적용: {name}',
  'hudChrome.overview.tablistAria': '캐릭터 시트 보기',
  'hudChrome.overview.gearTab': '캐릭터',
  'hudChrome.overview.overviewTab': '개요',
  ...
  'entities.npcs.cup_steward_wilder.name': '와일더',
  'entities.npcs.cup_steward_wilder.title': '밸리 컵 관리인',
  'entities.npcs.cup_steward_wilder.greeting':
    '컵이 열렸습니다, {className}. 품종 하나와 거기서 딴 꽃봉오리 열 개를 가져오시면 순위표에 이름을 올려 드리지요. 심사는 유전, 가져온 등급, 그리고 그 식물을 얼마나 아는지. 셋 다 아니면 그냥 출품일 뿐입니다.',
  ...
  'hudChrome.questTracker.timeLabel': '남은 시간: {time}',
  ...
  'hudChrome.cup.season': '{season} 시즌',
  'hudChrome.cup.remainingHours': '{hours}시간 {minutes}분 남음',
  'hudChrome.cup.remainingMinutes': '{minutes}분 남음',
  'hudChrome.cup.best': '내 최고 점수: {score}',
  'hudChrome.cup.emptyBoard': '이번 시즌 출품이 아직 없습니다. 순위표를 여는 건 당신입니다.',
  'hudChrome.cup.gradeLabel': '꽃봉오리 등급',
  'hudChrome.cup.strainLabel': '품종',
  'hudChrome.cup.noBuds': '출품할 꽃봉오리가 없습니다. 먼저 수확하세요.',
  'hudChrome.cup.noStrains': '품종이 아직 없습니다. 수확하면 하나 발견합니다.',
  'hudChrome.cup.projected': '{score}점',
  'hudChrome.cup.enter': '출품 (꽃봉오리 {count}개, {score}점)',
  'hudChrome.cup.posted': '{strain}이(가) {score}점으로 {rank}위에 올랐습니다.',
  ...
  'hudChrome.garden.tend': '돌보기',
  'hudChrome.garden.tendCount': '돌봄 {tends}/{total}',
  'hudChrome.garden.tendNudge': '{count}그루가 돌볼 준비가 되었습니다.',
  ...
  'entities.items.bud_fine.name': '상급 꽃봉오리',
  'entities.items.bud_prime.name': '최상급 꽃봉오리',
  'entities.items.cured_flower_fine.name': '상급 건조 꽃',
  'entities.items.cured_flower_prime.name': '최상급 건조 꽃',
  'entities.items.pressed_resin_fine.name': '상급 압착 수지',
  ...
  'entities.quests.q_first_harvest.completion':
    '이것 좀 보게. 깔끔하게 손질했고 서두른 티가 하나도 없군. 자네는 이 일에 맞는 손을 가졌어.',
  'entities.quests.q_first_harvest.objectives.0.label': '평범한 꽃봉오리',
  'entities.quests.q_fine_supply.title': '조금 더 좋은 것',
  'entities.quests.q_fine_supply.text':
    '평범한 물건으로도 등불은 밝히지만, 그걸로 누군가를 감탄시키지는 못하지. 나는 더 좋은 재료가 필요하고, 자네가 그걸 어디서 구해오든 별로 상관하지 않네. 참을성이 있으면 직접 교배해서 얻고, 없으면 그렇게 해낸 사람에게서 사 오게. 돈을 쥔 재배자도 여전히 재배자니까.',
  'entities.quests.q_fine_supply.completion':
    '이 정도면 제대로 건조할 값어치가 있군. 이걸 길러낸 자는 뭘 아는 사람이야. 그게 자네라면 더 좋고.',
  'entities.quests.q_fine_supply.objectives.0.label': '상급 꽃봉오리',
  'entities.quests.q_prime_order.title': '재배자의 주문서',
  'entities.quests.q_prime_order.text':
    '한 번도 채워본 적 없는 상시 주문이 하나 있네. 최상급 재료, 그 아래로는 안 돼. 그러려면 끝까지 제대로 교배된 품종이 있어야 하고, 그건 몇 해에 걸쳐 직접 교배하거나 이미 해낸 누군가와 좋은 관계를 맺어야 한다는 뜻이지. 어느 쪽이든 이걸 채워주면 오두막 전체가 자네 이름을 기억할 걸세.',
  'entities.quests.q_prime_order.completion':
    '최상급 여섯. 긴 계절을 기다렸네. 오두막이 자네에게 빚을 졌고, 나도 마찬가지야.',
  'entities.quests.q_prime_order.objectives.0.label': '최상급 꽃봉오리',
};
