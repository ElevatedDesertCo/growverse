...
export const ru_RU: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.mounts.active': 'Активен',
  'hudChrome.mounts.close': 'Закрыть окно транспорта',
  'hudChrome.mounts.summonAria': 'Призвать: {name}',
  'hudChrome.mounts.dismissAria': 'Спешиться: {name}',
  ...
  'hudChrome.mounts.errors.alreadyHaveReins': 'У вас уже есть эти поводья.',
  'hudChrome.mounts.errors.fiestaBout': 'Во время матча Фиесты это невозможно.',
  'entities.quests.q_riding_lessons.title': 'Уроки верховой езды',
  'entities.quests.q_riding_lessons.text':
    'Хотите ездить верхом, {className}? Тогда сначала освойте двор, а уж потом дорогу. Пройдите мой учебный маршрут: низкий барьер, стога сена, а затем обратно через деревянную арку. Вперед! Возьмите каждое препятствие и вернитесь верхом через арку.',
  'entities.quests.q_riding_lessons.completion':
    'Твердая рука, уверенная посадка. Вы справитесь. Возьмите это за труды: должно хватить на первые поводья. Выберите скакуна себе по нраву, и остерегайтесь Цветущего Странника: этот сам выбирает своего всадника.',
  'entities.quests.q_riding_lessons.objectives.0.label': 'Низкий барьер взят',
  'entities.quests.q_riding_lessons.objectives.1.label': 'Стога сена взяты',
  'entities.quests.q_riding_lessons.objectives.2.label': 'Деревянная арка пройдена верхом',
  'entities.mounts.mount_alpaca.name': 'Альпака с Верхних полей',
  'entities.mounts.mount_bull.name': 'Железношкурый бык',
  'entities.mounts.mount_boar.name': 'Тернистый вепрь',
  'entities.mounts.mount_bloomstrider.name': 'Цветущий Странник',
  'entities.mounts.mount_swift_alpaca.name': 'Быстрая альпака с Верхних полей',
  'entities.mounts.mount_swift_bull.name': 'Быстрый железношкурый бык',
  'entities.mounts.mount_swift_boar.name': 'Быстрый тернистый вепрь',
  'entities.mounts.mount_elder_bloomstrider.name': 'Древний Цветущий Странник',
  'guide.nav.mounts': 'Транспорт',
  'guide.mountsPage.heading': 'Транспорт',
  'guide.mountsPage.intro':
    'Верховые животные с ветерком несут вас через весь мир. Научитесь верховой езде в конюшнях Блумхейвена, выберите спутника себе по нраву, и дороги станут куда короче.',
  'guide.mountsPage.whatHeading': 'Как устроена верховая езда',
  'guide.mountsPage.whatBody':
    'Каждый скакун открывается один раз: купите его поводья в конюшне, обучитесь, и он ваш навсегда. Призывайте его вне боя и на суше; удар, начало заклинания или погружение в воду вернут вас на собственные ноги.',
  'guide.mountsPage.tiersHeading': 'Верховая езда и быстрая езда',
  'guide.mountsPage.tiersBody':
    'Конюшня растит два поголовья. Обычные скакуны, это первый шаг, а быстрые, это то же спокойное поголовье, выращенное резвее. Внутри одного разряда все скакуны движутся с одинаковой скоростью, так что выбор, это нрав и облик, но никогда не скорость.',
  'guide.mountsPage.exclusiveHeading': 'Цветущие Странники',
  'guide.mountsPage.exclusiveBody':
    'Два скакуна, Цветущий Странник и Древний Цветущий Странник, не выращены, а выросли сами, и продаются в конюшне только за $GROW. Это скакуны престижа: внутри своего разряда они ровно так же быстры, как и любой другой.',
  'guide.mountsPage.whereHeading': 'Где научиться',
  'guide.mountsPage.whereBody':
    'Достигнув уровня {level}, загляните в конюшни Блумхейвена в стартовой долине. Смотрительница конюшен начнет с уроков верховой езды на учебном маршруте, а поводья в продаже покрывают оба разряда.',
  'guide.mountsPage.fromLevel': 'С уровня {n}',
  'guide.mountsPage.ridingTier': 'Верховая',
  'guide.mountsPage.swiftTier': 'Быстрая',
  'guide.mountsPage.exclusiveTag': 'Только за $GROW',
  'entities.items.reins_swift_highfield_alpaca.name': 'Поводья быстрой альпаки с Верхних полей',
  'entities.items.reins_swift_ironhide_bull.name': 'Поводья быстрого железношкурого быка',
  'entities.items.reins_swift_thornback_boar.name': 'Поводья быстрого тернистого вепря',
  'entities.items.reins_elder_bloomstrider.name': 'Поводья Древнего Цветущего Странника',
  'entities.items.verdant_wardrobe_crate.name': 'Зеленеющий гардеробный сундук',
  'entities.items.course_low_rail.name': 'Низкий барьер',
  'entities.items.course_hay_bales.name': 'Стога сена',
  'entities.items.course_timber_arch.name': 'Деревянная арка',
};
