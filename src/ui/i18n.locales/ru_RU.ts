...
export const ru_RU: Partial<Record<TranslationKey, string>> = {
  ...
  'auth.designCodeImportedPartial':
    'Облик импортирован. Значения, неизвестные этой версии, были пропущены.',
  'auth.designCodeImported': 'Облик импортирован.',
  'auth.designCodeHint':
    'Скопируйте этот код, чтобы сохранить облик или поделиться им. Вставьте код сюда и импортируйте, чтобы загрузить облик.',
  'auth.designCodeErrVersion': 'Этот код облика создан в более новой версии игры.',
  'auth.designCodeErrMalformed':
    'Этот код облика повреждён. Скопируйте код целиком и попробуйте снова.',
  'auth.designCodeErrHeader': 'Это не похоже на код облика.',
  'auth.designCodeErrEmpty': 'Сначала вставьте код облика.',
  'auth.designCodeCopyManual':
    'Автоматическое копирование здесь недоступно. Код выделен, скопируйте его с клавиатуры.',
  'auth.designCodeCopied': 'Код облика скопирован.',
  'auth.designCode': 'Код облика',
  'auth.customColor': 'Свой цвет',
  'auth.copyCode': 'Копировать код',
  'auth.colorWheelAria':
    'Цветовой круг {label}: перетаскивайте, чтобы выбрать оттенок и насыщенность',
  ...
  'hudChrome.professions.mining': 'Горное дело',
  'hudChrome.professions.herbalism': 'Травничество',
  'hudChrome.professions.logging': 'Лесозаготовка',
  'hudChrome.professions.cultivation': 'Выращивание',
  'hudChrome.professions.fishing': 'Рыбалка',
  ...
  'hudChrome.overview.tablistAria': 'Виды листа персонажа',
  'hudChrome.overview.gearTab': 'Персонаж',
  'hudChrome.overview.overviewTab': 'Обзор',
  ...
  'playerCard.defaultRealm': 'Мир Growverse',
  ...
  'playerCard.shareText':
    'Я создаю свою легенду в Growverse: уровень {level}, {className}{tierBit}. Присоединяйтесь к моему миру:',
  'playerCard.nativeShareTitle': 'Мир Growverse',
  ...
  'a11y.githubProject': 'Открыть проект Growverse на GitHub',
  'a11y.discordCommunity': 'Присоединиться к Discord-сообществу Growverse',
  'a11y.donateProject': 'Пожертвовать на поддержку Growverse',
  ...
  'mobilePreflight.androidOpenStep': 'Откройте Growverse через новый значок.',
  ...
  'serverUnavailable.title': 'Growverse - мир недоступен',
  ...
  'entities.items.restful_bloom_tonic.name': 'Успокаивающий цветочный тоник',
  ...
  'entities.npcs.cup_steward_wilder.name': 'Уайлдер',
  'entities.npcs.cup_steward_wilder.title': 'Распорядитель Кубка Долины',
  'entities.npcs.cup_steward_wilder.greeting':
    'Кубок открыт, {className}. Принесите штамм и десять бутонов с него, и я впишу ваше имя в таблицу. Судим по генетике, по принесённому сорту и по тому, насколько вы знаете растение. Всё три, иначе вы просто участник.',
  ...
  'entities.quests.q_greyrot.title': 'Серая гниль',
  'entities.quests.q_greyrot.text':
    'Здесь Блум не вянет так, как на сухих равнинах, {playerName}. Он тонет. Сереет, размякает, и гниль идёт от корня к корню, пока целая терраса не превращается в жижу. А над каждым тронутым участком уже сносит болотных раздутней. Вскрой десяток на западной отмели и расскажи мне, что из них вышло.',
  'entities.quests.q_greyrot.completion':
    'Споры, говоришь. Плотно уложенные и все одного размера. Это не погода, {playerName}, и не случайность. Кто-то выращивает эту гниль и направляет её на наши сады.',
  'entities.quests.q_greyrot.objectives.0.label': 'Болотный раздутень: убито',
  'entities.quests.q_burn_the_beds.title': 'Выжечь гнёзда',
  'entities.quests.q_burn_the_beds.text':
    'Яра просит целый сезон, чтобы вывести что-то, что перерастёт гниль. У меня нет сезона. У меня есть гать, на которой держатся две сотни человек, и гниль, идущая прямо на неё. Выжги гнёзда раздутней на западной отмели, {playerName}. Двенадцати хватит, чтобы прервать их дрейф. Топь станет беднее, а я всё равно буду спать.',
  'entities.quests.q_burn_the_beds.completion':
    'Отмель в золе, дрейф встал у самой воды. Решение было верным, и Яра теперь месяц со мной не заговорит. Забирай плату.',
  'entities.quests.q_burn_the_beds.objectives.0.label': 'Болотный раздутень: убито',
  'entities.quests.q_seed_the_shallows.title': 'Засеять отмели',
  'entities.quests.q_seed_the_shallows.text':
    'Огонь оставляет отмель голой, а голая земля и есть то, куда гниль пойдёт дальше. Я предпочла бы вытеснить её зеленью. У меня есть черенки, выведенные из блумхейвенского маточника, они укореняются даже в стоячей воде. Но глубинные щелкуны обирают отмели от всего зелёного за сутки. Расчисти двенадцать на восточном берегу, и я высажу черенки.',
  'entities.quests.q_seed_the_shallows.completion':
    'Черенки высажены, и вода их пока не тронула. Это медленнее, чем хотелось бы Стражу, и доказать пользу будет ещё медленнее. Но если они удержатся, топь сохранит свою зелень, а не выменяет её на золу.',
  'entities.quests.q_seed_the_shallows.objectives.0.label': 'Глубинный щелкун: убито',
  'entities.quests.q_ash_and_water.title': 'Зола и вода',
  'entities.quests.q_ash_and_water.text':
    'Выжигание сработало и купило мне новую беду, потому что эта топь платит по долгам именно так. Дым поднял утопших с мелководья, и теперь они стоят в золе на месте гнёзд и не ждут ничего. Уложи десятерых обратно, пока они не нашли гать.',
  'entities.quests.q_ash_and_water.completion':
    'Зола, и мертвецы, стоящие в ней. Огонь выбрал я, {playerName}, и выбрал бы снова. Но пусть никто не говорит тебе, что это обошлось даром.',
  'entities.quests.q_ash_and_water.objectives.0.label': 'Утопший мертвец: упокоено',
  'entities.quests.q_first_green.title': 'Первая зелень',
  'entities.quests.q_first_green.text':
    'Черенки принялись, {playerName}. Впервые с тех пор, как поднялась топь, на отмелях есть зелень, и тролли уже спустились с курганов и выдирают её горстями. Отгони десятерых обратно на восток. Каждый день, что эти корни держатся, гниль вынуждена обходить их стороной.',
  'entities.quests.q_first_green.completion':
    'Всё ещё стоят, всё ещё зелёные. Этот год топи они не спасут. Но моя бабушка посадила блумхейвенскую террасу и тоже не дожила до её цветения, так что я приму полную отмель черенков и назову это хорошим сезоном.',
  'entities.quests.q_first_green.objectives.0.label': 'Мирефенский тролль: убито',
  ...
  'entities.items.bloom_essence.name': 'Эссенция цветения',
  'entities.items.ember_essence.name': 'Эссенция углей',
  'entities.items.flow_essence.name': 'Эссенция потока',
  'entities.items.spore_essence.name': 'Эссенция спор',
  'entities.items.common_seed.name': 'Обычное семя',
  'entities.items.corruption_shard.name': 'Осколок порчи',
  'entities.items.bloom_nutrient.name': 'Питательная смесь цветения',
  'entities.items.ember_nutrient.name': 'Питательная смесь углей',
  'entities.items.flow_nutrient.name': 'Питательная смесь потока',
  'entities.items.enriched_seed.name': 'Обогащённое семя',
  'entities.items.prime_strain_seed.name': 'Семя первичного штамма',
  'entities.items.bloom_lamp.name': 'Лампа цветения',
  'entities.items.irrigation_coil.name': 'Оросительный змеевик',
  'entities.items.shard_whetstone.name': 'Точильный камень осколков',
  ...
  'hudChrome.questTracker.timeLabel': 'Осталось времени: {time}',
  ...
  'guide.worldPage.intro':
    'Growverse - это единый цельный край, который вы пересекаете пешком, три зоны, протянувшиеся с юга на север. Здесь нет быстрых перемещений, так что дорога - это часть приключения.',
  ...
  'hudChrome.nativeUpdate.body':
    'Доступна новая версия Growverse. Обновите сейчас, чтобы получить последние исправления и улучшения.',
  'hudChrome.nativeUpdate.bodyWithVersion':
    'Доступна версия {version} Growverse. Обновите сейчас, чтобы получить последние исправления и улучшения.',
  ...
  'entities.npcs.cultivator_marlow.name': 'Марлоу',
  'entities.npcs.cultivator_marlow.title': 'Культиватор',
  'entities.npcs.cultivator_marlow.greeting':
    'Станция выращивания в твоём распоряжении, друг. Питательные смеси, сорта семян, снаряжение для выращивания. Что нужно растениям?',
  'entities.npcs.smith_draxa.name': 'Дракса',
  'entities.npcs.smith_draxa.title': 'Кузнец Разлома',
  'entities.npcs.smith_draxa.greeting':
    'Верстак улучшений раскалён. Принеси мне осколки Порчи, и я перекую твою сталь в то, что не сломит и сам Разлом.',
  'hudChrome.crafting.growTitle': 'Станция выращивания',
  'hudChrome.crafting.upgradeTitle': 'Верстак улучшений',
  'hudChrome.crafting.growHint':
    'Создавайте питательные смеси, улучшайте сорта семян и собирайте снаряжение для выращивания.',
  'hudChrome.crafting.upgradeHint':
    'Перековывайте снаряжение и вырезайте боевые расходники из осколков Порчи.',
  'hudChrome.crafting.craftButton': 'Создать',
  ...
  'hudChrome.cup.hint':
    'Судят по генетике, по принесённому сорту бутонов и по тому, насколько вы знаете растение.',
  'hudChrome.cup.season': 'Сезон {season}',
  'hudChrome.cup.remainingHours': 'Осталось {hours} ч {minutes} мин',
  'hudChrome.cup.remainingMinutes': 'Осталось {minutes} мин',
  'hudChrome.cup.best': 'Ваш лучший результат: {score}',
  'hudChrome.cup.emptyBoard': 'В этом сезоне заявок ещё нет. Открыть таблицу вам.',
  'hudChrome.cup.gradeLabel': 'Сорт бутонов',
  'hudChrome.cup.strainLabel': 'Штамм',
  'hudChrome.cup.noBuds': 'Нет бутонов для заявки. Сначала соберите урожай.',
  'hudChrome.cup.noStrains': 'Штаммов пока нет. Соберите урожай, чтобы открыть первый.',
  'hudChrome.cup.projected': 'Даст {score}',
  'hudChrome.cup.enter': 'Участвовать ({count} бутонов, {score} очков)',
  'hudChrome.cup.posted': '{strain} в таблице с результатом {score}, место {rank}.',
  'hudChrome.garden.title': 'Сад',
  'hudChrome.garden.hint': 'Сажайте семена на грядках и собирайте Цветение.',
  'hudChrome.garden.seedLabel': 'Семя для посадки',
  'hudChrome.garden.noSeeds': 'Нет семян для посадки. Создайте их на Грядке.',
  ...
  'hudChrome.breeding.potency': 'Сила',
  'hudChrome.breeding.vigor': 'Живучесть',
  'hudChrome.breeding.yield': 'Урожай',
  'hudChrome.breeding.parentA': 'Родитель A',
  'hudChrome.breeding.parentB': 'Родитель B',
  ...
  'hudChrome.reputation.tier.revered': 'Почтение',
  'hudChrome.reputation.tier.exalted': 'Превознесение',
  'hudChrome.crafting.categories.nutrient': 'Питательные смеси',
  'hudChrome.crafting.categories.seed': 'Сорта семян',
  'hudChrome.crafting.categories.accessory': 'Снаряжение для выращивания',
  'hudChrome.crafting.categories.consumable': 'Расходники',
  'hudChrome.crafting.categories.gear': 'Перекованное снаряжение',
  'hudChrome.crafting.errors.recipeUnavailable': 'Этот рецепт здесь недоступен.',
  ...
  'entities.items.cured_flower_prime.name': 'Отменный вяленый цвет',
  'entities.items.pressed_resin_fine.name': 'Отборная прессованная смола',
  ...
  'entities.quests.q_first_harvest.completion':
    'Ты только глянь. Обрезано чисто, и нигде не видно спешки. У тебя руки для этой работы.',
  'entities.quests.q_first_harvest.objectives.0.label': 'Обычный бутон',
  'entities.quests.q_fine_supply.title': 'Что-нибудь получше',
  'entities.quests.q_fine_supply.text':
    'На обычном сырье лампы горят, но никого этим не покоришь. Мне нужен материал получше, а откуда ты его возьмёшь, меня мало заботит. Есть терпение — выведи сам, нет — купи у того, кто вывел. Садовник с деньгами всё равно садовник.',
  'entities.quests.q_fine_supply.completion':
    'Вот это уже стоит просушить как следует. Тот, кто это вырастил, знал своё дело. А если это был ты, тем лучше.',
  'entities.quests.q_fine_supply.objectives.0.label': 'Отборный бутон',
  'entities.quests.q_prime_order.title': 'Заказ садовника',
  'entities.quests.q_prime_order.text':
    'У меня есть постоянный заказ, который я ни разу не сумел закрыть: только отменное сырьё, ничем не хуже. Для этого нужен сорт, выведенный правильно до самого верха, а значит — либо годы собственных скрещиваний, либо добрые отношения с тем, кто это уже проделал. Так или иначе, закрой его — и на Заимке будут знать твоё имя.',
  'entities.quests.q_prime_order.completion':
    'Шесть отменных. Я ждал этого долгий сезон. Заимка у тебя в долгу, и я тоже.',
  'entities.quests.q_prime_order.objectives.0.label': 'Отменный бутон',
};
