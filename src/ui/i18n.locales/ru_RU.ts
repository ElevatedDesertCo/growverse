...
export const ru_RU: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.items.glassscale_mail.name': 'Кольчуга из стеклянной чешуи',
  'entities.items.sunbleached_leathers.name': 'Выцветшие на солнце кожаные доспехи',
  'entities.items.sunspun_robes.name': 'Одеяние, сотканное из солнца',
  'entities.items.sunforged_blade.name': 'Клинок, выкованный солнцем',
  'entities.items.sunforged_dagger.name': 'Кинжал, выкованный солнцем',
  'entities.items.sunforged_scepter.name': 'Скипетр, выкованный солнцем',
  ...
  'entities.npcs.zaida_sunstranded.name': 'Зайда',
  'entities.npcs.zaida_sunstranded.title': 'Застигнутая солнцем',
  'entities.npcs.zaida_sunstranded.greeting':
    'Значит, и ты это чувствуешь, жар, что сочится из тех врат? Я прошла через них, {playerName}, и уже не смогла вернуться. За ними лежит мир, где солнце никогда не заходит, Угольные пустоши, и он не щадит неготовых. Сруби волков, которых жар выгнал на эту дорогу, докажи свою сталь, и я открою тебе путь.',
  'entities.quests.q_ember_intro.title': 'Врата знойного марева',
  'entities.quests.q_ember_intro.text':
    'Жар из врат свёл волков южной дороги с ума, {playerName}, и пока с ними не разберутся, никто не встанет здесь лагерем спокойно, а я и подавно. Истреби четверых из них, и я буду знать, что твоя сталь готова к тому, что ждёт за маревом.',
  'entities.quests.q_ember_intro.completion':
    'Твёрдая рука и чистое убийство. Хорошо. Пустоши испытают тебя суровее любого волка, {playerName}, но переправу ты заслужил. Ступай сквозь марево, когда будешь готов: на той стороне лежит караван-сарай, и тамошнему следопыту нужен кто-то вроде тебя.',
  'entities.quests.q_ember_intro.objectives.0.label': 'Истреблено волков южной дороги',
  'entities.itemSets.sunforged.name': 'Доспех, выкованный солнцем',
  'entities.itemSets.sunforged.bonus2': 'Увеличивает выносливость на 12.',
  'entities.itemSets.sunforged.bonus3': 'Увеличивает выносливость на 20.',
