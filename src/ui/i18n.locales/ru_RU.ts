...
export const ru_RU: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.quests.q_first_harvest.text': 'Все садовники начинают одинаково: грядка, семя и терпение оставить всё как есть. Посади что-нибудь, дай дозреть и принеси мне то, что снимешь. Прежде чем доверить тебе стоящий материал, я хочу посмотреть, как ты обходишься с урожаем.',
  'entities.quests.q_first_harvest.completion': 'Ты только глянь. Обрезано чисто, и нигде не видно спешки. У тебя руки для этой работы.',
  'entities.quests.q_first_harvest.objectives.0.label': 'Обычный бутон',
  'entities.quests.q_fine_supply.title': 'Что-нибудь получше',
  'entities.quests.q_fine_supply.text': 'На обычном сырье лампы горят, но никого этим не покоришь. Мне нужен материал получше, а откуда ты его возьмёшь, меня мало заботит. Есть терпение — выведи сам, нет — купи у того, кто вывел. Садовник с деньгами всё равно садовник.',
  'entities.quests.q_fine_supply.completion': 'Вот это уже стоит просушить как следует. Тот, кто это вырастил, знал своё дело. А если это был ты, тем лучше.',
  'entities.quests.q_fine_supply.objectives.0.label': 'Отборный бутон',
  'entities.quests.q_prime_order.title': 'Заказ садовника',
  'entities.quests.q_prime_order.text': 'У меня есть постоянный заказ, который я ни разу не сумел закрыть: только отменное сырьё, ничем не хуже. Для этого нужен сорт, выведенный правильно до самого верха, а значит — либо годы собственных скрещиваний, либо добрые отношения с тем, кто это уже проделал. Так или иначе, закрой его — и на Заимке будут знать твоё имя.',
  'entities.quests.q_prime_order.completion': 'Шесть отменных. Я ждал этого долгий сезон. Заимка у тебя в долгу, и я тоже.',
