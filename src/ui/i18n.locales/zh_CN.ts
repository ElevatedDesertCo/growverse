...
export const zh_CN: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.mounts.active': '使用中',
  'hudChrome.mounts.close': '关闭坐骑窗口',
  'hudChrome.mounts.summonAria': '召唤{name}',
  'hudChrome.mounts.dismissAria': '收起{name}',
  ...
  'entities.npcs.stablemaster_marla.greeting':
    '马厩的门开着呢，{className}。这里的每一头坐骑都被悉心养大，骑起来又稳又乖。至于绽放行者嘛……那可是长出来的，从未被驯服过。',
  ...
  'hudChrome.mounts.errors.alreadyHaveReins': '你已经拥有这副缰绳了。',
  'hudChrome.mounts.errors.fiestaBout': '嘉年华对局期间无法这么做。',
  'entities.quests.q_riding_lessons.title': '骑术课程',
  'entities.quests.q_riding_lessons.text':
    '想学骑术吗，{className}？那就先学会院场，再谈上路。走一遍我的练习赛道：先是低栏，然后是干草堆，最后再穿回木拱门。去吧！跳过每一道障碍，然后骑着穿过拱门回来。',
  'entities.quests.q_riding_lessons.completion':
    '手稳，坐姿也稳。你行的。这份酬劳拿去：应该够你买下第一副缰绳了。挑一头脾气合你心意的坐骑吧，另外当心绽放行者，那家伙是会挑选骑手的。',
  'entities.quests.q_riding_lessons.objectives.0.label': '已越过低栏',
  'entities.quests.q_riding_lessons.objectives.1.label': '已越过干草堆',
  'entities.quests.q_riding_lessons.objectives.2.label': '已骑行穿过木拱门',
  'entities.mounts.mount_alpaca.name': '高地草原羊驼',
  'entities.mounts.mount_bull.name': '铁皮公牛',
  'entities.mounts.mount_boar.name': '棘背野猪',
  'entities.mounts.mount_bloomstrider.name': '翠绿绽放行者',
  'entities.mounts.mount_swift_alpaca.name': '迅捷高地草原羊驼',
  'entities.mounts.mount_swift_bull.name': '迅捷铁皮公牛',
  'entities.mounts.mount_swift_boar.name': '迅捷棘背野猪',
  'entities.mounts.mount_elder_bloomstrider.name': '长老绽放行者',
  'guide.nav.mounts': '坐骑',
  'guide.mountsPage.heading': '坐骑',
  'guide.mountsPage.intro':
    '坐骑载着你风驰电掣地穿越大陆。到布鲁姆海文马厩学习骑术，挑一头脾气合你心意的伙伴，路途便会短上许多。',
  'guide.mountsPage.whatHeading': '骑术如何运作',
  'guide.mountsPage.whatBody':
    '每头坐骑都是一次性解锁：在马厩买下它的缰绳并学会骑乘，它就永远属于你。只要你脱离战斗、身处旱地，随时都能召唤；受到攻击、开始施法或潜入水中都会让你落地。',
  'guide.mountsPage.tiersHeading': '骑术与迅捷骑术',
  'guide.mountsPage.tiersBody':
    '马厩养着两批坐骑。骑术坐骑是入门之选，而迅捷坐骑则是同样温驯的坐骑养得更快。同一层级内的每头坐骑速度完全相同，所以选择只关乎性情与外观，与速度无关。',
  'guide.mountsPage.exclusiveHeading': '绽放行者',
  'guide.mountsPage.exclusiveBody':
    '有两头坐骑，翠绿绽放行者与长老绽放行者，是长出来而非养出来的，也是马厩用$GROW出售的专属坐骑。它们是身份的象征：在各自层级内，速度与其他坐骑完全一致。',
  'guide.mountsPage.whereHeading': '在哪里学习',
  'guide.mountsPage.whereBody':
    '达到{level}级后，前往起始山谷的布鲁姆海文马厩。马厩长会先带你在练习赛道上完成骑术课程，出售的缰绳则涵盖两个层级。',
  'guide.mountsPage.fromLevel': '从 {n} 级起',
  'guide.mountsPage.ridingTier': '骑术',
  'guide.mountsPage.swiftTier': '迅捷',
  'guide.mountsPage.exclusiveTag': '$GROW专属',
  'entities.items.reins_swift_highfield_alpaca.name': '迅捷高地草原羊驼缰绳',
  'entities.items.reins_swift_ironhide_bull.name': '迅捷铁皮公牛缰绳',
  'entities.items.reins_swift_thornback_boar.name': '迅捷棘背野猪缰绳',
  'entities.items.reins_elder_bloomstrider.name': '长老绽放行者缰绳',
  'entities.items.verdant_wardrobe_crate.name': '翠绿衣橱箱',
  'entities.items.course_low_rail.name': '低栏障碍',
  'entities.items.course_hay_bales.name': '干草堆障碍',
  'entities.items.course_timber_arch.name': '木拱门',
};
