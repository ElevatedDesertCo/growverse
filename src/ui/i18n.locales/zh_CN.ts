...
export const zh_CN: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.harvest.gatheredPopup': '采集到 {item}',
  ...
  'seo.officialLabel': 'Growverse 官方网站',
  'seo.officialBody':
  ...
  'hudChrome.professions.title': '专业技能',
  'hudChrome.professions.mining': '采矿',
  'hudChrome.professions.herbalism': '草药学',
  'hudChrome.professions.logging': '伐木',
  'hudChrome.professions.cultivation': '栽培',
  'hudChrome.professions.fishing': '钓鱼',
  'hudChrome.professions.cooking': '烹饪',
  'hudChrome.professions.alchemy': '炼金术',
  'hudChrome.professions.smithing': '锻造',
  'hudChrome.professions.enchanting': '附魔',
  'hudChrome.professions.extraction': '萃取',
  'hudChrome.professions.breeding': '育种',
  'hudChrome.professions.lockpicking': '开锁',
  'hudChrome.loadouts.title': '配装',
  'hudChrome.loadouts.hint': '在天赋面板中保存装备与天赋套装。',
  'hudChrome.loadouts.applyAria': '应用配装：{name}',
  'hudChrome.overview.tablistAria': '角色面板视图',
  'hudChrome.overview.gearTab': '角色',
  'hudChrome.overview.overviewTab': '概览',
  'hudChrome.overview.commune': '公社声望',
  'hudChrome.overview.sessions': '绽放疗程',
  'hudChrome.overview.strains': '品系库',
  'hudChrome.overview.noSessions': '当前没有绽放疗程。前往炼金实验室调制一份药剂。',
  'character.sortBy': '排序',
  ...
  'playerCard.defaultRealm': 'Growverse 世界',
  'playerCard.brandWordmark': 'GROWVERSE',
  ...
  'playerCard.shareText':
    '我正在 Growverse 中铸就传说：{level}级 {className}{tierBit}。加入我的服务器：',
  'playerCard.nativeShareTitle': 'Growverse 世界',
  ...
  'controls.chat': '打开聊天框',
  'seo.title': 'Growverse：经典风格网页 MMO',
  'seo.description':
    '在 Growverse 展开史诗冒险。这是一款可直接在浏览器中游玩的经典风格微型 MMO。加入持续共享的服务器，提升职业等级，击败敌人。',
  'seo.genre': 'MMORPG',
  'seo.playMode': '多人游戏',
  ...
  'a11y.githubProject': '打开 Growverse 的 GitHub 项目',
  'a11y.discordCommunity': '加入 Growverse 的 Discord 社区',
  'a11y.donateProject': '捐赠支持 Growverse',
  ...
  'mobilePreflight.iosOpenStep': '从新的主屏幕图标打开 Growverse。',
  ...
  'mobilePreflight.androidOpenStep': '从新图标打开 Growverse。',
  'mobilePreflight.otherStandaloneDetail': '请保持设备处于横屏全屏。',
  'mobilePreflight.otherInstallDetail': '安装此页面或将其添加到主屏幕，以获得最佳移动端全屏体验。',
  'serverUnavailable.title': 'Growverse - 服务器不可用',
  'serverUnavailable.logoAlt': 'Growverse',
  ...
  'entities.items.bloom_extract.name': '绽放萃取物',
  ...
  'entities.items.restful_bloom_tonic.name': '安神绽放药剂',
  'entities.items.lively_bloom_tonic.name': '活力绽放药剂',
  'entities.items.balanced_bloom_tonic.name': '均衡绽放药剂',
  'entities.items.slow_bloom_lozenge.name': '缓释绽放含片',
  ...
  'entities.npcs.glyphwright_orrin.name': '奥林',
  'entities.npcs.cup_steward_wilder.name': '怀尔德',
  'entities.npcs.cup_steward_wilder.title': '山谷杯司仪',
  'entities.npcs.cup_steward_wilder.greeting':
    '山谷杯开赛了，{className}。带一个品系和十枚花苞来，我就把你的名字写上榜。评的是基因、你带来的品级，还有你对这株植物有多熟。三样齐全，不然你只是来凑数的。',
  'entities.npcs.extractor_rell.name': '雷尔',
  'entities.npcs.extractor_rell.title': '萃取师',
  'entities.npcs.extractor_rell.greeting':
    '花只是起点，{className}，不是终点。把花苞带来，我能洗成大麻脂、脆片或钻石。要是刚从苗床上摘下、还带着水汽，我们能做出更好的东西。',
  'entities.npcs.glyphwright_orrin.title': '符文匠',
  'entities.npcs.glyphwright_orrin.greeting':
    '任何种植者都能烧掉自己最好的花，{className}。把你的上等花苞和一块裂隙碎片带来，我会把两者绑成一枚可维持半小时的符文。',
  'entities.npcs.alchemist_sable.name': '塞布尔',
  'entities.npcs.alchemist_sable.title': '炼金术士',
  'entities.npcs.alchemist_sable.greeting':
    '{className}，从山谷里给我采来花蕾，我便能提炼出其中的精华：治愈血肉的药水、令心神敏捷的药剂，还有一瓶磨砺神智的灵药。',
  'hudChrome.crafting.alchemyTitle': '炼金实验室',
  'hudChrome.crafting.enchantTitle': '注灵台',
  'hudChrome.crafting.extractTitle': '萃取实验室',
  'hudChrome.crafting.extractHint': '把收获的花苞洗炼成大麻脂、脆片、鲜活树脂与钻石。',
  'hudChrome.crafting.errors.budsNotFresh': '这些花苞已经干了。鲜活树脂要在收获后立刻萃取。',
  'hudChrome.crafting.errors.processRunning': '这道工序还在进行中。等它完成后再来。',
  'hudChrome.crafting.enchantHint': '将上等花苞与腐化碎片结合，铸成可持续半小时的符文。',
  'hudChrome.crafting.alchemyHint': '将采集的花蕾酿成治疗药水、法力药水和一瓶战斗灵药。',
  ...
  'entities.npcs.boone_cascade.greeting':
    '瞧瞧是谁从地图外头晃了下来，{playerName}。我们的大坝如今就在这儿，你早就受邀了。不过水库那边迷雾小怪成群。替我们拍掉几只，篝火就归你了。',
  'entities.npcs.sequoia_marsh.name': '红杉·马什',
  'entities.npcs.sequoia_marsh.title': '蓝田守护者',
  'entities.npcs.sequoia_marsh.greeting':
    '走路当心点，那块地又烫又蓝。你是来买货，还是来干活的？不管哪样，我这儿都有活儿要做，{playerName}。',
  'entities.npcs.ollie_ridgeback.name': '奥利·瑞奇巴克',
  'entities.npcs.ollie_ridgeback.title': '山脊斥候',
  'entities.npcs.ollie_ridgeback.greeting':
    '你会玩滑板？无所谓，早晚你会学会。今天水面上的迷雾特别浓，{playerName}，雾一浓就有小怪。抄根棍子，帮我把它们清一清。',
  'entities.npcs.wren_alder.name': '雷恩·奥尔德',
  'entities.npcs.wren_alder.title': '广播',
  'entities.npcs.wren_alder.greeting':
    '不管你乐不乐意，你现在正在直播。信号每周一晚上发出去，整条山脊都在收听。保持嗨着，亚利桑那，{playerName}，试着说点值得播出去的话吧。',
  ...
  'entities.quests.q_welcome_dam.completion':
    '少了六只小怪，你还稳稳站着。这就是全部的考验了，{playerName}。篝火边的位置归你了，免费。现在你是我们的人了。保持嗨着，亚利桑那。',
  'entities.quests.q_welcome_dam.objectives.0.label': '迷雾小怪已拍掉',
  'entities.quests.q_clear_haze.title': '驱散迷雾',
  'entities.quests.q_clear_haze.text':
    '布恩让你拍掉了几只，可迷雾还是从水库那头浓浓地滚过来，一转眼又聚回去了，{playerName}。烦人的小东西，还老吓着新来的人。沿着水边干掉十只，我就分你点好货。',
  'entities.quests.q_clear_haze.completion':
    '干掉十只，空气一下就清爽多了。这是你的那份，再送你一口塞哥自留地的货。劲儿很冲。别还没上第一个坡就先烧尽了。',
  'entities.quests.q_clear_haze.objectives.0.label': '迷雾小怪已驱散',
  'entities.quests.q_dam_driftwood.title': '咬人的浮木',
  'entities.quests.q_dam_driftwood.text':
    '大坝正漏着蓝水，我的种植床有一半都泡在水里了，{playerName}。我本想用好浮木把它补上，可浅滩里那些咬客把我漂过去的每一块板子都啃了。宰掉十只，我就能自己把苗床垫高。当心它们的嘴。',
  'entities.quests.q_dam_driftwood.completion':
    '我的浮木里少了十副牙口。苗床这下能干出来了。作为新来的，你这手挺稳。等你靴子干些了再回来，我教你怎么种。',
  'entities.quests.q_dam_driftwood.objectives.0.label': '浮木咬客已宰杀',
  'entities.zones.the_dam.welcome':
    '没人邀请河狸帮，布恩·卡斯凯德还是招手让你进来。保持嗨着，亚利桑那。',
  'entities.zones.the_dam.pois.1.label': '坦克水塘',
  'entities.zones.the_dam.pois.2.label': '浮木街',
  'entities.zones.the_dam.pois.3.label': '蓝田种植区',
  'entities.zones.the_dam.pois.4.label': '水库',
  'entities.zones.the_dam.pois.5.label': '咬客浅滩',
  'entities.zones.the_dam.pois.6.label': '冰封山脊小径',
  ...
  'entities.mobs.dust_reaver.name': '尘暴掠夺者',
  'entities.mobs.dust_slinger.name': '尘石投掷者',
  ...
  'entities.dungeons.blightroot_hollow.name': '枯根空穴',
  'entities.dungeons.blightroot_hollow.enterText': '你挤过垂落的根须，进入枯根空穴...',
  'entities.dungeons.blightroot_hollow.leaveText': '你穿过纠缠的根须，爬向开阔的天空。',
  'entities.dungeons.emberhold_keep.name': '烬堡',
  'entities.dungeons.emberhold_keep.enterText': '你穿过烧焦的闸门，进入烬堡...',
  'entities.dungeons.emberhold_keep.leaveText': '你穿过门楼，重新踏入开阔的荒漠。',
  ...
  'entities.items.bloom_essence.name': '绽放精华',
  'entities.items.ember_essence.name': '余烬精华',
  'entities.items.flow_essence.name': '流动精华',
  'entities.items.spore_essence.name': '孢子精华',
  'entities.items.common_seed.name': '普通种子',
  'entities.items.corruption_shard.name': '腐蚀碎片',
  'entities.items.bloom_nutrient.name': '绽放养料',
  'entities.items.ember_nutrient.name': '余烬养料',
  'entities.items.flow_nutrient.name': '流动养料',
  'entities.items.enriched_seed.name': '富集种子',
  'entities.items.prime_strain_seed.name': '原初品系种子',
  'entities.items.bloom_lamp.name': '绽放之灯',
  'entities.items.irrigation_coil.name': '灌溉盘管',
  'entities.items.shard_whetstone.name': '碎片磨刀石',
  ...
  'entities.mobs.rootfen_crawler.name': '根沼爬行者',
  'entities.mobs.spore_tick.name': '孢子虱',
  'entities.mobs.blightroot_weaver.name': '枯根织网者',
  'entities.mobs.hollowed_husk.name': '空壳躯',
  'entities.mobs.rootwraith_the_hollowed.name': '根魅·空蚀者',
  'entities.mobs.ashfell_knight.name': '灰落骑士',
  'entities.mobs.emberbound_zealot.name': '缚烬狂徒',
  'entities.mobs.castellan_maldrek.name': '城主马尔德雷克',
  'entities.mobs.lord_kaelen_ashbound.name': '缚烬领主凯伦',
  ...
  'hudChrome.questTracker.timeLabel': '剩余时间：{time}',
  ...
  'guide.worldPage.intro':
    'Growverse 是一片连绵不绝、需你徒步穿越的大陆，三大区域由南向北依次铺展。这里没有快速旅行，因此旅途本身便是冒险的一部分。',
  ...
  'hudChrome.discord.panelTitle': 'Growverse',
  ...
  'hudChrome.nativeUpdate.body': 'Growverse 有新版本可用。立即更新以获取最新修复和改进。',
  'hudChrome.nativeUpdate.bodyWithVersion':
    'Growverse {version} 版本已可用。立即更新以获取最新修复和改进。',
  ...
  'desktop.crash.fatalBody': 'Growverse 遇到意外错误，需要关闭。',
  ...
  'entities.npcs.cultivator_marlow.name': '马洛',
  'entities.npcs.cultivator_marlow.title': '培植师',
  'entities.npcs.cultivator_marlow.greeting':
    '培育站随你使用，朋友。营养剂、种子品系、种植装备。这些植物需要什么？',
  'entities.npcs.smith_draxa.name': '德拉克萨',
  'entities.npcs.smith_draxa.title': '裂隙铁匠',
  'entities.npcs.smith_draxa.greeting':
    '升级台正热着呢。给我带来腐蚀碎片，我会把你的钢铁重铸成裂隙也无法折断的利器。',
  'hudChrome.crafting.growTitle': '培育站',
  'hudChrome.crafting.upgradeTitle': '升级台',
  'hudChrome.crafting.growHint': '制作营养剂、升级种子品系、打造种植装备。',
  'hudChrome.crafting.upgradeHint': '重铸装备，并用腐蚀碎片切割战斗消耗品。',
  'hudChrome.crafting.craftButton': '制作',
  'hudChrome.crafting.costLabel': '花费',
  'hudChrome.crafting.requiresLabel': '需要',
  'hudChrome.crafting.levelReq': '需要等级 {level}',
  'hudChrome.crafting.professionReq': '需要{profession} {skill}',
  'hudChrome.crafting.produces': '产出 {count} 个{name}',
  'hudChrome.crafting.crafted': '制作了{name}。',
  'hudChrome.crafting.empty': '这里暂时没有可制作的物品。',
  'hudChrome.crafting.close': '关闭',
  'hudChrome.trade.cutLabel': '插枝',
  'hudChrome.trade.hint': '插枝是复制品：你保留自己的母株，对方需要一个空的品系槽位。',
  'hudChrome.cup.title': '山谷杯',
  'hudChrome.cup.open': '参加山谷杯',
  'hudChrome.cup.hint': '评审看的是基因、你带来的品级，以及你对这株植物的了解。',
  'hudChrome.cup.season': '第 {season} 赛季',
  'hudChrome.cup.remainingHours': '剩余 {hours} 小时 {minutes} 分',
  'hudChrome.cup.remainingMinutes': '剩余 {minutes} 分',
  'hudChrome.cup.best': '你的最高分：{score}',
  'hudChrome.cup.emptyBoard': '本赛季还没有参赛作品。榜单由你来开启。',
  'hudChrome.cup.gradeLabel': '花苞品级',
  'hudChrome.cup.strainLabel': '品系',
  'hudChrome.cup.noBuds': '没有可参赛的花苞。先去收获一季。',
  'hudChrome.cup.noStrains': '还没有品系。收获一季即可发现一个。',
  'hudChrome.cup.projected': '得分 {score}',
  'hudChrome.cup.enter': '参赛（{count} 枚花苞，得分 {score}）',
  'hudChrome.cup.posted': '{strain} 已上榜，得分 {score}，排名第 {rank}。',
  'hudChrome.garden.title': '花园',
  'hudChrome.garden.hint': '在地块中种下种子，收获绽放。',
  'hudChrome.garden.seedLabel': '要种植的种子',
  'hudChrome.garden.noSeeds': '没有可种植的种子。在培育站制作。',
  'hudChrome.garden.empty': '空地块',
  'hudChrome.garden.plant': '种植',
  'hudChrome.garden.harvest': '收获',
  'hudChrome.garden.tend': '照料',
  'hudChrome.garden.tendCount': '已照料 {tends}/{total}',
  'hudChrome.garden.tendNudge': '有 {count} 株植物可以照料。',
  ...
  'hudChrome.breeding.open': '培育品系',
  'hudChrome.breeding.empty': '还没有品系。收获绽放以发现你的第一个品系。',
  'hudChrome.breeding.landrace': '原生种',
  'hudChrome.breeding.potency': '效力',
  'hudChrome.breeding.vigor': '活力',
  'hudChrome.breeding.yield': '产量',
  'hudChrome.breeding.parentA': '亲本A',
  'hudChrome.breeding.parentB': '亲本B',
  'hudChrome.breeding.plant': '种植',
  ...
  'hudChrome.breeding.refine': '精炼',
  'hudChrome.breeding.refineHint': '把第二个品系并入第一个，提升它并腾出一个槽位。',
  'hudChrome.breeding.fullRefine': '你的品系库已满。精炼或释放一个品系以腾出空间。',
  'hudChrome.breeding.outlookTitle': '这次杂交可能出什么',
  'hudChrome.breeding.outlookRow': '{trait}：至少 {chance}% 保住 {target}，最高可到 {ceiling}',
  'hudChrome.breeding.outlookLandrace': '这个组合有机会出地方种。',
  'hudChrome.breeding.mastery': '精通',
  'hudChrome.breeding.masteryAria': '{strain} 精通：{mastery} / {max}',
  'hudChrome.reputation.tier.neutral': '中立',
  'hudChrome.reputation.tier.friendly': '友善',
  'hudChrome.reputation.tier.honored': '尊敬',
  'hudChrome.reputation.tier.revered': '崇敬',
  'hudChrome.reputation.tier.exalted': '崇拜',
  'hudChrome.crafting.categories.nutrient': '营养剂',
  'hudChrome.crafting.categories.seed': '种子品系',
  'hudChrome.crafting.categories.accessory': '种植配件',
  'hudChrome.crafting.categories.consumable': '消耗品',
  'hudChrome.crafting.categories.gear': '重铸装备',
  'hudChrome.crafting.errors.recipeUnavailable': '这里没有该配方。',
  'hudChrome.crafting.errors.tooFarFromStation': '你离工作台太远了。',
  'hudChrome.crafting.errors.levelTooLow': '你的技艺还不足以制作那个。',
  'hudChrome.crafting.errors.missingMaterials': '你缺少制作所需的材料。',
  // Hollowmere (zone 2 haunted fen) + harvest channel label
  'abilityUi.cast.harvest': '采集中',
  'entities.mobs.grinning_jack.name': '咧嘴杰克',
  'entities.mobs.marsh_hag.name': '沼泽巫妪',
  'entities.mobs.wispford_dead.name': '鬼火渡亡者',
  'entities.mobs.fen_revenant.name': '沼地归亡者',
  'entities.mobs.hexbound_crone.name': '咒缚老妪',
  'entities.mobs.grave_sentinel.name': '墓地哨卫',
  'entities.mobs.mausoleum_shambler.name': '陵墓蹒跚者',
  'entities.mobs.crypt_hexward.name': '墓穴咒卫',
  'entities.mobs.bonepile_horror.name': '尸骨堆恐魔',
  'entities.mobs.pumpkin_spriteling.name': '南瓜小妖',
  'entities.mobs.grinning_king.name': '南瓜王',
  'entities.npcs.morvenna_hedgewitch.name': '莫文娜',
  'entities.npcs.morvenna_hedgewitch.title': '篱笆女巫',
  'entities.npcs.morvenna_hedgewitch.greeting':
    '待在灯火照得到的地方，{className}。黄昏时分，泥沼会吐出它埋下的亡者，而我所结的护咒，只在牛脂灯燃着时才管用。把我要的东西带来，我便能让鬼火渡再多喘息一夜。',
  'entities.npcs.gravewarden_holt.title': '守墓人',
  'entities.npcs.gravewarden_holt.greeting':
    '这些人大多是我亲手埋下的，{playerName}，如今我却要把他们第二次送回土里。北端的那道墓门，已有一辈子不曾封闭过。门下有什么东西，正在唤起亡者。',
  'entities.dungeons.sunken_mausoleum.name': '沉没陵墓',
  'entities.dungeons.sunken_mausoleum.enterText':
    '你穿过墓门向下走去，四周尽是湿冷的石壁与牛脂的腥臭，而在下方某处，有什么东西正在黑暗中咧嘴而笑。',
  'entities.dungeons.sunken_mausoleum.leaveText': '你顺着墓门石阶向上，重回灯火摇曳的沼泽。',
  'entities.quests.q_hollowmere_risen.title': '不宁之沼',
  'entities.quests.q_hollowmere_risen.text':
    '如今每到黄昏，他们便从泥沼里爬出，{playerName}：鬼火渡的亡者，身上仍穿着我们下葬时的破烂衣衫。趁他们还没走到村落篱笆前，把其中十个重新放倒。这是桩阴森的活计，却也是一种慈悲。',
  'entities.quests.q_hollowmere_risen.completion':
    '十个重新躺回了泥里。他们并不还手，{playerName}，其实压根不还手。他们只是朝着灯火走去。无论是什么在召唤他们，那声音都来自墓门之下。',
  'entities.quests.q_hollowmere_risen.objectives.0.label': '已放倒的鬼火渡亡者',
  'entities.quests.q_hollowmere_revenants.title': '莫文娜的护咒',
  'entities.quests.q_hollowmere_revenants.text':
    '我用来结护咒的苍白墓苔，只在沾了沼气的亡者倒下之处才会扎根，{playerName}。沼地归亡者所过之处，都把它踩得稀烂。沿着墓地边缘砍倒八个，墓苔便会重新爬回它们占据的土地。',
  'entities.quests.q_hollowmere_revenants.completion':
    '它们倒下的地方，墓苔已经泛绿了。很好。村落的护环还能再撑一夜，牛脂也够点燃它。你为这些人争取到了时间，{playerName}。',
  'entities.quests.q_hollowmere_revenants.objectives.0.label': '已砍倒的沼地归亡者',
  'entities.quests.q_hollowmere_crones.title': '点亮长夜',
  'entities.quests.q_hollowmere_crones.text':
    '通往墓门的路旁排着古旧的护咒灯，{playerName}，而咒缚老妪们在黄昏时悄悄爬上这条路，掐灭她们经过的每一簇火焰，好让亡者走上一条黑暗之路。砍倒她们六个，护咒灯便会重新燃彻整夜。',
  'entities.quests.q_hollowmere_crones.completion':
    '那条路重新亮了起来，起身的亡者们嘶嘶低鸣，不敢靠近。这撑不了太久，{playerName}：下方的某物极有耐心，而火焰不过是牛脂罢了。',
  'entities.quests.q_hollowmere_crones.objectives.0.label': '已了结的咒缚老妪',
  'entities.quests.q_hollowmere_sentinel.title': '墓地哨卫',
  'entities.quests.q_hollowmere_sentinel.text':
    '这片沼泽上有一样东西并非起身的尸首，{playerName}：墓地哨卫，一个以篝火为头颅的看守，是下方之物派来守卫墓门之路的。只要它还立着，就没人能活着走到墓门。凭一柄利刃想杀它绝非易事，但这也是个难得的机会，能看看那深处的亡者究竟惧怕什么，竟要设下守卫。了结它。',
  'entities.quests.q_hollowmere_sentinel.completion':
    '那咧嘴的火光渐渐熄灭，通往墓门的路终于畅通了。无论是什么为那哨卫加了冕，{playerName}，它如今已近在咫尺。霍尔特会想知道，下行之路已经清开。',
  'entities.quests.q_hollowmere_sentinel.objectives.0.label': '已摧毁的墓地哨卫',
  'entities.quests.q_hollowmere_pumpkin_king.title': '南瓜王',
  'entities.quests.q_hollowmere_pumpkin_king.text':
    '哨卫已倒，墓门之路已开，我们已知晓下方等待着的是什么，{playerName}：在沉没陵墓之中，一个以篝火为头颅、被古老歌谣唤作南瓜王的东西，已自封为亡者之王，唤起沼中每一具尸体来充实它的宫廷。带上同伴穿过墓门下去，斩下它的头颅。这可不是一柄孤刃能办成的差事。',
  ...
  'hudChrome.bank.none': '附近没有银行。',
  'hudChrome.bank.full': '你的银行已满。',
  'hudChrome.bank.notInBank': '你的银行里没有那件物品。',
  'hudChrome.bank.open': '银行',
  'hudChrome.bank.title': '{name}的金库',
  'hudChrome.bank.close': '关闭银行',
  'hudChrome.bank.bankedTitle': '金库中',
  'hudChrome.bank.bankedEmpty': '你的金库是空的。',
  'hudChrome.bank.bagsTitle': '你的背包',
  'hudChrome.bank.bagsEmpty': '你的背包是空的。',
  'hudChrome.bank.withdrawAria': '取出{item}',
  'hudChrome.bank.depositAria': '存入{item}',
  'hudChrome.bank.clickWithdraw': '点击取出',
  'hudChrome.bank.clickDeposit': '点击存入',
  'hudChrome.bank.hint': '点击背包物品将其存入，或点击金库物品将其取回。',
  'hudChrome.bank.fullHint': '金库已满。取出一些物品以腾出空间。',
  'hudChrome.bank.deposited': '已存入{name}。',
  'hudChrome.bank.withdrew': '已取出{name}。',
  'entities.npcs.banker_thistle.name': '金库管理员西斯尔',
  ...
  'entities.items.bloom_diamonds.name': '花晶钻石',
  'entities.items.resin_glyph_vigor.name': '活力树脂符文',
  'entities.items.resin_glyph_focus.name': '专注树脂符文',
  'entities.items.resin_glyph_warding.name': '守护树脂符文',
  'entities.items.bud_fine.name': '优质花苞',
  'entities.items.bud_prime.name': '极品花苞',
  'entities.items.cured_flower_fine.name': '优质熟化花',
  'entities.items.cured_flower_prime.name': '极品熟化花',
  'entities.items.pressed_resin_fine.name': '优质压制树脂',
  'entities.items.pressed_resin_prime.name': '极品压制树脂',
  'entities.items.infused_lozenge_fine.name': '优质浸制含片',
  'entities.items.infused_lozenge_prime.name': '极品浸制含片',
  'entities.quests.q_stock_run.title': '调种之行',
  'entities.quests.q_stock_run.text':
    '你把那张长期订单填上了，所以现在告诉你新手没人会说的一件事：好种源不在这儿。它锁在种库山下面，而看守只对公社认得的面孔开门。上去让他们看看你。等他们认下你了再回来。',
  'entities.quests.q_stock_run.completion':
    '他们认得你了。这比我能塞给你的任何一粒种子都值钱，而且你也确实花了够久。',
  'entities.quests.q_stock_run.objectives.0.label': '抵达种库山',
  'entities.quests.q_stock_run.objectives.1.label': '获得公社认可',
  'entities.quests.q_cuttings_for_the_lodge.title': '送往木屋的插条',
  'entities.quests.q_cuttings_for_the_lodge.text':
    '罗恩要三份萃取物送到木屋，而且今天就要，因为萃取物放不住。直接送下去，亲手交到她手里。你要是半路跑去打土狼，等你到了它就一文不值了。',
  'entities.quests.q_cuttings_for_the_lodge.completion':
    '趁着还没坏就送到了。你不会相信有多少种植者连这一件事都办不成。',
  'entities.quests.q_cuttings_for_the_lodge.objectives.0.label': '把萃取物交给罗恩',
  'entities.quests.q_walk_it_home.title': '把它送回家',
  'entities.quests.q_walk_it_home.text':
    '公社有只河狸钻进了烘干棚，从日出起就赖在我的苗床里，什么用也没有。你走慢点它就会跟着。把它带到明木林地它的水坝那边去，路上看着点，它自己可不会看着自己。',
  'entities.quests.q_walk_it_home.completion':
    '到家了，还喘着气。水坝那边不会谢你，那只河狸也不会，所以我来谢：谢了。',
  ...
  'entities.quests.q_first_harvest.text':
    '每个种植者都是这样起步的：一畦土、一粒种，以及静待其成的耐心。种下些什么，让它长足时候，再把收成带来给我。在我把更好的种源交给你之前，我要先看看你怎么侍弄一茬庄稼。',
  'entities.quests.q_first_harvest.completion':
    '瞧瞧这个。修剪得干净利落，没有一处是赶工出来的。你有做这行的手艺。',
  'entities.quests.q_first_harvest.objectives.0.label': '普通花苞',
  'entities.quests.q_fine_supply.title': '更上一层',
  'entities.quests.q_fine_supply.text':
    '普通货色够点灯过日子，却打动不了任何人。我需要更优质的料子，至于你从哪儿弄来的，我不太在意。有耐心就自己育出来，没有就从育出来的人手里买。手里有钱的种植者，也还是种植者。',
  'entities.quests.q_fine_supply.completion':
    '这才值得好好熟化。养出这货色的人是懂行的——若那人就是你，那就更好了。',
  'entities.quests.q_fine_supply.objectives.0.label': '优质花苞',
  'entities.quests.q_prime_order.title': '园丁的订单',
  'entities.quests.q_prime_order.text':
    '我有一份长期订单，却从来没能交付过一次：只要极品料，差一点都不行。那得有一株从头到尾都育对了的品系，要么你自己花上几年做杂交，要么跟已经做成的人搞好关系。无论走哪条路，只要你交得出来，整个营地都会记住你的名字。',
  'entities.quests.q_prime_order.completion':
    '六份极品。这一季我等了很久。营地欠你一份人情，我也是。',
  'entities.quests.q_prime_order.objectives.0.label': '极品花苞',
};
