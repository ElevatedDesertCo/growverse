...
export const de_DE: Partial<Record<TranslationKey, string>> = {
  ...
  'auth.designCodeImportedPartial':
    'Aussehen importiert. Werte, die diese Version nicht kennt, wurden übersprungen.',
  'auth.designCodeImported': 'Aussehen importiert.',
  'auth.designCodeHint':
    'Kopiere diesen Code, um dieses Aussehen zu speichern oder zu teilen. Füge hier einen Code ein und importiere ihn, um das Aussehen zu laden.',
  'auth.designCodeErrVersion': 'Dieser Aussehenscode stammt aus einer neueren Spielversion.',
  'auth.designCodeErrMalformed':
    'Dieser Aussehenscode ist beschädigt. Kopiere den vollständigen Code und versuche es erneut.',
  'auth.designCodeErrHeader': 'Das sieht nicht wie ein Aussehenscode aus.',
  'auth.designCodeErrEmpty': 'Füge zuerst einen Aussehenscode ein.',
  'auth.designCodeCopyManual':
    'Automatisches Kopieren ist hier gesperrt. Der Code ist ausgewählt; kopiere ihn mit der Tastatur.',
  'auth.designCodeCopied': 'Aussehenscode kopiert.',
  'auth.designCode': 'Aussehenscode',
  'auth.customColor': 'Eigene',
  'auth.copyCode': 'Code kopieren',
  ...
  'seo.officialLabel': 'Offizielle Website von Growverse',
  'seo.officialBody':
  ...
  'playerCard.defaultRealm': 'Welt von Growverse',
  ...
  'playerCard.shareText':
    'Ich schmiede meine Legende in Growverse: Stufe {level} {className}{tierBit}. Tretet meinem Realm bei:',
  'playerCard.nativeShareTitle': 'Welt von Growverse',
  ...
  'seo.title': 'Growverse: Klassisches Web-MMO',
  'seo.description':
  ...
  'a11y.githubProject': 'Growverse-Projekt auf GitHub öffnen',
  'a11y.discordCommunity': 'Der Growverse-Community auf Discord beitreten',
  'a11y.donateProject': 'Spenden, um Growverse zu unterstützen',
  ...
  'mobilePreflight.androidOpenStep': 'Öffne Growverse über das neue Symbol.',
  ...
  'serverUnavailable.title': 'Growverse - Realm nicht verfügbar',
  ...
  'entities.items.cooked_mirror_trout.name': 'Gegrillte Spiegeltrutte',
  'entities.items.cooked_river_perch.name': 'Gebratener Flussbarsch',
  'entities.items.cooked_marsh_pike.name': 'Gerösteter Sumpfhecht',
  'entities.items.cooked_bog_eel.name': 'Geräucherter Mooraal',
  'entities.items.cooked_frostgill_trout.name': 'Gegrillte Frostkiemen-Trutte',
  'entities.items.cooked_stonescale_carp.name': 'Gebackener Steinschuppen-Karpfen',
  'entities.items.bloom_extract.name': 'Blütenextrakt',
  ...
  'entities.items.restful_bloom_tonic.name': 'Erholsames Blütentonikum',
  ...
  'entities.items.bloom_essence.name': 'Blütenessenz',
  'entities.items.ember_essence.name': 'Glutessenz',
  'entities.items.flow_essence.name': 'Flussessenz',
  'entities.items.spore_essence.name': 'Sporenessenz',
  'entities.items.common_seed.name': 'Gewöhnlicher Samen',
  'entities.items.corruption_shard.name': 'Verderbnissplitter',
  'entities.items.bloom_nutrient.name': 'Blütennährstoff',
  'entities.items.ember_nutrient.name': 'Glutnährstoff',
  'entities.items.flow_nutrient.name': 'Flussnährstoff',
  'entities.items.enriched_seed.name': 'Angereicherter Samen',
  'entities.items.prime_strain_seed.name': 'Urstamm-Samen',
  'entities.items.bloom_lamp.name': 'Blütenlampe',
  'entities.items.irrigation_coil.name': 'Bewässerungsspule',
  'entities.items.shard_whetstone.name': 'Splitter-Schleifstein',
  ...
  'guide.worldPage.intro':
    'Growverse ist ein zusammenhängendes Land, das du zu Fuß durchquerst, drei Gebiete von Süden nach Norden gereiht. Es gibt keine Schnellreise, die Reise selbst ist also Teil des Abenteuers.',
  ...
  'desktop.crash.fatalBody':
    'Growverse ist auf einen unerwarteten Fehler gestoßen und muss geschlossen werden.',
  ...
  'hudChrome.nativeUpdate.body':
    'Eine neue Version von Growverse ist verfügbar. Aktualisiere jetzt für die neuesten Fehlerbehebungen und Verbesserungen.',
  'hudChrome.nativeUpdate.bodyWithVersion':
    'Version {version} von Growverse ist verfügbar. Aktualisiere jetzt für die neuesten Fehlerbehebungen und Verbesserungen.',
  ...
  'entities.items.bloom_diamonds.name': 'Blütendiamanten',
  'entities.items.resin_glyph_vigor.name': 'Harzglyphe der Kraft',
  'entities.items.resin_glyph_focus.name': 'Harzglyphe der Konzentration',
  'entities.items.resin_glyph_warding.name': 'Harzglyphe des Schutzes',
