...
export const pt_BR: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "nativeUpdate": {
      ...
      "body": "Uma nova versão do Growverse está disponível. Atualize agora para receber as últimas correções e melhorias.",
      "bodyWithVersion": "A versão {version} do Growverse está disponível. Atualize agora para receber as últimas correções e melhorias.",
      "notNow": "Agora não",
      "update": "Atualizar"
    },
    "castBar": {
  ...
  "guide": {
    ...
    "worldPage": {
      "heading": "O mundo",
      "intro": "Growverse é uma terra contínua que você atravessa a pé, três zonas dispostas de sul a norte. Não há viagem rápida, então a jornada faz parte da aventura.",
  ...
  "playerCard": {
    ...
    "shareText": "Estou forjando minha lenda em Growverse: nível {level} {className}{tierBit}. Entre no meu reino:",
  ...
  "desktop": {
    ...
    "crash": {
      ...
      "reload": "Recarregar",
      "quit": "Sair",
      "fatalBody": "O Growverse encontrou um erro inesperado e precisa fechar."
    }
  },
  "realm": {
  ...
  "entities": {
    ...
    "items": {
      ...
      "swirling_healing_draught": {
        "name": "Poção curativa rodopiante"
      },
      "swirling_mana_draught": {
        "name": "Poção de mana rodopiante"
      },
      "elixir_of_the_bloom": {
        "name": "Elixir do florescimento"
      },
      "restful_bloom_tonic": {
        "name": "Tônico Floral Reparador"
      },
      "lively_bloom_tonic": {
        "name": "Tônico Floral Vívido"
      },
      "balanced_bloom_tonic": {
        "name": "Tônico Floral Equilibrado"
      },
      "slow_bloom_lozenge": {
        "name": "Pastilha de Floração Lenta"
      },
      "purple_petal": {
        "name": "Pétala Púrpura"
      },
      ...
      "reins_highfield_alpaca": {
        "name": "Rédeas da alpaca de Campoalto"
      },
      "reins_ironhide_bull": {
        "name": "Rédeas do touro Couro-de-Ferro"
      },
      "reins_thornback_boar": {
        "name": "Rédeas do javali Dorso-Espinhoso"
      },
      "reins_verdant_bloomstrider": {
        "name": "Rédeas do Andarilho-Florido Verdejante"
      },
      "briny_idol": {
        "name": "Ídolo Salobro"
      },
      ...
      "reins_swift_highfield_alpaca": {
        "name": "Rédeas da alpaca veloz de Campoalto"
      },
      "reins_swift_ironhide_bull": {
        "name": "Rédeas do touro veloz Couro-de-Ferro"
      },
      "reins_swift_thornback_boar": {
        "name": "Rédeas do javali veloz Dorso-Espinhoso"
      },
      "reins_elder_bloomstrider": {
        "name": "Rédeas do Andarilho-Florido Ancião"
      },
      "verdant_wardrobe_crate": {
        "name": "Caixa de guarda-roupa verdejante"
      },
      "course_low_rail": {
        "name": "Salto da barra baixa"
      },
      "course_hay_bales": {
        "name": "Salto dos fardos de feno"
      },
      "course_timber_arch": {
