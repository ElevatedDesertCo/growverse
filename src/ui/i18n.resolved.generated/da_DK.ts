...
export const da_DK: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "nativeUpdate": {
      ...
      "body": "En ny version af Growverse er tilgængelig. Opdater nu for de nyeste rettelser og forbedringer.",
      "bodyWithVersion": "Version {version} af Growverse er tilgængelig. Opdater nu for de nyeste rettelser og forbedringer.",
      "notNow": "Ikke nu",
      "update": "Opdater"
    },
    "castBar": {
  ...
  "guide": {
    ...
    "tagline": "En cannabis-fantasy-MMORPG, du spiller gratis i din browser.",
    ...
    "footer": {
      "blurb": "En open-source cannabis-fantasy-MMORPG. Tag på quests, dann grupper og udforsk en portalforbundet verden, direkte i din browser.",
      "playNow": "Spil nu",
    ...
    "worldPage": {
      "heading": "Verdenen",
      "intro": "Growverse er ét sammenhængende land, du krydser til fods, tre zoner lagt fra syd til nord. Der er ingen hurtigrejse, så rejsen er en del af eventyret.",
      "hub": "Hjemmebase",
  ...
  "playerCard": {
    ...
    "shareText": "Jeg smeder min legende i Growverse: Niveau {level} {className}{tierBit}. Slut dig til mit rige:",
  ...
  "seo": {
    "title": "Growverse: The Portal Chronicles, et gratis browser-MMORPG",
    "description": "Growverse er et gratis cannabis-fantasy-browser-MMORPG. Udforsk en portalforbundet verden, bekæmp væsner, gennemfør quests, dyrk magiske sorter, og skab din legende i et rige i konstant udvikling. Spil med det samme, ingen download.",
    "genre": "MMORPG",
    "playMode": "Flerspiller",
    "applicationCategory": "Spil",
    "operatingSystem": "Webbrowser",
    "officialLabel": "Officiel Growverse-hjemmeside",
    "officialBody": "Growverse er et gratis cannabis-fantasy-browser-MMORPG i en portalforbundet verden: bekæmp væsner, gennemfør quests, mestr professioner, og dyrk magiske sorter. Spil med det samme i din browser, udforsk verdenen solo, læs wikien, og følg opdateringer om udviklingen fra denne side."
  },
  "a11y": {
    ...
    "githubProject": "Åbn Growverse GitHub-projektet",
    "discordCommunity": "Deltag i Growverse Discord-fællesskabet",
    "donateProject": "Donér for at støtte Growverse"
  },
  "loading": {
  ...
  "desktop": {
    ...
    "crash": {
      ...
      "reload": "Genindlæs",
      "quit": "Afslut",
      "fatalBody": "Growverse stødte på en uventet fejl og skal lukke."
    }
  },
  "realm": {
  ...
  "mobilePreflight": {
    ...
    "iosOpenStep": "Åbn Growverse fra det nye ikon på startskærmen.",
    ...
    "androidOpenStep": "Åbn Growverse fra det nye ikon.",
  ...
  "serverUnavailable": {
    "title": "Growverse - Realm utilgængeligt",
    "logoAlt": "Growverse",
  ...
  "entities": {
    ...
    "items": {
      ...
      "cooked_mirror_trout": {
        "name": "Grillet Spejlørred"
      },
      "cooked_river_perch": {
        "name": "Pandestegt Flodaborre"
      },
      "cooked_marsh_pike": {
        "name": "Ovnstegt Sumpgedde"
      },
      "cooked_bog_eel": {
        "name": "Røget Moseål"
      },
      "cooked_frostgill_trout": {
        "name": "Grillet Frostgælle-Ørred"
      },
      "cooked_stonescale_carp": {
        "name": "Bagt Stenskæl-Karpe"
      },
      "bloom_extract": {
        "name": "Blomsterekstrakt"
      },
      "swirling_healing_draught": {
        "name": "Hvirvlende Helbredelsesdrik"
      },
      "swirling_mana_draught": {
        "name": "Hvirvlende Manadrik"
      },
      "elixir_of_the_bloom": {
        "name": "Blomstringens Eliksir"
      },
      "restful_bloom_tonic": {
        "name": "Hvilende Blomstertonic"
      },
      "lively_bloom_tonic": {
        "name": "Livlig Blomstertonic"
      },
      "balanced_bloom_tonic": {
        "name": "Balanceret Blomstertonic"
      },
      "slow_bloom_lozenge": {
        "name": "Pastil med Langsom Blomstring"
      },
      "purple_petal": {
        "name": "Lilla Kronblad"
      },
