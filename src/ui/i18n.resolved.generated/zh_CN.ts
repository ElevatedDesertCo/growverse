...
export const zh_CN: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "nativeUpdate": {
      "title": "有可用更新",
      "body": "Growverse 有新版本可用。立即更新以获取最新修复和改进。",
      "bodyWithVersion": "Growverse {version} 版本已可用。立即更新以获取最新修复和改进。",
      "notNow": "暂不",
      "update": "更新"
    },
    "castBar": {
  ...
  "guide": {
    ...
    "worldPage": {
      "heading": "世界",
      "intro": "Growverse 是一片连绵不绝、需你徒步穿越的大陆，三大区域由南向北依次铺展。这里没有快速旅行，因此旅途本身便是冒险的一部分。",
      "hub": "大本营",
      "mapHeading": "向北之路",
  ...
  "playerCard": {
    ...
    "shareText": "我正在 Growverse 中铸就传说：{level}级 {className}{tierBit}。加入我的服务器：",
    "nativeShareTitle": "Growverse 世界",
    "fileNameFallback": "玩家",
    "actionShareX": "分享到 X",
  ...
  "seo": {
    ...
    "description": "在 Growverse 展开史诗冒险。这是一款可直接在浏览器中游玩的经典风格微型 MMO。加入持续共享的服务器，提升职业等级，击败敌人。",
    "genre": "MMORPG",
    "playMode": "多人游戏",
    "applicationCategory": "游戏",
    "operatingSystem": "网页浏览器",
    "officialLabel": "Growverse 官方网站",
  ...
  "desktop": {
    ...
    "crash": {
      ...
      "reload": "重新加载",
      "quit": "退出",
      "fatalBody": "Growverse 遇到意外错误，需要关闭。"
    }
  },
  "realm": {
    "noRealms": "没有可用服务器。",
  ...
  "entities": {
    ...
    "npcs": {
      ...
      "rowan_sawtooth": {
        "name": "罗恩·锯齿",
        "title": "水闸看守",
        "greeting": "岸边生面孔啊，{className}。欢迎来到水闸，这是群落的前哨营地。真正的大坝在南边，路远着呢，可活儿就从这儿开始。保持嗨着，当心水。"
      },
      "hazel_timbers": {
        "name": "黑兹尔·廷伯斯",
        "title": "大坝军需官",
        "greeting": "工具、马具，还有路上吃的干粮，给新来的都是公道价。海狸把营地管得紧巴巴的，{className}。你要点什么？"
      },
      "boone_cascade": {
        "name": "布恩·卡斯凯德",
        "title": "大坝长老",
        "greeting": "瞧瞧是谁从地图外头晃了下来，{playerName}。我们的大坝如今就在这儿，你早就受邀了。不过水库那边迷雾小怪成群。替我们拍掉几只，篝火就归你了。"
      },
      "sequoia_marsh": {
        "name": "红杉·马什",
        "title": "蓝田守护者",
        "greeting": "走路当心点，那块地又烫又蓝。你是来买货，还是来干活的？不管哪样，我这儿都有活儿要做，{playerName}。"
      },
      "ollie_ridgeback": {
        "name": "奥利·瑞奇巴克",
        "title": "山脊斥候",
        "greeting": "你会玩滑板？无所谓，早晚你会学会。今天水面上的迷雾特别浓，{playerName}，雾一浓就有小怪。抄根棍子，帮我把它们清一清。"
      },
      "wren_alder": {
        "name": "雷恩·奥尔德",
        "title": "广播",
        "greeting": "不管你乐不乐意，你现在正在直播。信号每周一晚上发出去，整条山脊都在收听。保持嗨着，亚利桑那，{playerName}，试着说点值得播出去的话吧。"
      },
      "junie_stonewater": {
        "name": "朱妮·石水",
        "title": "古脊守护者",
      ...
      "zaida_sunstranded": {
        "name": "扎伊达",
        "title": "困于烈日者",
        "greeting": "这么说，你也感觉到了，那道门里渗出的热浪？我从那边过来的，{playerName}，却再也回不去了。门后是一片太阳永不落下的领域，余烬荒野，它不会容忍毫无准备的人。击杀那些被热浪逼到这条路上的野狼，证明你的钢铁，我便为你打开通路。"
      },
      "ember_trademaster": {
        "name": "凯萨",
        "title": "贸易主管",
        "greeting": "旅人，水、盐与钢铁，商队驿站只卖这些，也只有这些能得到沙丘的敬重。趁你还没走到那烈日之下，先买好你需要的东西吧。"
      },
      "ember_wayfinder": {
        "name": "Oren",
        "title": "寻路者",
        "greeting": "你既然穿过了传送门，就已经见到了它，{playerName}：那永不落下的太阳。沙丘之路沿途的古老日护塔都已熄灭，只要它们不再燃起，亡者便永不安息。帮我重新点燃第一座吧。"
      },
      "ember_cultivator": {
        "name": "萨布拉",
        "title": "日栽者",
        "greeting": "{className}，这片绿洲能开出荒野别处无法孕育的花朵：日耀球茎。给我带来未处理的球茎和一点余烬精华，培育站便能从中育出一枚真正的稀有种子。"
      },
      "ember_glassmaker": {
        "name": "瓦什提",
        "title": "制玻者",
        "greeting": "在峡谷谷底要小心，{playerName}：玻背蜥怪会融入黑曜石中，直到扑到你身上才现身。我留在这里是为了矿脉，那是任何世界中最上乘的玻璃砂，但第二座日护塔就埋在此地以北的狭缝峡谷里，还有个披着热浪幻影的东西守着它。"
      },
      "tidewatcher_ondrel": {
        "name": "翁德雷尔·凡恩",
        "title": "守潮者",
    ...
    "quests": {
      ...
      "q_sluice_welcome": {
        "title": "欢迎来到水闸",
        "text": "在岸边你要学的第一件事，{playerName}：海狸靠干活挣位置，不是靠站着看热闹。枯萎狼从北边的坡道下来，糟蹋我们的柴堆，惊吓幼崽。清掉六只，回来到木屋篝火边暖暖身子。然后你就是我们的人了。",
        "completion": "林线上少了六只狼，你一句怨言都没有。这就是水闸的规矩，{playerName}。篝火归你，免费。保持嗨着，亚利桑那。",
        "objectives": {
          "0": {
            "label": "枯萎狼已清剿"
          }
      ...
      "q_sluice_pilings": {
        "title": "木桩的麻烦",
        "text": "正因为有大坝，才有这片可以围着建的水塘，可东边草甸的硬鬃獠牙野猪老是拱开桩基去啃里头的甜泥。海狸把这事当成私仇，{playerName}。放倒六头掘地的家伙，水闸就欠你一件像样的纪念物，直接从大坝那儿捎来。",
        "completion": "桩基稳住了，水塘留住了，幼崽睡得安稳。给，{playerName}，一枚烤海狸信物，是在大坝那儿刻的。带着它，无论你漂泊到哪儿，你都是群落的一员。保持嗨着，亚利桑那。",
        "objectives": {
          "0": {
            "label": "硬鬃獠牙已肃清"
          }
      ...
      "q_welcome_dam": {
        "title": "欢迎来到大坝",
        "text": "大坝的第一条规矩，{playerName}：没人靠干坐着挣到自己的位置。水库上的迷雾又聚成小怪了，沿着水边一大片。拍掉六只，然后到篝火边暖暖身子。要是想听全整个故事，就去坦克水塘找朱妮。",
        "completion": "少了六只小怪，你还稳稳站着。这就是全部的考验了，{playerName}。篝火边的位置归你了，免费。现在你是我们的人了。保持嗨着，亚利桑那。",
        "objectives": {
          "0": {
            "label": "迷雾小怪已拍掉"
          }
      ...
      "q_clear_haze": {
        "title": "驱散迷雾",
        "text": "布恩让你拍掉了几只，可迷雾还是从水库那头浓浓地滚过来，一转眼又聚回去了，{playerName}。烦人的小东西，还老吓着新来的人。沿着水边干掉十只，我就分你点好货。",
        "completion": "干掉十只，空气一下就清爽多了。这是你的那份，再送你一口塞哥自留地的货。劲儿很冲。别还没上第一个坡就先烧尽了。",
        "objectives": {
          "0": {
            "label": "迷雾小怪已驱散"
          }
      ...
      "q_dam_driftwood": {
        "title": "咬人的浮木",
        "text": "大坝正漏着蓝水，我的种植床有一半都泡在水里了，{playerName}。我本想用好浮木把它补上，可浅滩里那些咬客把我漂过去的每一块板子都啃了。宰掉十只，我就能自己把苗床垫高。当心它们的嘴。",
        "completion": "我的浮木里少了十副牙口。苗床这下能干出来了。作为新来的，你这手挺稳。等你靴子干些了再回来，我教你怎么种。",
        "objectives": {
          "0": {
            "label": "浮木咬客已宰杀"
          }
      ...
      "q_ember_intro": {
        "title": "热浪蒸腾之门",
        "text": "这道门的热浪已把南路的野狼逼得半疯，{playerName}，在处理掉它们之前，没人能在这里安心扎营，我更不能。清除其中四只，我便知道你的钢铁已足以应对蒸腾热浪之后所等待的一切。",
        "completion": "手不抖，杀得利落。很好。荒野对你的考验将远胜任何野狼，{playerName}，但你已赢得了穿越的资格。准备好了就踏过那片蒸腾热浪：商队驿站就在另一边，那里的寻路者正需要你这样的人。",
        "objectives": {
          "0": {
            "label": "已清除的南路野狼"
          }
      ...
      "q_ember_ward1": {
        "title": "重燃日护塔",
        "text": "{playerName}，第一座日护塔破损伫立在商队驿站以北的沙丘之路上，潜沙猎手在它倒塌的石块间筑起了巢穴。清除其中六只，并从残骸中收集三块日护碎片，我便能重新绑定这座日护塔，为亡者划出一段它们无法踏足的道路。",
        "completion": "护塔之石吞入碎片，燃起光芒，久远以来第一次，沙丘之路的一段投下了阴影。这只是一小片黑暗，{playerName}，但这是个开端。亡者不会跨过它。",
        "objectives": {
          "0": {
            "label": "已清除的潜沙猎手"
          },
      ...
      "q_ember_ward2": {
        "title": "被埋的日护塔",
        "text": "第二座日护塔半埋在延伸地以北那座坍塌的狭缝峡谷中，{playerName}，玻背蜥怪已在它上方的碎石间筑巢。削减它们的数量，五只应该就够，再击杀八只峡谷伯劳，它们会尖叫着把任何挖掘者赶下山脊。为我清出一条路，我便能自己爬下去到日护塔那里。",
        "completion": "山脊安静了，巢穴也毁了，{playerName}。我爬到了日护塔那里，清掉了它聚焦石上的积沙：三座中的第二座，和第一座一样黑暗。两座已重燃，还剩一座，而最后那座就在异教徒守着圣火的地方。",
        "objectives": {
          "0": {
            "label": "已清除的玻背蜥怪"
          },
      ...
      "q_ember_ward3": {
        "title": "不落之日的教团",
        "text": "现在你明白太阳为何不落了，{playerName}：第三座日护塔并非废墟。余烬教团是故意让它燃着的，就在他们位于烬达的圆形剧场里，那里每一个灰烬狂信徒都在给那把维系白昼的火添薪。打破他们的仪式圈。击杀十名狂信徒，再击碎四尊他们从熔渣中唤起的煤渣魔像，我便能知道此事牵连有多深。",
        "completion": "十名狂信徒已倒下，他们的魔像也化作了熔渣，可太阳依旧悬在那里，{playerName}。看来是真的：这里的日护塔并未损坏，而是被人硬生生地维系着，而其锚点根本不在地表。它一直向下延伸，通向沙丘之下那座古老的陵墓之城。这一切将在那里终结。",
        "objectives": {
          "0": {
            "label": "已击杀的灰烬狂信徒"
          },
      ...
      "q_ember_finale": {
        "title": "日落之处",
        "text": "锚点一直向下延伸至湮没王朝，{playerName}，那座沉没于沙丘之下的陵墓之城，而在它的中心，圣甲虫育母正盘绕着那维系太阳高悬的仪式。这不是一柄剑能办成的差事：召集同伴，穿过教团的圆形剧场深入其中，击溃育母及其虫群。熄灭那不落之日。",
        "completion": "大功告成，{playerName}。育母已然不动，仪式之火摇曳将熄，沙丘之上，太阳正滑向那久远以来从未触及的地平线。今夜，商队驿站将迎来它第一个真正的黄昏，以及第一个清凉的黎明。你把黑夜还给了余烬荒野。",
        "objectives": {
          "0": {
            "label": "已击杀圣甲虫育母"
          }
    ...
    "zones": {
      "the_dam": {
        "name": "The Dam",
        "welcome": "没人邀请河狸帮，布恩·卡斯凯德还是招手让你进来。保持嗨着，亚利桑那。",
        "pois": {
          "0": {
            "label": "The Dam"
          },
    ...
    "dungeons": {
      ...
      "the_buried_dynasty": {
        "name": "湮没王朝",
        "enterText": "你越过摇曳将熄的仪式之火，向下潜入冰冷的砂岩，进入千万只圣甲虫干涩的窸窣声中，来到那与死去的太阳一同长埋着古老王朝的地方。",
        "leaveText": "你穿过圆形剧场重新向上攀爬，回到那凝立不落的日光之中。"
      },
      "drowned_temple": {
        "name": "溺亡神殿",
