...
export const fr_CA: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "nativeUpdate": {
      ...
      "body": "Une nouvelle version de Growverse est disponible. Mettez à jour maintenant pour les derniers correctifs et améliorations.",
      "bodyWithVersion": "La version {version} de Growverse est disponible. Mettez à jour maintenant pour les derniers correctifs et améliorations.",
  ...
  "guide": {
    ...
    "worldPage": {
      "heading": "Le monde",
      "intro": "Growverse est une seule terre continue que l'on traverse à pied, trois zones disposées du sud au nord. Il n'y a pas de voyage rapide, alors le trajet fait partie de l'aventure.",
      "hub": "Camp de base",
  ...
  "playerCard": {
    ...
    "defaultRealm": "Monde de Growverse",
    ...
    "shareText": "Je forge ma légende dans Growverse: niveau {level} {className}{tierBit}. Rejoignez mon royaume:",
    "nativeShareTitle": "Monde de Growverse",
  ...
  "seo": {
    ...
    "description": "Partez à l'aventure dans Growverse, un micro-MMO de style classique jouable directement dans votre navigateur. Rejoignez un royaume partagé, faites progresser vos classes et terrassez des ennemis.",
    "genre": "MMORPG",
  ...
  "desktop": {
    ...
    "crash": {
      ...
      "reload": "Recharger",
      "quit": "Quitter",
      "fatalBody": "Growverse a rencontré une erreur inattendue et doit se fermer."
    }
  },
  "realm": {
  ...
  "entities": {
    ...
    "items": {
      ...
      "cooked_mirror_trout": {
        "name": "Truite miroir grillée"
      },
      "cooked_river_perch": {
        "name": "Perche de rivière poêlée"
      },
      "cooked_marsh_pike": {
        "name": "Brochet des marais rôti"
      },
      "cooked_bog_eel": {
        "name": "Anguille des tourbières fumée"
      },
      "cooked_frostgill_trout": {
        "name": "Truite ouïe-givre grillée"
      },
      "cooked_stonescale_carp": {
        "name": "Carpe écaille-de-pierre au four"
      },
      "bloom_extract": {
        "name": "Extrait floral"
      },
      "swirling_healing_draught": {
        "name": "Breuvage de soins tourbillonnant"
      },
      "swirling_mana_draught": {
        "name": "Breuvage de mana tourbillonnant"
      },
      "elixir_of_the_bloom": {
        "name": "Élixir de la floraison"
      },
      "restful_bloom_tonic": {
        "name": "Tonique Floral Reposant"
      },
      "lively_bloom_tonic": {
        "name": "Tonique Floral Vif"
      },
      "balanced_bloom_tonic": {
        "name": "Tonique Floral Équilibré"
      },
      "slow_bloom_lozenge": {
        "name": "Pastille de Floraison Lente"
      },
      "purple_petal": {
        "name": "Pétale pourpre"
      },
      ...
      "reins_swift_highfield_alpaca": {
        "name": "Rênes de l’alpaga rapide des Hauts-Champs"
      },
      "reins_swift_ironhide_bull": {
        "name": "Rênes du taureau rapide Peau-de-Fer"
      },
      "reins_swift_thornback_boar": {
        "name": "Rênes du sanglier rapide Dos-Épineux"
      },
      "reins_elder_bloomstrider": {
        "name": "Rênes de l’Arpenteur-Fleuri ancien"
      },
      "verdant_wardrobe_crate": {
        "name": "Caisse de garde-robe verdoyante"
      },
      "course_low_rail": {
        "name": "Saut de barre basse"
      },
      "course_hay_bales": {
        "name": "Saut de bottes de foin"
      },
      "course_timber_arch": {
        "name": "Arche de bois"
      }
