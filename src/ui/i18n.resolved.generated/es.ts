...
export const es: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "nativeUpdate": {
      ...
      "body": "Ya hay disponible una nueva versión de Growverse. Actualiza ahora para obtener las últimas correcciones y mejoras.",
      "bodyWithVersion": "La versión {version} de Growverse ya está disponible. Actualiza ahora para obtener las últimas correcciones y mejoras.",
      "notNow": "Ahora no",
      "update": "Actualizar"
    },
    "castBar": {
  ...
  "guide": {
    ...
    "worldPage": {
      "heading": "El mundo",
      "intro": "Growverse es una sola tierra continua que recorres a pie, tres zonas dispuestas de sur a norte. No hay viaje rápido, así que el trayecto forma parte de la aventura.",
  ...
  "auth": {
    ...
    "designCodeErrEmpty": "Pega primero un código de apariencia.",
    "designCodeErrHeader": "Eso no parece un código de apariencia.",
    "designCodeErrMalformed": "Ese código de apariencia está dañado. Copia el código completo e inténtalo de nuevo.",
    "designCodeErrVersion": "Ese código de apariencia proviene de una versión más reciente del juego.",
    "designCodeImportedPartial": "Apariencia importada. Se omitieron los valores que esta versión no reconoce.",
    ...
    "designCode": "Código de apariencia",
    "designCodeCopied": "Código de apariencia copiado.",
    "designCodeCopyManual": "La copia automática está bloqueada aquí. El código está seleccionado; cópialo con el teclado.",
    "designCodeHint": "Copia este código para guardar o compartir este aspecto. Pega un código aquí e impórtalo para cargarlo.",
    "designCodeImported": "Apariencia importada.",
  ...
  "playerCard": {
    ...
    "defaultRealm": "Mundo de Growverse",
    ...
    "shareText": "Estoy forjando mi leyenda en Growverse: nivel {level} {className}{tierBit}. Únete a mi reino:",
    "nativeShareTitle": "Mundo de Growverse",
  ...
  "seo": {
    ...
    "description": "Emprende una aventura épica en Growverse, un micro-MMO de estilo clásico que se juega directamente en el navegador. Entra a un reino compartido, sube de nivel y derrota enemigos.",
    "genre": "MMORPG",
  ...
  "desktop": {
    ...
    "crash": {
      ...
      "reload": "Recargar",
      "quit": "Salir",
      "fatalBody": "Growverse tuvo un error inesperado y debe cerrarse."
    }
  },
  "realm": {
  ...
  "entities": {
    ...
    "items": {
      ...
      "cooked_mirror_trout": {
        "name": "Trucha espejo a la parrilla"
      },
      "cooked_river_perch": {
        "name": "Perca de río a la sartén"
      },
      "cooked_marsh_pike": {
        "name": "Lucio de marisma asado"
      },
      "cooked_bog_eel": {
        "name": "Anguila de ciénaga ahumada"
      },
      "cooked_frostgill_trout": {
        "name": "Trucha branquia escarcha a la parrilla"
      },
      "cooked_stonescale_carp": {
        "name": "Carpa escama de piedra al horno"
      },
      "bloom_extract": {
        "name": "Extracto floral"
      },
      "swirling_healing_draught": {
        "name": "Brebaje curativo arremolinado"
      },
      "swirling_mana_draught": {
        "name": "Brebaje de maná arremolinado"
      },
      "elixir_of_the_bloom": {
      ...
      "trellis_frame": {
        "name": "Espaldera de Cultivo"
      },
      "coppermesh_gloves": {
        "name": "Guantes de Malla de Cobre"
      },
      "verdant_draught": {
        "name": "Brebaje Verdante"
      },
      "bud_common": {
        "name": "Cogollo común"
      },
      "bud_fine": {
        "name": "Cogollo selecto"
      },
      "bud_prime": {
        "name": "Cogollo supremo"
      },
      "cured_flower_fine": {
        "name": "Flor curada selecta"
      },
      "cured_flower_prime": {
        "name": "Flor curada suprema"
      },
      "pressed_resin_fine": {
        "name": "Resina prensada selecta"
      },
      "pressed_resin_prime": {
        "name": "Resina prensada suprema"
      },
      "infused_lozenge_fine": {
        "name": "Pastilla infusionada selecta"
      },
