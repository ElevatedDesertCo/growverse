  ...
  "entities": {
    ...
    "items": {
      ...
      "reins_swift_highfield_alpaca": {
        "name": "Hızlı Highfield Alpakası Dizginleri"
      },
      "reins_swift_ironhide_bull": {
        "name": "Hızlı Demir Derili Boğa Dizginleri"
      },
      "reins_swift_thornback_boar": {
        "name": "Hızlı Dikenli Sırt Yaban Domuzu Dizginleri"
      },
      "reins_elder_bloomstrider": {
        "name": "Kadim Çiçek Gezgini Dizginleri"
      },
      "verdant_wardrobe_crate": {
        "name": "Yeşeren Gardırop Sandığı"
      },
      "course_low_rail": {
        "name": "Alçak Çıta Atlayışı"
      },
      "course_hay_bales": {
        "name": "Saman Balyası Atlayışı"
      },
      "course_timber_arch": {
        "name": "Ahşap Kemer"
      }
