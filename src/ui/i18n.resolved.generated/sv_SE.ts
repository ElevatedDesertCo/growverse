...
export const sv_SE: EnTranslations = {
  ...
  "seo": {
    "title": "Growverse: Klassiskt inspirerad webb-MMO",
    "description": "Ge dig ut på ett episkt äventyr i Growverse, en klassiskt inspirerad mikro-MMO som du spelar direkt i din webbläsare. Anslut till en beständig delad värld, höj nivå på klasser och besegra fiender!",
    "genre": "MMORPG",
  ...
  "entities": {
    ...
    "items": {
      ...
      "bud_prime": {
        "name": "Förstklassig knopp"
      },
      "cured_flower_fine": {
        "name": "Fin torkad blomma"
      },
      "cured_flower_prime": {
        "name": "Förstklassig torkad blomma"
      },
      "pressed_resin_fine": {
        "name": "Fin pressad kåda"
      },
      "pressed_resin_prime": {
        "name": "Förstklassig pressad kåda"
      },
      "infused_lozenge_fine": {
        "name": "Fin infunderad pastill"
      },
      "infused_lozenge_prime": {
        "name": "Förstklassig infunderad pastill"
      },
      "resin_glyph_vigor": {
        "name": "Hartsglyf för kraft"
      },
      "resin_glyph_focus": {
        "name": "Hartsglyf för fokus"
      },
      "resin_glyph_warding": {
        "name": "Hartsglyf för skydd"
      },
      "vale_hash": {
        "name": "Dalhaschisch"
      },
      "golden_shatter": {
        "name": "Gyllene shatter"
      },
      "live_resin": {
        "name": "Färsk kåda"
      },
      "bloom_diamonds": {
        "name": "Blomningsdiamanter"
      },
      "bristleback_maul": {
