...
export const sv_SE: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "nativeUpdate": {
      ...
      "body": "En ny version av Growverse är tillgänglig. Uppdatera nu för de senaste korrigeringarna och förbättringarna.",
      "bodyWithVersion": "Version {version} av Growverse är tillgänglig. Uppdatera nu för de senaste korrigeringarna och förbättringarna.",
      "notNow": "Inte nu",
      "update": "Uppdatera"
    },
    "castBar": {
    ...
    "account": {
      ...
      "sectionWallet": "Growverse-plånbok",
  ...
  "guide": {
    ...
    "tagline": "En cannabis-fantasy-MMORPG du spelar gratis i din webbläsare.",
    ...
    "footer": {
      "blurb": "En cannabis-fantasy-MMORPG med öppen källkod. Lös uppdrag, gruppera dig och utforska en värld sammanlänkad av portaler, direkt i din webbläsare.",
      "playNow": "Spela nu",
    ...
    "home": {
      "eyebrow": "Cannabis-fantasy-MMORPG i webbläsaren",
      "title": "Growverse",
    ...
    "worldPage": {
      "heading": "Världen",
      "intro": "Growverse är ett enda sammanhängande land som du korsar till fots, tre zoner lagda från söder till norr. Det finns ingen snabbresa, så resan är en del av äventyret.",
      "hub": "Hembas",
  ...
  "playerCard": {
    ...
    "shareText": "Jag skapar min legend i Growverse: Nivå {level} {className}{tierBit}. Gå med i min värld:",
  ...
  "seo": {
    "title": "Growverse: The Portal Chronicles, ett gratis webbläsar-MMORPG",
    "description": "Growverse är ett gratis webbläsar-MMORPG i cannabis-fantasy-stil. Utforska en värld sammanlänkad av portaler, strid mot varelser, slutför uppdrag, odla magiska sorter och skapa din legend i ett rike i ständig utveckling. Spela direkt, ingen nedladdning.",
    "genre": "MMORPG",
    "playMode": "Flerspelarläge",
    "applicationCategory": "Spel",
    "operatingSystem": "Webbläsare",
    "officialLabel": "Officiell webbplats för Growverse",
  ...
  "a11y": {
    ...
    "githubProject": "Öppna GitHub-projektet Growverse",
    "discordCommunity": "Gå med i Growverse-gemenskapen på Discord",
    "donateProject": "Donera för att stödja Growverse"
  },
  "loading": {
  ...
  "desktop": {
    ...
    "crash": {
      ...
      "reload": "Ladda om",
      "quit": "Avsluta",
      "fatalBody": "Growverse stötte på ett oväntat fel och måste stängas."
    }
  },
  "realm": {
  ...
  "mobilePreflight": {
    ...
    "iosOpenStep": "Öppna Growverse från den nya Hemskärmsikonen.",
    ...
    "androidOpenStep": "Öppna Growverse från den nya ikonen.",
  ...
  "serverUnavailable": {
    "title": "Growverse - Riket otillgängligt",
    "logoAlt": "Growverse",
  ...
  "entities": {
    ...
    "items": {
      ...
      "cooked_mirror_trout": {
        "name": "Grillad spegelforell"
      },
      "cooked_river_perch": {
        "name": "Panstekt flodabborre"
      },
      "cooked_marsh_pike": {
        "name": "Rostad kärrgädda"
      },
      "cooked_bog_eel": {
        "name": "Rökt mossål"
      },
      "cooked_frostgill_trout": {
        "name": "Grillad frostgäl-forell"
      },
      "cooked_stonescale_carp": {
        "name": "Bakad stenfjäll-karp"
      },
      "bloom_extract": {
        "name": "Blomsterextrakt"
      },
      "swirling_healing_draught": {
        "name": "Virvlande läkedryck"
      },
      "swirling_mana_draught": {
        "name": "Virvlande manadryck"
      },
      "elixir_of_the_bloom": {
        "name": "Blomningens elixir"
      },
      "restful_bloom_tonic": {
        "name": "Vilsam blomstertonic"
      },
      "lively_bloom_tonic": {
        "name": "Livlig blomstertonic"
      },
      "balanced_bloom_tonic": {
        "name": "Balanserad blomstertonic"
      },
      "slow_bloom_lozenge": {
        "name": "Pastill av långsam blomning"
      },
      "purple_petal": {
        "name": "Lila Kronblad"
      },
    ...
    "npcs": {
      ...
      "auctioneer_voss": {
        ...
        "title": "Väktare av världsmarknaden",
        "greeting": "Growverse-marknaden är öppen även här, {className}. Köp från varje äventyrare i riket, eller lägg ut dina egna varor."
      },
      "brother_aldric_raid": {
        "name": "Broder Aldric",
        "title": "Dalens präst",
