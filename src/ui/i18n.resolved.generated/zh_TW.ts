  ...
  "entities": {
    ...
    "npcs": {
      ...
      "zaida_sunstranded": {
        "name": "扎伊達",
        "title": "困於烈日者",
        "greeting": "這麼說，你也感覺到了，那道門裡滲出的熱浪？我從那邊過來的，{playerName}，卻再也回不去了。門後是一片太陽永不落下的領域，餘燼荒野，它不會容忍毫無準備的人。擊殺那些被熱浪逼到這條路上的野狼，證明你的鋼鐵，我便為你打開通路。"
      },
      "ember_trademaster": {
        "name": "凱薩",
        "title": "貿易主管",
    ...
    "quests": {
      ...
      "q_ember_intro": {
        "title": "熱浪蒸騰之門",
        "text": "這道門的熱浪已把南路的野狼逼得半瘋，{playerName}，在處理掉牠們之前，沒人能在這裡安心紮營，我更不能。清除其中四隻，我便知道你的鋼鐵已足以應對蒸騰熱浪之後所等待的一切。",
        "completion": "手不抖，殺得俐落。很好。荒野對你的考驗將遠勝任何野狼，{playerName}，但你已贏得了穿越的資格。準備好了就踏過那片蒸騰熱浪：商隊驛站就在另一邊，那裡的尋路者正需要你這樣的人。",
        "objectives": {
          "0": {
            "label": "已清除的南路野狼"
          }
