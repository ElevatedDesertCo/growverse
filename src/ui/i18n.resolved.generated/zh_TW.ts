...
export const zh_TW: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "nativeUpdate": {
      "title": "有可用更新",
      "body": "Growverse 有新版本可用。立即更新以取得最新修正與改進。",
      "bodyWithVersion": "Growverse {version} 版本已可用。立即更新以取得最新修正與改進。",
      "notNow": "暫不",
      "update": "更新"
    },
    "castBar": {
    ...
    "breeding": {
      ...
      "outlookTitle": "這次雜交可能出什麼",
      "outlookRow": "{trait}：至少 {chance}% 保住 {target}，最高可到 {ceiling}",
      "outlookLandrace": "這個組合有機會出地方種。"
    },
    "reputation": {
      "tier": {
        "neutral": "中立",
  ...
  "guide": {
    ...
    "worldPage": {
      "heading": "世界",
      "intro": "Growverse 是一片你需徒步橫越的連綿大地，三大區域由南向北排列。沒有快速旅行，所以旅程本身就是冒險的一部分。",
      "hub": "主據點",
      "mapHeading": "北行之路",
  ...
  "playerCard": {
    ...
    "shareText": "我正在 Growverse 中鑄就傳說：{level}級 {className}{tierBit}。加入我的伺服器：",
  ...
  "desktop": {
    ...
    "crash": {
      ...
      "reload": "重新載入",
      "quit": "離開",
      "fatalBody": "Growverse 發生未預期的錯誤，必須關閉。"
    }
  },
  "realm": {
    "noRealms": "沒有可用伺服器。",
  ...
  "entities": {
    ...
    "npcs": {
      ...
      "morvenna_hedgewitch": {
        "name": "莫溫娜",
        "title": "荒籬女巫",
        "greeting": "待在燈火之中，{className}。黃昏一到，沼澤便會吐出它的亡者，而我所束縛的結界，只在獸脂燃燒之時方能維繫。將我所求之物帶來，我便能讓燐渡再多喘息一夜。"
      },
      "gravewarden_holt": {
        "name": "Holt",
        "title": "守墓人",
    ...
    "quests": {
      ...
      "q_stock_run": {
        "title": "調種之行",
        "text": "你把那張長期訂單填上了，所以現在告訴你新手沒人會說的一件事：好種源不在這兒。它鎖在種庫山下面，而看守只對公社認得的面孔開門。上去讓他們看看你。等他們認下你了再回來。",
        "completion": "他們認得你了。這比我能塞給你的任何一粒種子都值錢，而且你也確實花了夠久。",
        "objectives": {
          "0": {
            "label": "抵達種庫山"
          },
      ...
      "q_cuttings_for_the_lodge": {
        "title": "送往木屋的插條",
        "text": "羅恩要三份萃取物送到木屋，而且今天就要，因為萃取物放不住。直接送下去，親手交到她手裡。你要是半路跑去打土狼，等你到了它就一文不值了。",
        "completion": "趁著還沒壞就送到了。你不會相信有多少種植者連這一件事都辦不成。",
        "objectives": {
          "0": {
            "label": "把萃取物交給羅恩"
          }
      ...
      "q_walk_it_home": {
        "title": "把牠送回家",
        "text": "公社有隻河狸鑽進了烘乾棚，從日出起就賴在我的苗床裡，什麼用也沒有。你走慢點牠就會跟著。把牠帶到明木林地牠的水壩那邊去，路上看著點，牠自己可不會看著自己。",
        "completion": "到家了，還喘著氣。水壩那邊不會謝你，那隻河狸也不會，所以我來謝：謝了。",
        "objectives": {
          "0": {
            "label": "把河狸送到明木林地"
          }
      ...
      "q_greyrot": {
        "title": "灰腐",
        "text": "在這裡，綻放不像旱原上那樣枯萎，{playerName}。它是被淹死的。先變灰、發軟，腐爛順著根鬚一路蔓延，一整片梯田都化成爛泥。哪一片開始變色，沼澤腫脹獸就已經飄在上頭了。去西岸淺灘戳破十隻，回來告訴我裡面流出的是什麼。",
        "completion": "孢子，還是密密匝匝、大小一致的孢子。那不是天氣，{playerName}，也不是運氣。有人在養這種腐爛，並且把它對準了我們的園子。",
        "objectives": {
          "0": {
            "label": "擊敗沼澤腫脹獸"
          }
      ...
      "q_burn_the_beds": {
        "title": "燒掉溫床",
        "text": "雅拉想要一整季的時間，去育出能壓過腐爛的種。我沒有一整季。我有一條撐著兩百口人的堤道，還有一場正朝它走來的腐爛。把西岸淺灘的腫脹獸溫床燒了，{playerName}。十二隻應該就能斷掉那股漂流。沼澤會因此更貧瘠，而我照樣睡得著。",
        "completion": "淺灘成了灰燼，漂流在水邊徹底停住。這個決定是對的，雅拉會有一個月不跟我說話。拿上你的酬勞。",
        "objectives": {
          "0": {
            "label": "擊敗沼澤腫脹獸"
          }
      ...
      "q_seed_the_shallows": {
        "title": "在淺灘播種",
        "text": "火燒過的淺灘只剩光地，而光地正是腐爛下一步要去的地方。我寧可用綠意把它擠走。我手上有從布魯姆海文母株上育出的插條，能在死水裡生根，可深沼的鉗咬魚人不出一天就會把淺灘裡所有綠色的東西啃光。去東岸清掉十二隻，我就把插條種下去。",
        "completion": "插條種下去了，水還沒把它們泡壞。這比守望者想要的慢，要證明它有用更慢。但只要撐得住，沼澤保住的就是綠色，而不是用綠色換來的灰燼。",
        "objectives": {
          "0": {
            "label": "擊敗深沼鉗咬魚人"
          }
      ...
      "q_ash_and_water": {
        "title": "灰與水",
        "text": "火燒奏效了，也給我招來了新麻煩，這沼澤就是這麼還債的。煙把溺亡死者從淺水裡引了上來，如今它們就站在溫床燒剩的灰裡，什麼也不等。趁它們還沒摸到堤道，把十個放回去。",
        "completion": "灰燼，還有站在灰裡的死人。是我選了火，{playerName}，再來一次我還是選火。但別讓誰告訴你這沒有代價。",
        "objectives": {
          "0": {
            "label": "讓溺亡死者安息"
          }
      ...
      "q_first_green": {
        "title": "第一抹綠",
        "text": "插條活了，{playerName}。自沼澤上漲以來，淺灘第一次有了綠色，而巨魔已經從墳丘上下來，成把成把地把它們扯走。把十隻趕回東邊去。那些根多撐一天，腐爛就得多繞一天路。",
        "completion": "還立著，還是綠的。今年它救不了這片沼澤。可我祖母種下布魯姆海文那片梯田時，也沒能親眼看它開花，所以我願意收下一淺灘插條，把這叫作一個好季節。",
        "objectives": {
          "0": {
            "label": "擊敗泥沼巨魔"
          }
      ...
      "q_hollowmere_risen": {
        "title": "不安的沼澤",
        "text": "如今每逢黃昏，他們便從沼澤中爬出，{playerName}：那些燐渡亡者，依舊裹著我們下葬時的破衣。趁他們尚未逼近村落的圍籬，將其中十具重新放倒。這是樁陰森的活計，卻也是一種慈悲。",
        "completion": "十具已重歸泥沼。他們其實並不反抗，{playerName}，並不真的反抗。他們只是朝著燈火走去。無論是什麼在召喚他們，那召喚都來自墓門之下。",
        "objectives": {
          "0": {
            "label": "已放倒的燐渡亡者"
          }
      ...
      "q_hollowmere_revenants": {
        "title": "莫溫娜的結界",
        "text": "我用來束縛結界的那種蒼白墓苔，唯有在沼氣浸染的亡者倒下之處才會生根，{playerName}。沼地還魂者所過之處，卻將它盡數踐踏。沿著墓地邊緣斬倒八具，墓苔便會重新蔓回它們所佔據的土地。",
        "completion": "他們倒下之處，墓苔已然轉綠。很好。村落的護環還能再撐一夜，供其燃燒的獸脂也還夠。你為這些人爭取到了時間，{playerName}。",
        "objectives": {
          "0": {
            "label": "已斬倒的沼地還魂者"
          }
      ...
      "q_hollowmere_crones": {
        "title": "照亮漫漫幽暗",
        "text": "古老的結界燈籠沿著通往墓門的道路排列，{playerName}，而咒縛老嫗每逢黃昏便沿路潛行，掐熄途經的每一簇火焰，好讓亡者能行走於黑暗之路。斬倒她們六人，結界之燈便能再度徹夜燃燒。",
        "completion": "道路再度亮起，復生的亡者退縮其外，嘶嘶低鳴。這撐不了永遠，{playerName}：底下的某物極有耐性，而火焰不過是獸脂罷了。",
        "objectives": {
          "0": {
            "label": "已使噤聲的咒縛老嫗"
          }
      ...
      "q_hollowmere_sentinel": {
        "title": "墓塚哨衛",
        "text": "這片沼澤上有一物並非復生的屍首，{playerName}：一具墓塚哨衛，一名以篝火為首的守望者，是底下那東西派來看守墓門之路的。只要它還矗立，便無人能活著抵達墓門。單憑一柄刀刃難以將其斬殺，卻是難得的機會，能一窺深處的亡者究竟畏懼何物，竟要立下守衛。終結它。",
        "completion": "那咧笑的火光終於黯滅，通往墓門的道路總算暢通。無論是什麼為那哨衛加冕，{playerName}，它如今已近在咫尺。霍特會想知道，下行之路已然清空。",
        "objectives": {
          "0": {
            "label": "已摧毀墓塚哨衛"
          }
      ...
      "q_hollowmere_pumpkin_king": {
        "title": "南瓜王",
        "text": "哨衛既倒，門路既通，我們便知曉底下究竟有何物等待，{playerName}：在沉沒陵墓之中，一具以篝火為首的東西，古老歌謠稱其為南瓜王，已自封為亡者之王，喚起沼澤中的每一具屍首以充實它的宮廷。帶上同伴穿過墓門而下，斬落它的首級。這絕非孤身一刃所能承擔的差事。",
        "completion": "那咧笑歸於黑暗，我們頭頂上整片沼澤霎時一齊靜寂，{playerName}：每一具復生之物都如斷線傀儡般跌回泥沼。燐渡將最後一次埋葬它的亡者，而這一次，他們將長眠不起。你把墓園歸還給了這些人。",
        "objectives": {
          "0": {
            "label": "已擊殺南瓜王"
          }
    ...
    "dungeons": {
      ...
      "emberhold_keep": {
        "name": "燼堡",
        "enterText": "你穿過燒焦的閘門，進入燼堡...",
        "leaveText": "你穿過門樓，重新踏入開闊的荒漠。"
      },
      "sunken_bastion": {
        "name": "沉沒堡壘",
