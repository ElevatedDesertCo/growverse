...
export const ko_KR: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "nativeUpdate": {
      "title": "업데이트 사용 가능",
      "body": "Growverse의 새 버전을 사용할 수 있습니다. 지금 업데이트하여 최신 수정 사항과 개선 사항을 받으세요.",
      "bodyWithVersion": "Growverse 버전 {version}을(를) 사용할 수 있습니다. 지금 업데이트하여 최신 수정 사항과 개선 사항을 받으세요.",
      "notNow": "나중에",
      "update": "업데이트"
    },
    "castBar": {
  ...
  "guide": {
    ...
    "worldPage": {
      "heading": "세계",
      "intro": "Growverse는 두 발로 가로지르는 하나로 이어진 대지이며, 남에서 북으로 펼쳐진 세 개의 지역으로 이루어져 있습니다. 빠른 이동이 없으니, 여정 자체가 모험의 일부입니다.",
      "hub": "본거지",
  ...
  "playerCard": {
    ...
    "shareText": "Growverse에서 제 전설을 벼리고 있습니다: {level}레벨 {className}{tierBit}. 제 렐름에 합류하세요:",
    "nativeShareTitle": "Growverse의 세계",
  ...
  "desktop": {
    ...
    "crash": {
      ...
      "reload": "다시 불러오기",
      "quit": "종료",
      "fatalBody": "Growverse에 예기치 않은 오류가 발생하여 종료해야 합니다."
    }
  },
  "realm": {
  ...
  "entities": {
    ...
    "npcs": {
      ...
      "zaida_sunstranded": {
        "name": "자이다",
        "title": "태양에 발이 묶인 자",
        "greeting": "그럼 자네도 느끼는군, 저 관문에서 새어 나오는 열기를? 나는 저것을 지나 이곳에 왔다네, {playerName}, 그리고 다시는 돌아갈 수 없었지. 저 너머에는 태양이 결코 지지 않는 영역이 있네, 엠버웨이스트라고 하지. 그곳은 준비되지 않은 자를 봐주지 않아. 열기에 쫓겨 이 길로 나온 늑대들을 베어 넘겨 자네의 강철을 증명하게. 그러면 내가 자네에게 길을 열어 주겠네."
      },
      "ember_trademaster": {
        "name": "케사",
        "title": "교역장",
        "greeting": "나그네여, 물과 소금과 강철, 대상 숙소가 파는 것은 그것뿐이며 사구가 존중하는 것도 그것뿐이라네. 저 태양 아래로 나서기 전에 필요한 것을 사 두게."
      },
      "ember_wayfinder": {
        "name": "Oren",
        "title": "길잡이",
        "greeting": "문을 지나왔으니 이미 보았겠지, {playerName}. 지지 않는 태양을 말일세. 사구 길을 따라 늘어선 오래된 태양 수호탑은 모두 꺼졌고, 그것들이 다시 타오르기 전까지 죽은 자들은 결코 잠들지 못하네. 그 첫 번째 탑에 다시 불을 밝히도록 도와주게."
      },
      "ember_cultivator": {
        "name": "사브라",
        "title": "태양 재배자",
        "greeting": "{className}이여, 이 오아시스는 다른 황무지에서는 피울 수 없는 꽃 하나를 피운다네. 바로 태양섬광 구근이지. 가공하지 않은 구근과 약간의 잔불 정수를 가져다주면, 재배소가 그것에서 진정한 희귀 씨앗을 이끌어낼 걸세."
      },
      "ember_glassmaker": {
        "name": "바슈티",
        "title": "유리 세공사",
        "greeting": "협곡 바닥에서는 조심하게, {playerName}. 유리등 바실리스크는 흑요석에 녹아들어 덮칠 때까지 보이지 않는다네. 내가 여기 머무는 것은 광맥 때문이지, 어느 세계에서도 가장 고운 유리모래니까. 하지만 두 번째 태양 수호탑은 여기서 북쪽 슬롯 협곡에 묻혀 있고, 아지랑이를 두른 무언가가 그것을 지키고 있네."
      },
      "tidewatcher_ondrel": {
        "name": "온드렐 베인",
        "title": "조수지기",
    ...
    "quests": {
      ...
      "q_ember_intro": {
        "title": "아지랑이 이는 관문",
        "text": "저 관문의 열기가 남쪽 길의 늑대들을 반쯤 미치게 만들었다네, {playerName}. 그것들을 처리하기 전까지는 아무도 여기서 편히 야영할 수 없지, 나조차도 말일세. 그중 넷을 처치하면 자네의 강철이 아지랑이 너머에서 기다리는 것에 맞설 준비가 되었음을 알 수 있을 걸세.",
        "completion": "흔들림 없는 손, 깔끔한 처치로군. 좋아. 황무지는 그 어떤 늑대보다도 혹독하게 자네를 시험할 걸세, {playerName}, 하지만 자네는 건너갈 자격을 얻었네. 준비가 되거든 아지랑이를 지나게. 그 건너편에 대상 숙소가 있고, 그곳의 길잡이가 자네 같은 사람을 필요로 한다네.",
        "objectives": {
          "0": {
            "label": "처치한 남쪽 길 늑대"
          }
      ...
      "q_ember_ward1": {
        "title": "태양 수호탑에 다시 불을 밝혀라",
        "text": "{playerName}, 첫 번째 태양 수호탑은 대상 숙소 북쪽 사구 길에 부서진 채 서 있고, 모래 추적자들이 무너진 돌 사이에 둥지를 틀었다네. 그중 여섯을 처치하고 잔해에서 태양 수호석 조각 세 개를 모아 오게. 그러면 내가 수호탑을 다시 묶어, 죽은 자들이 걸을 수 없는 한 구간의 길을 그들에게 내어줄 수 있네.",
        "completion": "수호석이 조각을 삼키고 빛을 머금으니, 오랜 세월 만에 처음으로 사구 길 한 구간이 그림자를 드리웠다네. 작은 어둠이지만, {playerName}, 이것이 시작일세. 죽은 자들은 그것을 넘지 못하네.",
        "objectives": {
          "0": {
            "label": "처치한 모래 추적자"
          },
      ...
      "q_ember_ward2": {
        "title": "파묻힌 태양 수호탑",
        "text": "두 번째 태양 수호탑은 리치 북쪽의 무너진 슬롯 협곡에 반쯤 파묻혀 있다네, {playerName}. 유리등 바실리스크가 그 위 잔해에 굴을 틀었지. 그 수를 줄이게, 다섯이면 충분할 걸세. 그리고 능선에서 파는 자를 비명으로 쫓아내는 협곡 때까치 여덟 마리를 베어 넘기게. 길을 열어 주면 내가 직접 수호탑으로 내려갈 수 있네.",
        "completion": "능선은 잠잠해지고 굴은 부서졌네, {playerName}. 나는 수호탑까지 내려가 그 초점석에서 모래를 걷어냈다네. 셋 중 둘째, 첫째만큼이나 어두웠지. 둘은 다시 밝혔고, 하나가 남았네. 마지막 하나는 교단이 불을 지키는 곳에 있지.",
        "objectives": {
          "0": {
            "label": "처치한 유리등 바실리스크"
          },
      ...
      "q_ember_ward3": {
        "title": "지지 않는 태양의 교단",
        "text": "이제 태양이 왜 지지 않는지 알겠지, {playerName}. 세 번째 태양 수호탑은 폐허가 아니라네. 잔불 교단이 신더리치 높은 곳의 원형 극장에서 일부러 불을 지피고 있는 것이지. 그곳의 잿빛 광신도는 하나같이 낮을 붙들어 두는 저 불에 땔감을 대고 있네. 그들의 원진을 깨뜨리게. 광신도 열을 베어 넘기고, 그들이 슬래그에서 일으키는 잉걸 골렘 넷을 부수게. 그러면 이 일이 얼마나 깊은지 알 수 있을 걸세.",
        "completion": "광신도 열이 쓰러지고 그 골렘들도 슬래그로 돌아갔건만, 태양은 여전히 저기 걸려 있네, {playerName}. 그러니 사실이었어. 이곳의 수호탑은 부서진 것이 아니라, 억지로 붙들려 있는 것이지. 그리고 그 닻은 지표에 있지도 않네. 그것은 아래로, 사구 밑 오래된 무덤 도시로 뻗어 있다네. 이 모든 것이 끝나는 곳은 바로 거기일세.",
        "objectives": {
          "0": {
            "label": "베어 넘긴 잿빛 광신도"
          },
      ...
      "q_ember_finale": {
        "title": "태양이 지는 곳",
        "text": "그 닻은 파묻힌 왕조로 뻗어 내려간다네, {playerName}. 사구 밑에 가라앉은 무덤 도시지. 그 중심에서 풍뎅이 산란모가 태양을 높이 떠받치는 의식을 휘감고 있네. 이것은 칼 한 자루로 될 심부름이 아닐세. 동료를 모아 교단의 원형 극장을 지나 내려가, 산란모와 그 새끼들을 부수게. 저 지지 않는 태양을 꺼뜨리게.",
        "completion": "해냈군, {playerName}. 산란모는 미동도 없고, 의식의 불은 사그라들며, 사구 위로는 태양이 오랜 세월 닿지 못했던 지평선을 향해 미끄러져 내려가네. 오늘 밤 대상 숙소는 처음으로 진정한 황혼을, 그리고 처음으로 서늘한 새벽을 맞이할 걸세. 자네가 엠버웨이스트에 밤을 되돌려 주었네.",
        "objectives": {
          "0": {
            "label": "처치한 풍뎅이 산란모"
          }
    ...
    "dungeons": {
      ...
      "the_buried_dynasty": {
        "name": "파묻힌 왕조",
        "enterText": "사그라드는 의식의 불을 지나, 자네는 차가운 사암 속으로, 수천 마리 풍뎅이의 메마른 사각거림 속으로 내려가네. 옛 왕조가 그 죽은 태양과 함께 묻힌 그 깊은 곳으로.",
        "leaveText": "원형 극장을 지나 자네는 지지 않는 빛 속으로 다시 올라가네."
      },
      "drowned_temple": {
        "name": "익사한 신전",
