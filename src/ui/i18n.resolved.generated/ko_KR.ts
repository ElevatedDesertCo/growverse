...
export const ko_KR: EnTranslations = {
  ...
  "entities": {
    ...
    "quests": {
      "q_first_harvest": {
        "title": "첫 수확",
        "text": "재배자는 누구나 같은 자리에서 시작하지. 이랑 하나, 씨앗 하나, 그리고 건드리지 않고 기다리는 인내심. 무언가를 심고, 끝까지 자라게 둔 다음, 거기서 나온 것을 내게 가져오게. 더 좋은 종자를 맡기기 전에 자네가 작물을 어떻게 다루는지부터 봐야겠어.",
        "completion": "이것 좀 보게. 깔끔하게 손질했고 서두른 티가 하나도 없군. 자네는 이 일에 맞는 손을 가졌어.",
        "objectives": {
          "0": {
            "label": "평범한 꽃봉오리"
          }
      ...
      "q_stock_run": {
        "title": "종자 수급",
        "text": "그 상시 주문을 채웠으니, 이제 새 재배자에게 아무도 말해주지 않는 걸 알려주지. 좋은 원주는 여기 두지 않는다. 씨앗금고 언덕 아래에 있고, 지킴이들은 공동체가 이미 아는 얼굴에게만 문을 연다. 올라가서 얼굴을 보여라. 그쪽이 알아보면 돌아와.",
        "completion": "이제 그들이 자네를 안다. 내가 쥐여줄 수 있는 어떤 씨앗보다 값지지. 물론 오래도 걸렸다만.",
        "objectives": {
          "0": {
            "label": "씨앗금고 언덕 방문"
          },
      ...
      "q_cuttings_for_the_lodge": {
        "title": "로지로 보낼 삽수",
        "text": "로언이 로지에서 추출물 세 몫을 원하고, 그것도 오늘 원한다. 추출물은 오래 못 가니까. 곧장 내려가서 그녀 손에 직접 쥐여줘라. 도중에 코요테나 쏘러 새면, 도착할 즈음엔 아무 값어치도 없을 거다.",
        "completion": "상하기 전에 전달했군. 그 한 가지도 못 해내는 재배자가 얼마나 많은지 알면 놀랄 거다.",
        "objectives": {
          "0": {
            "label": "로언에게 추출물 전달"
          }
      ...
      "q_walk_it_home": {
        "title": "걸려서 데려다줘라",
        "text": "공동체 비버 한 마리가 건조 창고에 들어갔다가, 해 뜰 때부터 내 모판에 눌러앉아 아무짝에도 쓸모없이 있다. 천천히 걸으면 따라올 거다. 브라이트우드 숲에 있는 제 둑까지 데려다줘라. 가는 길에 잘 봐줘야 한다. 제 앞가림은 못 하는 놈이니까.",
        "completion": "집에 갔고, 아직 숨도 쉰다. 둑에서도 고맙다 안 할 거고 비버도 안 할 테니, 내가 하지. 고맙다.",
        "objectives": {
          "0": {
            "label": "비버를 브라이트우드 숲까지 인솔"
          }
        }
      },
      "q_fine_supply": {
        "title": "조금 더 좋은 것",
        "text": "평범한 물건으로도 등불은 밝히지만, 그걸로 누군가를 감탄시키지는 못하지. 나는 더 좋은 재료가 필요하고, 자네가 그걸 어디서 구해오든 별로 상관하지 않네. 참을성이 있으면 직접 교배해서 얻고, 없으면 그렇게 해낸 사람에게서 사 오게. 돈을 쥔 재배자도 여전히 재배자니까.",
        "completion": "이 정도면 제대로 건조할 값어치가 있군. 이걸 길러낸 자는 뭘 아는 사람이야. 그게 자네라면 더 좋고.",
        "objectives": {
          "0": {
            "label": "상급 꽃봉오리"
          }
      ...
      "q_prime_order": {
        "title": "재배자의 주문서",
        "text": "한 번도 채워본 적 없는 상시 주문이 하나 있네. 최상급 재료, 그 아래로는 안 돼. 그러려면 끝까지 제대로 교배된 품종이 있어야 하고, 그건 몇 해에 걸쳐 직접 교배하거나 이미 해낸 누군가와 좋은 관계를 맺어야 한다는 뜻이지. 어느 쪽이든 이걸 채워주면 오두막 전체가 자네 이름을 기억할 걸세.",
        "completion": "최상급 여섯. 긴 계절을 기다렸네. 오두막이 자네에게 빚을 졌고, 나도 마찬가지야.",
        "objectives": {
          "0": {
            "label": "최상급 꽃봉오리"
          }
      ...
      "q_greyrot": {
        "title": "잿빛 부패",
        "text": "이곳의 블룸은 메마른 평지에서처럼 시들지 않습니다, {playerName}. 익사하지요. 잿빛으로 물러지고, 부패가 뿌리에서 뿌리로 걸어가 계단밭 하나를 통째로 진창으로 만듭니다. 그리고 색이 변한 자리 위에는 어김없이 늪 부푼괴물이 떠 있습니다. 서쪽 여울에서 열 마리를 터뜨리고, 안에서 무엇이 나왔는지 알려주세요.",
        "completion": "포자군요. 그것도 빽빽하게 들어차고 크기까지 고른. 그건 날씨가 아닙니다, {playerName}. 운도 아니고요. 누군가 이 부패를 기르고 있고, 우리 밭을 겨누고 있습니다.",
        "objectives": {
          "0": {
            "label": "늪 부푼괴물 처치"
          }
      ...
      "q_burn_the_beds": {
        "title": "온상을 불태워라",
        "text": "야라는 부패를 이길 품종을 길러낼 한 철을 원하지. 내겐 한 철이 없다. 내겐 이백 명을 떠받치는 둑길과, 그리로 곧장 걸어오는 부패가 있을 뿐이다. 서쪽 여울의 부푼괴물 온상을 태워라, {playerName}. 열두 마리면 그 흐름은 끊긴다. 늪은 그만큼 메마르겠지만, 나는 그래도 잠들 것이다.",
        "completion": "여울은 재가 되었고 흐름은 물가에서 뚝 멈췄다. 옳은 판단이었고, 덕분에 야라는 한 달간 내게 말을 걸지 않겠지. 삯을 받아 가라.",
        "objectives": {
          "0": {
            "label": "늪 부푼괴물 처치"
          }
      ...
      "q_seed_the_shallows": {
        "title": "여울에 심다",
        "text": "불은 여울을 헐벗게 할 뿐이고, 헐벗은 땅이야말로 부패가 다음으로 향하는 곳입니다. 저는 차라리 초록으로 밀어내고 싶습니다. 블룸헤이븐 모주에서 길러낸, 고인 물에서도 뿌리내리는 삽수가 있습니다. 그런데 딥펜 무는이들이 여울의 푸른 것을 하루 만에 훑어 먹습니다. 동쪽 기슭에서 열두 마리를 치워주시면 삽수를 넣겠습니다.",
        "completion": "삽수는 들어갔고, 물은 아직 그것을 상하게 하지 않았습니다. 감시관이 바라는 것보다 느리고, 쓸모를 증명하기는 더 느리지요. 하지만 버텨준다면 늪은 초록을 재와 맞바꾸지 않고 지켜냅니다.",
        "objectives": {
          "0": {
            "label": "딥펜 무는이 처치"
          }
      ...
      "q_ash_and_water": {
        "title": "재와 물",
        "text": "불태우기는 통했다. 그리고 새 골칫거리를 사들였지. 이 늪이 빚을 갚는 방식이 그렇다. 연기가 익사한 자들을 얕은 물에서 끌어올렸고, 이제 그것들은 온상이 있던 자리의 재 위에 아무것도 기다리지 않는 얼굴로 서 있다. 둑길을 찾아내기 전에 열을 도로 눕혀라.",
        "completion": "재와, 그 위에 선 망자라. 불을 고른 건 나다, {playerName}. 다시라도 같은 것을 고르겠다. 다만 그것이 공짜였다고는 누구에게도 말하게 두지 마라.",
        "objectives": {
          "0": {
            "label": "익사한 망자 안식시킴"
          }
      ...
      "q_first_green": {
        "title": "첫 초록",
        "text": "삽수가 뿌리를 내렸습니다, {playerName}. 늪이 차오른 이래 처음으로 여울에 초록이 있습니다. 그런데 트롤들이 봉분에서 내려와 그것을 한 움큼씩 뜯어 가고 있어요. 열 마리를 동쪽으로 몰아내 주세요. 저 뿌리가 버티는 하루하루가, 부패가 돌아가야 하는 하루입니다.",
        "completion": "아직 서 있고, 아직 초록입니다. 올해의 늪을 구하지는 못하겠지요. 하지만 제 할머니도 블룸헤이븐 계단밭을 심고 꽃을 보지 못했습니다. 그러니 여울 가득한 삽수를 받고, 좋은 철이었다고 부르겠습니다.",
        "objectives": {
          "0": {
            "label": "마이어펜 트롤 처치"
          }
