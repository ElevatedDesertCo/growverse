...
export const ru_RU: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "mounts": {
      "learned": "Вы научились ездить верхом: {name}.",
      "windowTitle": "Транспорт",
      "summon": "Призвать",
      "dismiss": "Спешиться",
      ...
      "errors": {
        ...
        "alreadyHaveReins": "У вас уже есть эти поводья.",
        "fiestaBout": "Во время матча Фиесты это невозможно.",
        "notKnown": "Вы не умеете ездить на этом транспорте.",
        "notEnoughGrow": "Недостаточно $GROW.",
        "learnLevel": "Чтобы научиться верховой езде, требуется уровень {level}.",
        "rideLevel": "Для верховой езды требуется уровень {level}."
      }
    },
    "emotes": {
      "wave": "Помахать",
  ...
  "guide": {
    ...
    "mountsPage": {
      "heading": "Транспорт",
      "intro": "Верховые животные с ветерком несут вас через весь мир. Научитесь верховой езде в конюшнях Блумхейвена, выберите спутника себе по нраву, и дороги станут куда короче.",
      "whatHeading": "Как устроена верховая езда",
      "whatBody": "Каждый скакун открывается один раз: купите его поводья в конюшне, обучитесь, и он ваш навсегда. Призывайте его вне боя и на суше; удар, начало заклинания или погружение в воду вернут вас на собственные ноги.",
      "tiersHeading": "Верховая езда и быстрая езда",
      "tiersBody": "Конюшня растит два поголовья. Обычные скакуны, это первый шаг, а быстрые, это то же спокойное поголовье, выращенное резвее. Внутри одного разряда все скакуны движутся с одинаковой скоростью, так что выбор, это нрав и облик, но никогда не скорость.",
      "exclusiveHeading": "Цветущие Странники",
      "exclusiveBody": "Два скакуна, Цветущий Странник и Древний Цветущий Странник, не выращены, а выросли сами, и продаются в конюшне только за $GROW. Это скакуны престижа: внутри своего разряда они ровно так же быстры, как и любой другой.",
      "whereHeading": "Где научиться",
      "whereBody": "Достигнув уровня {level}, загляните в конюшни Блумхейвена в стартовой долине. Смотрительница конюшен начнет с уроков верховой езды на учебном маршруте, а поводья в продаже покрывают оба разряда.",
      "fromLevel": "С уровня {n}",
      "ridingTier": "Верховая",
      "swiftTier": "Быстрая",
      "exclusiveTag": "Только за $GROW"
    },
    "talentsPage": {
  ...
  "entities": {
    ...
    "items": {
      ...
      "reins_swift_highfield_alpaca": {
        "name": "Поводья быстрой альпаки с Верхних полей"
      },
      "reins_swift_ironhide_bull": {
        "name": "Поводья быстрого железношкурого быка"
      },
      "reins_swift_thornback_boar": {
        "name": "Поводья быстрого тернистого вепря"
      },
      "reins_elder_bloomstrider": {
        "name": "Поводья Древнего Цветущего Странника"
      },
      "verdant_wardrobe_crate": {
        "name": "Зеленеющий гардеробный сундук"
      },
      "course_low_rail": {
        "name": "Низкий барьер"
      },
    ...
    "mounts": {
      "mount_alpaca": {
        "name": "Альпака с Верхних полей"
      },
      "mount_bull": {
        "name": "Железношкурый бык"
      },
      "mount_boar": {
        "name": "Тернистый вепрь"
      },
      "mount_bloomstrider": {
        "name": "Цветущий Странник"
      },
      "mount_swift_alpaca": {
        "name": "Быстрая альпака с Верхних полей"
      },
      "mount_swift_bull": {
        "name": "Быстрый железношкурый бык"
      },
      "mount_swift_boar": {
        "name": "Быстрый тернистый вепрь"
      },
      "mount_elder_bloomstrider": {
        "name": "Древний Цветущий Странник"
      }
    },
    "npcs": {
      "the_merchant": {
      ...
      "stablemaster_marla": {
        "name": "Смотрительница конюшен Марла",
        "title": "Хранительница конюшен Блумхейвена",
        "greeting": "Ворота конюшни открыты, {className}. Каждого из этих скакунов растили с заботой, и ход у них ровный. А вот Цветущий Странник... тот вырос сам, и приручить его не удалось никому."
      },
      "rowan_sawtooth": {
        "name": "Роуэн Сотут",
    ...
    "quests": {
      ...
      "q_riding_lessons": {
        ...
        "text": "Хотите ездить верхом, {className}? Тогда сначала освойте двор, а уж потом дорогу. Пройдите мой учебный маршрут: низкий барьер, стога сена, а затем обратно через деревянную арку. Вперед! Возьмите каждое препятствие и вернитесь верхом через арку.",
        "completion": "Твердая рука, уверенная посадка. Вы справитесь. Возьмите это за труды: должно хватить на первые поводья. Выберите скакуна себе по нраву, и остерегайтесь Цветущего Странника: этот сам выбирает своего всадника.",
        "objectives": {
          "0": {
            "label": "Низкий барьер взят"
          },
          "1": {
            "label": "Стога сена взяты"
          },
          "2": {
            "label": "Деревянная арка пройдена верхом"
          }
        }
      },
      "q_sluice_welcome": {
