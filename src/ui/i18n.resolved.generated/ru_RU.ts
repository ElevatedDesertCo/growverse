...
export const ru_RU: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "fishing": {
      ...
      "introHint": "Повернитесь к воде и используйте удочку, чтобы ловить рыбу."
    }
  },
  "guide": {
    "brand": "Growverse",
  ...
  "entities": {
    ...
    "npcs": {
      ...
      "cook_marta": {
        "name": "Марта",
        "title": "Портовая кухарка",
        "greeting": "Мельничный пруд спокоен, и окунь хорошо клюёт. Удочка стоит недорого, а горячая еда согревает, {className}."
      },
      "rowan_sawtooth": {
        "name": "Роуэн Сотут",
