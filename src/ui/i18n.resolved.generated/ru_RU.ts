...
export const ru_RU: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "nativeUpdate": {
      ...
      "body": "Доступна новая версия Growverse. Обновите сейчас, чтобы получить последние исправления и улучшения.",
      "bodyWithVersion": "Доступна версия {version} Growverse. Обновите сейчас, чтобы получить последние исправления и улучшения.",
      "notNow": "Не сейчас",
      "update": "Обновить"
    },
    "castBar": {
    ...
    "bank": {
      "none": "Поблизости нет банка.",
      "full": "Ваш банк переполнен.",
      "notInBank": "Этого предмета нет в вашем банке.",
      "open": "Банк",
      "title": "Хранилище {name}",
      "close": "Закрыть банк",
      "bankedTitle": "В хранилище",
      "bankedEmpty": "Ваше хранилище пусто.",
      "bagsTitle": "Ваши сумки",
      "bagsEmpty": "Ваши сумки пусты.",
      "withdrawAria": "Забрать {item}",
      "depositAria": "Положить {item}",
      "clickWithdraw": "Нажмите, чтобы забрать",
      "clickDeposit": "Нажмите, чтобы положить",
      "hint": "Нажмите на предмет в сумке, чтобы убрать его, или на предмет в хранилище, чтобы забрать обратно.",
      "fullHint": "Хранилище заполнено. Заберите что-нибудь, чтобы освободить место.",
      "deposited": "Положено: {name}.",
      "withdrew": "Забрано: {name}."
    },
    "itemArmorType": {
      "cloth": "Ткань",
      "leather": "Кожа",
    ...
    "crafting": {
      "growTitle": "Станция выращивания",
      "upgradeTitle": "Верстак улучшений",
      "cookTitle": "Костёр для готовки",
      "alchemyTitle": "Алхимическая лаборатория",
      "enchantTitle": "Стол внедрения",
      "extractTitle": "Лаборатория экстракции",
      "growHint": "Создавайте питательные смеси, улучшайте сорта семян и собирайте снаряжение для выращивания.",
      "upgradeHint": "Перековывайте снаряжение и вырезайте боевые расходники из осколков Порчи.",
      "cookHint": "Приготовьте пойманную рыбу в сытные блюда, восстанавливающие здоровье и ману.",
      "alchemyHint": "Варите собранные цветы в лечебные настои, зелья маны и боевой эликсир.",
      "enchantHint": "Свяжите отборные бутоны и осколки Порчи в глифы, которые держатся полчаса.",
      "extractHint": "Промывайте собранные бутоны в гашиш, шаттер, живую смолу и алмазы.",
      "craftButton": "Создать",
      "costLabel": "Стоимость",
      ...
      "close": "Закрыть",
      "categories": {
        "nutrient": "Питательные смеси",
        "seed": "Сорта семян",
        "accessory": "Снаряжение для выращивания",
        "consumable": "Расходники",
        "gear": "Перекованное снаряжение",
        "food": "Приготовленная еда"
      },
      "errors": {
        "recipeUnavailable": "Этот рецепт здесь недоступен.",
        "tooFarFromStation": "Вы слишком далеко от верстака.",
        "levelTooLow": "Вам пока не хватает мастерства, чтобы создать это.",
        "missingMaterials": "У вас недостаточно материалов для создания этого.",
        "budsNotFresh": "Эти бутоны высохли. Живую смолу добывают сразу после сбора.",
        "processRunning": "Этот процесс ещё идёт. Возвращайтесь, когда он закончится."
      }
    },
    "trade": {
      "cutLabel": "Черенок",
      "hint": "Черенок копирует штамм: свой вы оставляете себе, а получателю нужен свободный слот."
    },
    "cup": {
      "title": "Кубок Долины",
      "open": "Участвовать в Кубке Долины",
      "hint": "Судят по генетике, по принесённому сорту бутонов и по тому, насколько вы знаете растение.",
      "season": "Сезон {season}",
      "remainingHours": "Осталось {hours} ч {minutes} мин",
      "remainingMinutes": "Осталось {minutes} мин",
      "best": "Ваш лучший результат: {score}",
      "emptyBoard": "В этом сезоне заявок ещё нет. Открыть таблицу вам.",
      "gradeLabel": "Сорт бутонов",
      "strainLabel": "Штамм",
      "noBuds": "Нет бутонов для заявки. Сначала соберите урожай.",
      "noStrains": "Штаммов пока нет. Соберите урожай, чтобы открыть первый.",
      "projected": "Даст {score}",
      "enter": "Участвовать ({count} бутонов, {score} очков)",
      "posted": "{strain} в таблице с результатом {score}, место {rank}."
    },
    "garden": {
      "title": "Сад",
    ...
    "breeding": {
      ...
      "hint": "Скрестите два штамма, чтобы объединить их черты, или посадите один в саду.",
      "open": "Вывести штаммы",
      "empty": "Штаммов пока нет. Соберите Цветение, чтобы открыть первый штамм.",
      "landrace": "Ландрас",
      "potency": "Сила",
      "vigor": "Живучесть",
      "yield": "Урожай",
      ...
      "refine": "Улучшить",
      "refineHint": "Вложите второй штамм в первый: он станет лучше, а слот освободится.",
      "fullRefine": "Библиотека штаммов заполнена. Улучшите или отпустите штамм, чтобы освободить место.",
      "outlookTitle": "Что может дать это скрещивание",
      "outlookRow": "{trait}: не менее {chance}% удержать {target}, вплоть до {ceiling}",
      "outlookLandrace": "Эта пара может дать ландрас."
    },
    "reputation": {
      "tier": {
        "neutral": "Нейтралитет",
  ...
  "guide": {
    ...
    "worldPage": {
      "heading": "Мир",
      "intro": "Growverse - это единый цельный край, который вы пересекаете пешком, три зоны, протянувшиеся с юга на север. Здесь нет быстрых перемещений, так что дорога - это часть приключения.",
      "hub": "Опорная база",
  ...
  "playerCard": {
    ...
    "shareText": "Я создаю свою легенду в Growverse: уровень {level}, {className}{tierBit}. Присоединяйтесь к моему миру:",
    "nativeShareTitle": "Мир Growverse",
  ...
  "a11y": {
    ...
    "githubProject": "Открыть проект Growverse на GitHub",
    "discordCommunity": "Присоединиться к Discord-сообществу Growverse",
    "donateProject": "Пожертвовать на поддержку Growverse"
  },
  "loading": {
    "world": "Загрузка мира...",
  ...
  "desktop": {
    ...
    "crash": {
      ...
      "quit": "Выйти",
      "fatalBody": "Growverse столкнулась с непредвиденной ошибкой и будет закрыта."
    }
  },
  "realm": {
  ...
  "mobilePreflight": {
    ...
    "iosOpenStep": "Откройте Growverse через новый значок на домашнем экране.",
    ...
    "androidOpenStep": "Откройте Growverse через новый значок.",
  ...
  "serverUnavailable": {
    "title": "Growverse - мир недоступен",
    "logoAlt": "Growverse",
  ...
  "hud": {
    ...
    "arena": {
      ...
      "killsTitle": "Убийства на арене (всего)",
  ...
  "entities": {
    ...
    "items": {
      ...
      "cooked_mirror_trout": {
        "name": "Зеркальная форель на гриле"
      },
      "cooked_river_perch": {
        "name": "Жареный речной окунь"
      },
      "cooked_marsh_pike": {
        "name": "Запечённая болотная щука"
      },
      "cooked_bog_eel": {
        "name": "Копчёный болотный угорь"
      },
      "cooked_frostgill_trout": {
        "name": "Морозножаберная форель на гриле"
      },
      "cooked_stonescale_carp": {
        "name": "Запечённый каменночешуйчатый карп"
      },
      "bloom_extract": {
        "name": "Цветочный экстракт"
      },
      "swirling_healing_draught": {
        "name": "Вихревое лечебное зелье"
      },
      "swirling_mana_draught": {
        "name": "Вихревое зелье маны"
      },
      "elixir_of_the_bloom": {
      ...
      "cured_flower_fine": {
        "name": "Отборный вяленый цвет"
      },
      "cured_flower_prime": {
        "name": "Отменный вяленый цвет"
      },
      "pressed_resin_fine": {
        "name": "Отборная прессованная смола"
      },
      "pressed_resin_prime": {
        "name": "Отменная прессованная смола"
      },
      "infused_lozenge_fine": {
        "name": "Отборная настоянная пастилка"
      },
      "infused_lozenge_prime": {
        "name": "Отменная настоянная пастилка"
      },
      "resin_glyph_vigor": {
        "name": "Смоляной глиф мощи"
      },
      "resin_glyph_focus": {
        "name": "Смоляной глиф сосредоточения"
      },
      "resin_glyph_warding": {
        "name": "Смоляной глиф ограждения"
      },
      "vale_hash": {
        "name": "Долинный гашиш"
      },
    ...
    "npcs": {
      ...
      "cultivator_marlow": {
        "name": "Марлоу",
        "title": "Культиватор",
        "greeting": "Станция выращивания в твоём распоряжении, друг. Питательные смеси, сорта семян, снаряжение для выращивания. Что нужно растениям?"
      },
      "smith_draxa": {
        "name": "Дракса",
      ...
      "alchemist_sable": {
        "name": "Сейбл",
        "title": "Алхимик",
        "greeting": "Принеси мне цветы из долины, {className}, и я извлеку их суть: настои, что исцеляют плоть, что бодрят разум, и эликсир, что обостряет ум."
      },
      "glyphwright_orrin": {
        "name": "Оррин",
        "title": "Глифотворец",
        "greeting": "Сжечь свой лучший цвет способен любой садовод, {className}. Принеси отборные бутоны и осколок из разлома, и я свяжу их в глиф, который держится полчаса."
      },
      "extractor_rell": {
        "name": "Релл",
        "title": "Экстрактор",
        "greeting": "Цветок - это начало, {className}, а не конец. Принеси бутоны, и я промою их в гашиш, шаттер или алмазы. Принеси их прямо с грядки, ещё влажными, и мы сделаем кое-что получше."
      },
      "cup_steward_wilder": {
        "name": "Уайлдер",
        "title": "Распорядитель Кубка Долины",
        "greeting": "Кубок открыт, {className}. Принесите штамм и десять бутонов с него, и я впишу ваше имя в таблицу. Судим по генетике, по принесённому сорту и по тому, насколько вы знаете растение. Всё три, иначе вы просто участник."
      },
      "banker_thistle": {
        "name": "Хранитель Тистл",
        "title": "Банкир Блумхейвена",
        "greeting": "Ваши монеты и ценности в безопасности в хранилище, {className}. Сдайте то, что не можете унести, и забирайте, когда будете проходить мимо."
      },
      "cook_ferra": {
        "name": "Ферра",
        "title": "Портовая кухарка",
        "greeting": "У самого пирса щука ходит на глубине, {className}. Купи удочку, налови немного, а я поджарю их прямо на костре."
      },
      "cook_cobb": {
        "name": "Кобб",
        "title": "Портовая кухарка",
        "greeting": "Зеркальное озеро дарит отменную форель терпеливой удочке. Возьми снасть и неси улов к моему костру."
      },
      "rowan_sawtooth": {
        "name": "Роуэн Сотут",
        "title": "Смотритель Шлюза",
        "greeting": "Новое лицо на берегу, {className}. Добро пожаловать на Шлюз, передовой лагерь колонии. Сама Плотина далеко на юге, путь неблизкий, но работа начинается прямо здесь. Оставайся упоротым и берегись воды."
      },
      "hazel_timbers": {
        "name": "Хейзел Тимберс",
        "title": "Квартирмейстер Плотины",
        "greeting": "Инструмент, упряжь и походная еда, всё по честной цене для новичка. Бобёр держит лагерь в строгости, {className}. Что тебе нужно?"
      },
      "boone_cascade": {
        "name": "Бун Каскейд",
    ...
    "quests": {
      "q_first_harvest": {
        "title": "Первый урожай",
        "text": "Все садовники начинают одинаково: грядка, семя и терпение оставить всё как есть. Посади что-нибудь, дай дозреть и принеси мне то, что снимешь. Прежде чем доверить тебе стоящий материал, я хочу посмотреть, как ты обходишься с урожаем.",
        "completion": "Ты только глянь. Обрезано чисто, и нигде не видно спешки. У тебя руки для этой работы.",
        "objectives": {
          "0": {
            "label": "Обычный бутон"
          }
      ...
      "q_stock_run": {
        "title": "Ходка за стоком",
        "text": "Ты закрыл тот постоянный заказ, так что вот чего новичкам не рассказывают: хороший маточник держат не здесь. Он под Холмом Семенохранилища, а хранители открывают только тому лицу, которое община уже знает. Поднимись туда и покажись им. Возвращайся, когда запомнят.",
        "completion": "Теперь тебя знают. Это дороже любого семени, что я мог бы тебе сунуть, хотя времени ты на это угробил немало.",
        "objectives": {
          "0": {
            "label": "Холм Семенохранилища: посещено"
          },
          "1": {
            "label": "Признание общины: получено"
          }
        }
      },
      "q_cuttings_for_the_lodge": {
        "title": "Черенки для Дома",
        "text": "Роуэн ждёт в Доме три порции экстракта, и ждёт их сегодня, потому что экстракт не хранится. Неси прямо вниз и вложи ей в руки. Если свернёшь пострелять койотов, к твоему приходу это будет стоить ровно ничего.",
        "completion": "Донёс, пока был живой. Ты удивишься, сколько растильщиков не справляются даже с этим.",
        "objectives": {
          "0": {
            "label": "Экстракт доставлен Роуэн"
          }
        }
      },
      "q_walk_it_home": {
        "title": "Отведи домой",
        "text": "Один общинный бобр забрался в сушильню и с рассвета сидит в моих грядках совершенно без толку. Пойдёшь медленно, и он потянется следом. Отведи его к плотине на Поляну Брайтвуда и приглядывай по дороге, потому что за собой он не приглядит.",
        "completion": "Дома и дышит. На плотине тебя не поблагодарят, и бобр не поблагодарит, так что поблагодарю я: спасибо.",
        "objectives": {
          "0": {
            "label": "Бобр доведён до Поляны Брайтвуда"
          }
        }
      },
      "q_fine_supply": {
        "title": "Что-нибудь получше",
        "text": "На обычном сырье лампы горят, но никого этим не покоришь. Мне нужен материал получше, а откуда ты его возьмёшь, меня мало заботит. Есть терпение — выведи сам, нет — купи у того, кто вывел. Садовник с деньгами всё равно садовник.",
        "completion": "Вот это уже стоит просушить как следует. Тот, кто это вырастил, знал своё дело. А если это был ты, тем лучше.",
        "objectives": {
          "0": {
            "label": "Отборный бутон"
          }
        }
      },
      "q_prime_order": {
        "title": "Заказ садовника",
        "text": "У меня есть постоянный заказ, который я ни разу не сумел закрыть: только отменное сырьё, ничем не хуже. Для этого нужен сорт, выведенный правильно до самого верха, а значит — либо годы собственных скрещиваний, либо добрые отношения с тем, кто это уже проделал. Так или иначе, закрой его — и на Заимке будут знать твоё имя.",
        "completion": "Шесть отменных. Я ждал этого долгий сезон. Заимка у тебя в долгу, и я тоже.",
        "objectives": {
          "0": {
            "label": "Отменный бутон"
          }
        }
      },
      "q_wolves": {
      ...
      "q_greyrot": {
        "title": "Серая гниль",
        "text": "Здесь Блум не вянет так, как на сухих равнинах, {playerName}. Он тонет. Сереет, размякает, и гниль идёт от корня к корню, пока целая терраса не превращается в жижу. А над каждым тронутым участком уже сносит болотных раздутней. Вскрой десяток на западной отмели и расскажи мне, что из них вышло.",
        "completion": "Споры, говоришь. Плотно уложенные и все одного размера. Это не погода, {playerName}, и не случайность. Кто-то выращивает эту гниль и направляет её на наши сады.",
        "objectives": {
          "0": {
            "label": "Болотный раздутень: убито"
          }
        }
      },
      "q_burn_the_beds": {
        "title": "Выжечь гнёзда",
        "text": "Яра просит целый сезон, чтобы вывести что-то, что перерастёт гниль. У меня нет сезона. У меня есть гать, на которой держатся две сотни человек, и гниль, идущая прямо на неё. Выжги гнёзда раздутней на западной отмели, {playerName}. Двенадцати хватит, чтобы прервать их дрейф. Топь станет беднее, а я всё равно буду спать.",
        "completion": "Отмель в золе, дрейф встал у самой воды. Решение было верным, и Яра теперь месяц со мной не заговорит. Забирай плату.",
        "objectives": {
          "0": {
            "label": "Болотный раздутень: убито"
          }
      ...
      "q_seed_the_shallows": {
        "title": "Засеять отмели",
        "text": "Огонь оставляет отмель голой, а голая земля и есть то, куда гниль пойдёт дальше. Я предпочла бы вытеснить её зеленью. У меня есть черенки, выведенные из блумхейвенского маточника, они укореняются даже в стоячей воде. Но глубинные щелкуны обирают отмели от всего зелёного за сутки. Расчисти двенадцать на восточном берегу, и я высажу черенки.",
        "completion": "Черенки высажены, и вода их пока не тронула. Это медленнее, чем хотелось бы Стражу, и доказать пользу будет ещё медленнее. Но если они удержатся, топь сохранит свою зелень, а не выменяет её на золу.",
        "objectives": {
          "0": {
            "label": "Глубинный щелкун: убито"
          }
      ...
      "q_ash_and_water": {
        "title": "Зола и вода",
        "text": "Выжигание сработало и купило мне новую беду, потому что эта топь платит по долгам именно так. Дым поднял утопших с мелководья, и теперь они стоят в золе на месте гнёзд и не ждут ничего. Уложи десятерых обратно, пока они не нашли гать.",
        "completion": "Зола, и мертвецы, стоящие в ней. Огонь выбрал я, {playerName}, и выбрал бы снова. Но пусть никто не говорит тебе, что это обошлось даром.",
        "objectives": {
          "0": {
      ...
      "q_first_green": {
        "title": "Первая зелень",
        "text": "Черенки принялись, {playerName}. Впервые с тех пор, как поднялась топь, на отмелях есть зелень, и тролли уже спустились с курганов и выдирают её горстями. Отгони десятерых обратно на восток. Каждый день, что эти корни держатся, гниль вынуждена обходить их стороной.",
        "completion": "Всё ещё стоят, всё ещё зелёные. Этот год топи они не спасут. Но моя бабушка посадила блумхейвенскую террасу и тоже не дожила до её цветения, так что я приму полную отмель черенков и назову это хорошим сезоном.",
        "objectives": {
          "0": {
      ...
      "q_sluice_welcome": {
        "title": "Добро пожаловать на Шлюз",
        "text": "Первое, что усвоишь на берегу, {playerName}: бобёр зарабатывает своё место работой, а не глазением. Гнилые волки спускаются с северных склонов, треплют наши поленницы и пугают детёнышей. Проредь шестерых и приходи погреться у огня в домике. Тогда ты один из нас.",
        "completion": "На шесть волков у кромки леса меньше, и ты ни разу не пожаловался. Вот это по-нашему, по-шлюзовски, {playerName}. Огонь твой, бесплатно. Оставайся упоротым, Аризона.",
        "objectives": {
          "0": {
            "label": "Гнилой волк проредён"
          }
        }
      },
      "q_sluice_pilings": {
        "title": "Беда на сваях",
        "text": "Плотина, из-за неё вообще есть пруд, вокруг которого строимся, а щетинистые кабаны с восточного луга всё роют её сваи ради сладкой грязи. Бобёр принимает это как личное, {playerName}. Уложи шестерых копателей, и Шлюз будет должен тебе достойный сувенир, прямиком с самой Плотины.",
        "completion": "Сваи держатся, пруд на месте, детёныши спят спокойно. Вот, {playerName}, жетон Запечённого бобра, вырезанный на самой Плотине. Носи его, и ты колония, куда бы ни забрёл. Оставайся упоротым, Аризона.",
        "objectives": {
          "0": {
            "label": "Щетинистый клык истреблён"
          }
        }
      },
      "q_welcome_dam": {
