...
export const ru_RU: EnTranslations = {
  ...
  "entities": {
    ...
    "items": {
      ...
      "ember_ward_shard": {
        "name": "Осколок солнечного оберега"
      },
      "sunflare_bulb_raw": {
        "name": "Необработанная луковица солнечной вспышки"
      },
      "sunflare_bulb": {
    ...
    "mobs": {
      ...
      "dust_scarab": {
        "name": "Пыльный скарабей"
      },
      "sand_stalker": {
        "name": "Песчаный охотник"
      },
      "sunbleached_husk": {
        "name": "Выбеленная солнцем оболочка"
      },
      "glassback_basilisk": {
        "name": "Стеклоспинный василиск"
      },
      "canyon_shrike": {
        "name": "Каньонный сорокопут"
      },
      "mirage_djinn": {
        "name": "Миражный джинн"
      },
      "emberling": {
        "name": "Угольное отродье"
      },
      "cinder_golem": {
        "name": "Шлаковый голем"
      },
      ...
      "mummified_guard": {
        "name": "Мумифицированный страж"
      },
      "tombscarab_cluster": {
        "name": "Рой гробничных скарабеев"
      },
      "scarab_broodmother": {
        "name": "Матка скарабеев"
      },
      "ironvein_foreman": {
    ...
    "npcs": {
      ...
      "zaida_sunstranded": {
        "name": "Зайда",
        "title": "Застигнутая солнцем",
        "greeting": "Значит, и ты это чувствуешь, жар, что сочится из тех врат? Я прошла через них, {playerName}, и уже не смогла вернуться. За ними лежит мир, где солнце никогда не заходит, Угольные пустоши, и он не щадит неготовых. Сруби волков, которых жар выгнал на эту дорогу, докажи свою сталь, и я открою тебе путь."
      },
      "ember_trademaster": {
        "name": "Кесса",
        "title": "Торговый распорядитель",
        "greeting": "Вода, соль и сталь, путник, вот всё, что продаёт караван-сарай, и всё, что уважают барханы. Купи что нужно, прежде чем выйдешь под то солнце."
      },
      "ember_wayfinder": {
        "name": "Oren",
        "title": "Следопыт",
        "greeting": "Ты прошёл через врата, а значит, уже видел это, {playerName}: солнце, которое не заходит. Древние солнечные обереги вдоль дюнной дороги погасли, и пока они не загорятся вновь, мёртвые не найдут покоя. Помоги мне зажечь первый из них."
      },
      "ember_cultivator": {
        "name": "Сабра",
        "title": "Солнечный садовод",
        "greeting": "{className}, оазис растит цветок, какого не вырастить остальным пустошам: луковицу солнечной вспышки. Принеси мне необработанные луковицы и немного эссенции угольков, и Станция взращивания выманит из них настоящее редкое семя."
      },
      "ember_glassmaker": {
        "name": "Вашти",
        "title": "Стеклодел",
        "greeting": "Осторожнее на дне каньона, {playerName}: стеклоспинные василиски сливаются с обсидианом, пока не окажутся прямо на тебе. Я остаюсь ради жил, тончайшего стеклянного песка во всех мирах, но второй солнечный оберег погребён в щелевом каньоне к северу отсюда, и нечто, укутанное знойным маревом, стережёт его."
      },
      "tidewatcher_ondrel": {
        "name": "Ондрел Вейн",
    ...
    "quests": {
      ...
      "q_ember_intro": {
        "title": "Врата знойного марева",
        "text": "Жар из врат свёл волков южной дороги с ума, {playerName}, и пока с ними не разберутся, никто не встанет здесь лагерем спокойно, а я и подавно. Истреби четверых из них, и я буду знать, что твоя сталь готова к тому, что ждёт за маревом.",
        "completion": "Твёрдая рука и чистое убийство. Хорошо. Пустоши испытают тебя суровее любого волка, {playerName}, но переправу ты заслужил. Ступай сквозь марево, когда будешь готов: на той стороне лежит караван-сарай, и тамошнему следопыту нужен кто-то вроде тебя.",
        "objectives": {
          "0": {
            "label": "Истреблено волков южной дороги"
          }
        }
      },
      "q_ember_ward1": {
        "title": "Зажги солнечный оберег",
        "text": "Первый солнечный оберег стоит разбитым на дюнной дороге к северу от караван-сарая, {playerName}, и песчаные охотники устроили гнездо среди его павших камней. Истреби шестерых из них и собери три осколка оберега из обломков, и я смогу связать оберег заново и дать мёртвым один отрезок дороги, по которому им не пройти.",
        "completion": "Камень оберега впитывает осколки и загорается, и впервые за долгий век один отрезок дюнной дороги отбрасывает тень. Это малая тьма, {playerName}, но это начало. Мёртвые не переступят её.",
        "objectives": {
          "0": {
            "label": "Истреблено песчаных охотников"
          },
          "1": {
            "label": "Собрано осколков солнечного оберега"
          }
        }
      },
      "q_ember_ward2": {
        "title": "Погребённый солнечный оберег",
        "text": "Второй солнечный оберег наполовину погребён в обвалившемся щелевом каньоне к северу от Предела, {playerName}, и стеклоспинные василиски устроили логово в завале над ним. Проредить их, пятерых довольно, и срази восьмерых каньонных сорокопутов, что визгом гонят любого копателя с гребня. Расчисти мне путь, и я сам спущусь к оберегу.",
        "completion": "Гребень тих, логово разбито, {playerName}. Я спустился к оберегу и очистил от песка его камень-средоточие: второй из трёх, тёмный, как был первый. Два зажжены, остался один, и последний там, где культ хранит свой огонь.",
        "objectives": {
          "0": {
            "label": "Истреблено стеклоспинных василисков"
          },
          "1": {
            "label": "Повержено каньонных сорокопутов"
          }
        }
      },
      "q_ember_ward3": {
        "title": "Культ Стоящего Солнца",
        "text": "Теперь ты знаешь, почему солнце не заходит, {playerName}: третий солнечный оберег вовсе не руина. Культ Углей намеренно держит его зажжённым, в своём амфитеатре наверху, в Пепельном Пределе, и каждый пепельный фанатик там питает огонь, что удерживает день. Разбей их круг. Сруби десятерых фанатиков и разбей четырёх шлаковых големов, которых они поднимают из шлака, и я пойму, как глубоко всё зашло.",
        "completion": "Десять фанатиков пали, их големы обращены в шлак, а солнце всё так же висит там, {playerName}. Значит, это правда: оберег здесь не сломан, его УДЕРЖИВАЮТ, и якорь вовсе не на поверхности. Он уходит вниз, в древний город-усыпальницу под дюнами. Именно там всему этому придёт конец.",
        "objectives": {
          "0": {
            "label": "Срублено пепельных фанатиков"
          },
          "1": {
            "label": "Разбито шлаковых големов"
          }
        }
      },
      "q_ember_finale": {
        "title": "Там, где заходит солнце",
        "text": "Якорь уходит вниз, в Погребённую династию, {playerName}, город-усыпальницу, затонувший под дюнами, и в самом его сердце Матка скарабеев обвивает ритуал, что держит солнце в вышине. Это дело не для одного клинка: собери спутников, спустись через амфитеатр культа и сокруши Матку и её выводок. Погаси стоящее солнце.",
        "completion": "Свершилось, {playerName}. Матка недвижима, ритуальный огонь угасает, а над дюнами солнце скользит вниз, к горизонту, которого не касалось целую эпоху. Нынче ночью караван-сарай увидит свой первый настоящий закат и свой первый прохладный рассвет. Ты вернул Угольным пустошам их ночь.",
        "objectives": {
          "0": {
            "label": "Матка скарабеев повержена"
          }
        }
      },
      "q_drowned_choir": {
    ...
    "dungeons": {
      ...
      "the_buried_dynasty": {
        "name": "Погребённая династия",
        "enterText": "Минуя угасающий ритуальный огонь, ты спускаешься в холодный песчаник и сухой шорох тысячи скарабеев, туда, где древнюю династию погребли вместе с её мёртвым солнцем.",
        "leaveText": "Ты поднимаешься обратно через амфитеатр к стоящему свету."
      },
      "drowned_temple": {
        "name": "Утонувший храм",
    ...
    "itemSets": {
      ...
      "sunforged": {
        "name": "Доспех, выкованный солнцем",
        "bonus2": "Увеличивает выносливость на 12.",
        "bonus3": "Увеличивает выносливость на 20."
      },
      "wyrmshadow": {
