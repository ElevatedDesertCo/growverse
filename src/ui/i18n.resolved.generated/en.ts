...
export const en: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "nativeUpdate": {
      ...
      "bodyWithVersion": "Version {version} of Growverse is available. Update now for the latest fixes and improvements.",
      "notNow": "Not now",
      "update": "Update"
    },
    "castBar": {
  ...
  "guide": {
    ...
    "worldPage": {
      "heading": "The world",
      "intro": "Growverse is one continuous land you cross on foot, three zones laid south to north. There is no fast travel, so the journey is part of the adventure.",
      "hub": "Home base",
    ...
    "questsPage": {
      ...
      "storyBody": "From your first errands in Bloomhaven, something is wrong with the dead. A cult is at work, and the trail leads north through every zone. Follow it to learn who stands behind it.",
      ...
      "typeSlayTitle": "Slay",
      "typeSlayBody": "Thin out a pack of beasts or break a cult's hold by defeating a set number of a marked enemy. The first quest in the game, clearing wolves off the Bloomhaven road, is one of these.",
      ...
      "sagaValeBody": "In Bloomhaven the dead will not rest, and the mark behind it belongs to a sect long thought gone. Trace it to a Gravecaller working the chapel crypt, and his own papers point you toward the fen in the north.",
    ...
    "lore": {
      ...
      "aldricBody": "A humble village priest who first names the cult over a defiled grave in Bloomhaven, then follows its trail in person through the marsh and up to the wall at Highwatch. He is the steady heart of the whole campaign.",
  ...
  "delveUi": {
    ...
    "lore": {
      "eastbrook_ledger": "A water-stained page from Bloomhaven's burial ledger. Names crossed out and rewritten in a hand that is not human.",
  ...
  "classDetails": {
    ...
    "lore": {
      "warrior": "Thornguards are the living walls of the Thorn Guild, melee Growers who build Rage as they deal or take damage. They root themselves against heavy blows or crush foes with thorn-forged weapons.",
      "paladin": "Bloomwards are Bloomveil protectors who bless allies, mend wounds with Bloom Light, and guard the weak behind sacred plant-armor.",
      "hunter": "Spiritcallers fight beside a bonded spirit beast, peppering enemies with aimed and rapid shots, slowing them with stinging spores and concussive fire, and shifting spirit-aspects to suit the moment.",
      "rogue": "Sandrunners are Desert Runner scouts who spend Energy and Combo Points on ambushes and finishing strikes from mirage and dust.",
      "priest": "Tidemystics call on Bloom Light to heal and shield allies, while corrupting Flow lets them drain the life of their enemies.",
      "shaman": "Rootspeakers command the elements through the old Roots ways, imbuing weapons with power, shocking enemies with living lightning, and restoring allies with root-idols.",
      "mage": "Embercasters bend Ember, Frost, and relic-Arcane power to destroy enemies, conjure water, and freeze threats in place.",
      "warlock": "Sporebinders bind corrupted spirits, spread mutation and decay curses, and drain life from enemies to endure.",
      "druid": "Bloomshapers channel raw growth, healing wounds, entangling foes with vines, and shifting into spirit-beast forms for defense or damage."
    },
  ...
  "entities": {
    ...
    "items": {
      ...
      "eastbrook_chain_vest": {
        "name": "Bloomhaven Chainmail Vest"
      },
      "valespun_robe": {
        "name": "Valespun Robe"
      },
      ...
      "reins_swift_highfield_alpaca": {
        "name": "Reins of the Swift Highfield Alpaca"
      },
      "reins_swift_ironhide_bull": {
        "name": "Reins of the Swift Ironhide Bull"
      },
      "reins_swift_thornback_boar": {
        "name": "Reins of the Swift Thornback Boar"
      },
      "reins_elder_bloomstrider": {
        "name": "Reins of the Elder Bloomstrider"
      },
