  ...
  "entities": {
    ...
    "npcs": {
      ...
      "zaida_sunstranded": {
        "name": "ザイダ",
        "title": "陽に阻まれし者",
        "greeting": "あんたも感じるんだね、あの門から漏れ出す熱を。私はあれをくぐって来た、{playerName}、そして戻れなくなった。向こうには陽の沈まぬ領域が広がっている。エンバーウェイストだ。あそこは備えのない者を容赦しない。熱に追われてこの道に出てきた狼どもを斬り伏せ、あんたの鋼を示しておくれ。そうすれば道を開いてやる。"
      },
      "ember_trademaster": {
        "name": "ケッサ",
        "title": "交易長",
      ...
      "ember_glassmaker": {
        "name": "ヴァシュティ",
        "title": "ガラス作り",
        "greeting": "峡谷の底では気をつけろ、{playerName}。ガラス背のバジリスクは黒曜石に溶け込み、飛びかかるまで見えぬ。俺がここに留まるのは鉱脈のため、どの世界でも最上のガラス砂だからだ。だが二つ目の日守りはここより北のスロット峡谷に埋もれ、陽炎をまとった何かがそれを守っている。"
      },
      "tidewatcher_ondrel": {
        "name": "オンドレル・ヴェイン",
        "title": "潮見の番人",
    ...
    "quests": {
      ...
      "q_ember_intro": {
        "title": "陽炎揺らめく門",
        "text": "門の熱が南街道の狼どもを半狂乱にしてしまってね、{playerName}。あれを片づけない限り、誰も安心してここで野営できない、この私ですら。四匹を討ち取れば、あんたの鋼が陽炎の向こうで待つものに耐えられると分かる。",
        "completion": "揺るがぬ手、鮮やかな仕留めだ。よし。荒野はどんな狼よりも厳しくあんたを試すだろう、{playerName}、だが渡る資格は勝ち取った。覚悟ができたら陽炎をくぐるがいい。向こう側には隊商宿があり、そこの道導きが、あんたのような者を必要としている。",
        "objectives": {
          "0": {
            "label": "討伐した南街道の狼"
          }
      ...
      "q_ember_ward2": {
        "title": "埋もれた日守り",
        "text": "二つ目の日守りは、リーチの北にある崩れたスロット峡谷に半ば埋もれている、{playerName}。ガラス背のバジリスクがその上の瓦礫に巣を作ってしまった。数を減らせ、五体でよかろう。そして峡谷のモズを八羽討ち取れ。あれは掘り手を金切り声で尾根から追い払う。道を切り開いてくれれば、俺自身が日守りまで降りていける。",
        "completion": "尾根は静まり、巣は打ち砕かれた、{playerName}。俺は日守りまで降り、その焦点石から砂を払った。三つのうちの二つ目、最初と同じく暗かった。二つが灯り、残るは一つ。最後の一つは、教団が炎を守る場所にある。",
        "objectives": {
          "0": {
            "label": "討伐したガラス背のバジリスク"
          },
          "1": {
            "label": "討ち取った峡谷のモズ"
          }
      ...
      "q_ember_ward3": {
        "title": "沈まぬ太陽の教団",
        "text": "なぜ太陽が沈まぬのか、これで分かったろう、{playerName}。三つ目の日守りは廃墟などではない。残り火教団がわざと燃やし続けているのだ。シンダーリーチの高みにある円形劇場でな。そこの灰の狂信者は一人残らず、昼を留めるあの炎に薪をくべている。奴らの円環を打ち破れ。狂信者を十人斬り伏せ、奴らが鉱滓から起こす燃え殻のゴーレムを四体砕け。そうすれば、これがどれほど根深いか分かる。",
        "completion": "狂信者を十人倒し、ゴーレムも鉱滓に還した。それでもなお太陽はあそこに懸かったままだ、{playerName}。やはり本当だった。ここの日守りは壊れているのではない、無理やり保たれているのだ。そして要石は地表にすらない。地の底へ、砂丘の下の古い墓所の都へと続いている。すべてが終わるのはそこだ。",
        "objectives": {
          "0": {
            "label": "斬り伏せた灰の狂信者"
          },
      ...
      "q_ember_finale": {
        "title": "陽の沈む場所",
        "text": "要石は埋もれし王朝へと下っている、{playerName}。砂丘の下に沈んだ墓所の都だ。その中心で、スカラベの母巣が、太陽を高く掲げ続ける儀式にとぐろを巻いている。これは剣一本で済む使いではない。仲間を集め、教団の円形劇場を抜けて降り、母巣とその眷属を打ち砕け。あの沈まぬ太陽を消せ。",
        "completion": "成し遂げたな、{playerName}。母巣は動かなくなり、儀式の火は消えかけ、砂丘の上では、太陽が幾時代も触れなかった地平線へと滑り落ちていく。今宵、隊商宿はまことの黄昏を、そしてはじめての涼やかな夜明けを迎えるだろう。お前はエンバーウェイストに夜を取り戻してやったのだ。",
        "objectives": {
          "0": {
            "label": "討伐したスカラベの母巣"
          }
    ...
    "dungeons": {
      ...
      "the_buried_dynasty": {
        "name": "埋もれし王朝",
        "enterText": "揺らめき消えかける儀式の火を過ぎて、お前は冷たい砂岩の中へ、幾千のスカラベの乾いた擦れ音の中へと降りていく。古き王朝がその死せる太陽とともに葬られた、その底へと。",
        "leaveText": "円形劇場を抜けて、お前は沈まぬ光の中へと登り戻る。"
      },
      "drowned_temple": {
        "name": "溺れし神殿",
