...
export const ja_JP: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "nativeUpdate": {
      "title": "アップデートがあります",
      "body": "Growverse の新しいバージョンが利用可能です。今すぐアップデートして最新の修正と改善を入手しましょう。",
      "bodyWithVersion": "Growverse のバージョン {version} が利用可能です。今すぐアップデートして最新の修正と改善を入手しましょう。",
      "notNow": "後で",
      "update": "更新"
    },
    "castBar": {
  ...
  "guide": {
    ...
    "worldPage": {
      "heading": "世界",
      "intro": "Growverseは、自らの足で歩いて渡る一続きの大地です。南から北へと3つのゾーンが連なっています。ファストトラベルはなく、その旅路こそが冒険の一部です。",
      "hub": "拠点",
      "mapHeading": "北への道",
  ...
  "playerCard": {
    ...
    "shareText": "Growverseで伝説を鍛えています: レベル{level} {className}{tierBit}。私のレルムに参加してください:",
    "nativeShareTitle": "Growverseの世界",
  ...
  "desktop": {
    ...
    "crash": {
      ...
      "reload": "再読み込み",
      "quit": "終了",
      "fatalBody": "Growverse で予期しないエラーが発生したため、終了します。"
    }
  },
  "realm": {
  ...
  "entities": {
    ...
    "npcs": {
      ...
      "rowan_sawtooth": {
        "name": "ローワン・ソウトゥース",
        "title": "ザ・スルースの守り手",
        "greeting": "岸に見ない顔だな、{className}。ようこそザ・スルースへ、群れの前線基地だ。本拠のザ・ダムはずっと南、長い道のりだが、仕事はまさにここから始まる。ステイ・ベイクド、水には気をつけな。"
      },
      "hazel_timbers": {
        "name": "ヘイゼル・ティンバーズ",
        "title": "ダムの糧秣官",
        "greeting": "道具に馬具、それに行動食、どれも新入りに優しい値付けだ。ビーバーの営む隙のない基地さ、{className}。何が入り用だい？"
      },
      "boone_cascade": {
        "name": "ブーン・カスケード",
        "title": "ザ・ダムの長老",
    ...
    "quests": {
      "q_first_harvest": {
        "title": "最初の収穫",
        "text": "育てる者は皆こうして始めるものだ。畝がひとつ、種がひとつ、そして手を出さずに待つ辛抱強さ。何かを植え、最後まで育て切って、そこから採れたものを持ってきてくれ。もっと良い種を預ける前に、君が作物をどう扱うか見ておきたい。",
        "completion": "これは見事だ。丁寧に刈り込まれていて、急いだ跡がどこにもない。君はこの仕事に向いた手をしている。",
        "objectives": {
          "0": {
            "label": "並の花芽"
          }
      ...
      "q_stock_run": {
        "title": "種の買い付け",
        "text": "例の常設注文を埋めたな。では新入りの誰も教えてもらえないことを言おう。良い株はここには置いていない。シードヴォルトの丘の地下だ。そして番人は、共同体がすでに知っている顔にしか開かない。上まで歩いて、顔を見せてこい。向こうが覚えたら戻れ。",
        "completion": "向こうはお前を覚えた。私が渡せるどんな種よりも価値がある。もっとも、ずいぶん時間はかかったがな。",
        "objectives": {
          "0": {
            "label": "シードヴォルトの丘を訪れる"
          },
      ...
      "q_cuttings_for_the_lodge": {
        "title": "ロッジへの挿し穂",
        "text": "ローワンがロッジで抽出物を三つ欲しがっている。しかも今日だ。抽出物は保たないからな。まっすぐ下って、彼女の手に直接渡せ。途中でコヨーテを撃ちに寄り道すれば、着く頃には何の価値もない。",
        "completion": "まだ生きているうちに届いたか。その一事すらできない栽培者がどれだけいるか、驚くぞ。",
        "objectives": {
          "0": {
            "label": "ローワンに抽出物を届ける"
          }
      ...
      "q_walk_it_home": {
        "title": "歩いて帰らせろ",
        "text": "共同体のビーバーが乾燥小屋に入り込んで、日の出からずっと私の苗床に座り込んでいる。まるで役に立たん。ゆっくり歩けばついてくる。ブライトウッドの林間にある巣まで連れて行け。道中は見ていてやれ、自分では自分を見ていられん奴だからな。",
        "completion": "無事に帰り着いたか。巣の連中も礼は言わんし、当のビーバーも言わん。だから私が言う。ありがとう。",
        "objectives": {
          "0": {
            "label": "ビーバーをブライトウッドの林間まで送る"
          }
        }
      },
      "q_fine_supply": {
        "title": "もう少し良いものを",
        "text": "並の品でも灯りは灯せるが、それで誰かを唸らせることはできん。もっと上質な材料が要る。どこで手に入れたかは大して気にしない。辛抱強く自分で交配してもいいし、やり遂げた者から買ってもいい。金を持つ育て手も、やはり育て手だ。",
        "completion": "これならきちんと熟成させる価値がある。これを育てた者は分かっている。それが君なら、なお良い。",
        "objectives": {
          "0": {
            "label": "上質な花芽"
          }
      ...
      "q_prime_order": {
        "title": "栽培者の注文書",
        "text": "一度も満たせたことのない常時注文がある。極上の材料、それ以下は受け付けん。そのためには最後まで正しく交配された系統が要る。つまり自分で何年も交配を重ねるか、すでにやり遂げた誰かと良い関係を築くかだ。どちらにせよ、これを満たせばロッジの誰もが君の名を覚えるだろう。",
        "completion": "極上が六つ。長い季節を待った。ロッジは君に借りができた。私もだ。",
        "objectives": {
          "0": {
            "label": "極上の花芽"
          }
      ...
      "q_greyrot": {
        "title": "灰腐り",
        "text": "ここのブルームは、乾いた平地のようには枯れない、{playerName}。溺れるのだ。灰色にふやけ、腐りは根から根へと歩き、段々畑ひとつがまるごと泥になる。そして色の変わった区画には、必ず沼の膨れ者がもう漂っている。西の浅棚で十匹を裂き、中から何が出たか教えてくれ。",
        "completion": "胞子か。しかもぎっしり詰まって、粒までそろっていたと。それは天候ではないし、運でもない、{playerName}。誰かがこの腐りを育て、我々の畑へ向けている。",
        "objectives": {
          "0": {
            "label": "沼の膨れ者を討伐"
          }
      ...
      "q_burn_the_beds": {
        "title": "苗床を焼き払え",
        "text": "ヤラは腐りに打ち勝つ品種を育てるのに一季ほしいと言う。私に一季はない。あるのは二百人を支える堤道と、そこへまっすぐ歩いてくる腐りだけだ。西の浅棚の膨れ者の苗床を焼け、{playerName}。十二匹も潰せば漂流は止まる。沼は痩せるだろうが、それでも私は眠る。",
        "completion": "浅棚は灰、漂流は水際でぴたりと止まった。正しい判断だった。おかげでヤラはひと月口をきいてくれまい。報酬を持っていけ。",
        "objectives": {
          "0": {
            "label": "沼の膨れ者を討伐"
          }
      ...
      "q_seed_the_shallows": {
        "title": "浅瀬に挿す",
        "text": "火は浅棚を裸にするだけ、そして裸の地こそ腐りが次に向かう先です。私はむしろ緑で押し出したい。ブルームヘイヴンの株から育てた、溜まり水でも根づく挿し穂があります。けれどディープフェンのスナッパーは、浅瀬の緑を一日で食い尽くす。東岸から十二匹を片づけてくれれば、挿し穂を入れます。",
        "completion": "挿し穂は入りました。水はまだそれを腐らせていません。番人の望むより遅く、効くと証すのはもっと遅い。それでも保てば、沼は緑を灰に替えずに済みます。",
        "objectives": {
          "0": {
            "label": "ディープフェンのスナッパーを討伐"
          }
      ...
      "q_ash_and_water": {
        "title": "灰と水",
        "text": "焼き払いは効いた。そして新しい厄介事を買い込んだ。この沼はそうやって借りを返す。煙が溺れ死者を浅瀬から呼び上げ、今や苗床の焼け跡の灰の中に、何を待つでもなく立っている。堤道を見つけられる前に十体を戻してやれ。",
        "completion": "灰と、その中に立つ死者か。火を選んだのは私だ、{playerName}。もう一度でも同じ道を選ぶ。だが、それが只で済んだなどと誰にも言わせるな。",
        "objectives": {
          "0": {
            "label": "溺れ死者を安息させる"
          }
      ...
      "q_first_green": {
        "title": "最初の緑",
        "text": "挿し穂が根づきました、{playerName}。沼が満ちて以来はじめて、浅瀬に緑があります。ところがトロルどもが塚から下りてきて、それを掴んでは剥ぎ取っていく。十匹を東へ追い返してください。あの根が保つ一日ごとに、腐りは一日遠回りを強いられます。",
        "completion": "まだ立っている、まだ緑です。今年の沼を救いはしないでしょう。けれど祖母もブルームヘイヴンの段々畑を植えて、花を見ることはなかった。ですから浅瀬いっぱいの挿し穂を受け取って、よい季節だったと呼びます。",
        "objectives": {
          "0": {
            "label": "マイアフェン・トロルを討伐"
          }
      ...
      "q_sluice_welcome": {
        "title": "ザ・スルースへようこそ",
        "text": "岸で最初に学ぶことだ、{playerName}。ビーバーは働いて居場所を勝ち取る、ぼんやり眺めていてはだめだ。北の斜面からブライト・ウルフが下りてきて、俺たちの薪山を荒らし、子らを怯えさせる。六匹間引いて、ロッジの焚き火で温まりに来い。そうすれば君も仲間だ。",
        "completion": "木立の際に狼が六匹減って、君は一度も弱音を吐かなかった。それがザ・スルースの流儀だ、{playerName}。焚き火は君のもの、タダでな。ステイ・ベイクド、AZ。",
        "objectives": {
          "0": {
            "label": "ブライト・ウルフを間引いた"
          }
      ...
      "q_sluice_pilings": {
        "title": "杭のトラブル",
        "text": "そもそもダムがあるからこそ、その周りに貯水池を築けるんだ。だが東の草地のブリッスル・タスクの猪どもが、甘い泥目当てにその杭を掘り返し続けてな。ビーバーはそれを個人的な恨みと受け取る、{playerName}。掘り屋を六匹仕留めてくれれば、ザ・スルースは君にふさわしい記念の品を、ザ・ダムじきじきの一品を借りとして渡そう。",
        "completion": "杭は持ちこたえ、貯水池はそのまま、子らも安らかに眠る。さあ、{playerName}、ベイクド・ビーバーのトークンだ、ザ・ダムで彫られたものさ。これを持てば、どこをさすらおうと君は群れの一員だ。ステイ・ベイクド、AZ。",
        "objectives": {
          "0": {
            "label": "ブリッスル・タスクを片づけた"
          }
        }
      },
      "q_welcome_dam": {
