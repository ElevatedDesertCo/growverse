...
export const it_IT: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "nativeUpdate": {
      ...
      "body": "È disponibile una nuova versione di Growverse. Aggiorna ora per le ultime correzioni e migliorie.",
      "bodyWithVersion": "La versione {version} di Growverse è disponibile. Aggiorna ora per le ultime correzioni e migliorie.",
      "notNow": "Non ora",
      "update": "Aggiorna"
    },
    "castBar": {
  ...
  "guide": {
    ...
    "worldPage": {
      "heading": "Il mondo",
      "intro": "Growverse è una terra continua che attraversi a piedi, tre zone disposte da sud a nord. Non c'è viaggio rapido, perciò il viaggio è parte dell'avventura.",
      "hub": "Base operativa",
  ...
  "playerCard": {
    ...
    "defaultRealm": "Mondo di Growverse",
    ...
    "shareText": "Sto forgiando la mia leggenda in Growverse: livello {level} {className}{tierBit}. Unisciti al mio reame:",
    "nativeShareTitle": "Mondo di Growverse",
  ...
  "desktop": {
    ...
    "crash": {
      ...
      "reload": "Ricarica",
      "quit": "Esci",
      "fatalBody": "Growverse ha riscontrato un errore imprevisto e deve chiudersi."
    }
  },
  "realm": {
  ...
  "entities": {
    ...
    "items": {
      ...
      "cooked_mirror_trout": {
        "name": "Trota specchio alla griglia"
      },
      "cooked_river_perch": {
        "name": "Persico di fiume in padella"
      },
      "cooked_marsh_pike": {
        "name": "Luccio di palude arrosto"
      },
      "cooked_bog_eel": {
        "name": "Anguilla di palude affumicata"
      },
      "cooked_frostgill_trout": {
        "name": "Trota branchia-gelo alla griglia"
      },
      "cooked_stonescale_carp": {
        "name": "Carpa scaglia-di-pietra al forno"
      },
      "bloom_extract": {
        "name": "Estratto floreale"
      },
      "swirling_healing_draught": {
        "name": "Pozione curativa turbinante"
      },
      "swirling_mana_draught": {
        "name": "Pozione di mana turbinante"
      },
      "elixir_of_the_bloom": {
        "name": "Elisir della fioritura"
      },
      "restful_bloom_tonic": {
        "name": "Tonico Floreale Riposante"
      },
      "lively_bloom_tonic": {
        "name": "Tonico Floreale Vivace"
      },
      "balanced_bloom_tonic": {
        "name": "Tonico Floreale Bilanciato"
      },
      "slow_bloom_lozenge": {
        "name": "Pastiglia a Fioritura Lenta"
      },
      "purple_petal": {
        "name": "Petalo Purpureo"
      },
      "golden_petal": {
        "name": "Petalo Dorato"
      },
      ...
      "cured_flower_fine": {
        "name": "Fiore essiccato pregiato"
      },
      "cured_flower_prime": {
        "name": "Fiore essiccato supremo"
      },
      "pressed_resin_fine": {
        "name": "Resina pressata pregiata"
      },
      "pressed_resin_prime": {
        "name": "Resina pressata suprema"
      },
      "infused_lozenge_fine": {
        "name": "Pastiglia infusa pregiata"
      },
      "infused_lozenge_prime": {
        "name": "Pastiglia infusa suprema"
      },
      "resin_glyph_vigor": {
        "name": "Glifo di resina del vigore"
      },
      "resin_glyph_focus": {
        "name": "Glifo di resina della concentrazione"
      },
      "resin_glyph_warding": {
        "name": "Glifo di resina della protezione"
      },
      "vale_hash": {
        "name": "Hashish della valle"
      },
      "golden_shatter": {
        "name": "Ambra frantumata"
      },
      "live_resin": {
        "name": "Resina viva"
      },
      "bloom_diamonds": {
        "name": "Diamanti di fioritura"
      },
      "epic_bud": {
        "name": "Cima epica"
      },
