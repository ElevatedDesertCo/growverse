...
export const vi_VN: EnTranslations = {
  ...
  "entities": {
    ...
    "items": {
      ...
      "bud_prime": {
        "name": "Búp thượng hạng"
      },
      "cured_flower_fine": {
        "name": "Hoa sấy hảo hạng"
      },
      "cured_flower_prime": {
        "name": "Hoa sấy thượng hạng"
      },
      "pressed_resin_fine": {
        "name": "Nhựa ép hảo hạng"
      },
      "pressed_resin_prime": {
        "name": "Nhựa ép thượng hạng"
      },
      "infused_lozenge_fine": {
        "name": "Viên ngậm ủ hảo hạng"
      },
      "infused_lozenge_prime": {
        "name": "Viên ngậm ủ thượng hạng"
      },
      "resin_glyph_vigor": {
        "name": "Ấn nhựa cây sung mãn"
      },
      "resin_glyph_focus": {
        "name": "Ấn nhựa cây tập trung"
      },
      "resin_glyph_warding": {
