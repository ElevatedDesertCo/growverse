...
export const nl_NL: EnTranslations = {
  ...
  "seo": {
    "title": "Growverse: Web-MMO in Klassieke Stijl",
    "description": "Begin aan een episch avontuur in Growverse, een micro-MMO in klassieke stijl die je rechtstreeks in je browser kunt spelen. Sluit je aan bij een blijvende gedeelde realm, level je klassen op en versla vijanden!",
    "genre": "MMORPG",
  ...
  "entities": {
    ...
    "items": {
      ...
      "bud_prime": {
        "name": "Superieure knop"
      },
      "cured_flower_fine": {
        "name": "Fijne gedroogde bloem"
      },
      "cured_flower_prime": {
        "name": "Superieure gedroogde bloem"
      },
      "pressed_resin_fine": {
        "name": "Fijne geperste hars"
      },
      "pressed_resin_prime": {
        "name": "Superieure geperste hars"
      },
      "infused_lozenge_fine": {
        "name": "Fijne geïnfuseerde pastille"
      },
      "infused_lozenge_prime": {
        "name": "Superieure geïnfuseerde pastille"
      },
      "resin_glyph_vigor": {
        "name": "Harsglief van kracht"
      },
      "resin_glyph_focus": {
        "name": "Harsglief van focus"
      },
      "resin_glyph_warding": {
        "name": "Harsglief van bescherming"
      },
      "vale_hash": {
        "name": "Dalhasj"
      },
