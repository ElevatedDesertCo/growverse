// $GROW holder-tier ladder: the Cultivation Ranks.
//
// A purely cosmetic honor badge derived from how much $GROW a connected wallet
...
// Machine keys are the legacy upstream-$WOC set, kept stable on purpose (see
// src/sim/holder_tier.ts); only the player-visible names/flavors are rebranded.
//
...
export { GROW_MAX_SUPPLY } from '../sim/holder_tier';
...
// The eighteen rungs. Thresholds climb 10x up to Grovekeeper (1% of supply), then
// step by whole percents through the 2%-9% band, then 10% and the full supply.
// Rungs from Cultivator up call out their share of supply in the flavor.
