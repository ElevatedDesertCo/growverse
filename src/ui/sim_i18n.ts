...
const baseEnTable = {
  ...
  'garden.needEpicBuds': 'You need two Epic Buds to cross strains. Tend a crop to earn one.',
  'garden.refine': 'You refine {target} with {donor}.',
  'garden.refineNothing': 'That strain has nothing to add. Pick a stronger donor.',
  'garden.refinePickDifferent': 'Pick a different strain to refine with.',
  'garden.noSuchPlot': 'There is no such garden plot.',
  'garden.plotEmpty': 'That plot is empty.',
  'garden.plotOccupied': 'That plot already has something growing.',
  'garden.notPlantable': 'That is not a plantable seed.',
  'garden.noSeed': "You don't have that seed.",
  'garden.plant': 'You plant {name}.',
  'garden.noStrain': "You don't have that strain.",
  'garden.strainNoSeed': 'That strain has no seed to grow from.',
  'garden.noSeedForStrain': "You don't have a seed to grow that strain.",
  'garden.notReady': 'That plant is not ready to harvest yet.',
  'garden.harvest': 'You harvest {name}.',
  'garden.discovered': 'You have discovered the {name} strain.',
  'garden.tooFarChamber': 'You are too far from the Breeding Chamber.',
  'garden.pickTwo': 'Pick two different strains to cross.',
  'garden.noBothStrains': "You don't have both of those strains.",
  'garden.libraryFull': 'Your strain library is full. Release a strain first.',
  'garden.crossed': 'You cross {a} and {b} into a new {child} strain.',
  'garden.released': 'You release the {name} strain.',
  'garden.repTooLow': 'The commune does not trust you enough for that yet.',
  'trade.cutNoRoom': 'Trade failed: no room for that cut.',
  'cup.tooFar': 'You are too far from the Cup Steward.',
  'cup.already': 'You have already entered this season of the Vale Cup.',
  'cup.needBuds': 'The Cup is judged on buds. Bring a harvest to enter.',
  'cup.notEnough': 'You do not have enough buds to enter the Vale Cup.',
  'cup.entered': 'You enter {strain} in the Vale Cup with {bud}, scoring {score}.',
...
const BASE_DICT: Record<SupportedLanguage, Record<BaseSimMessageKey, string>> = {
  ...
  es: {
    'trade.cutNoRoom': 'El intercambio falló: no hay espacio para ese esqueje.',
    'garden.noSuchPlot': 'No existe esa parcela de jardín.',
    'garden.plotEmpty': 'Esa parcela está vacía.',
    'garden.plotOccupied': 'En esa parcela ya crece algo.',
    'garden.notPlantable': 'Eso no es una semilla plantable.',
    'garden.noSeed': 'No tienes esa semilla.',
    'garden.plant': 'Plantas {name}.',
    'garden.noStrain': 'No tienes esa cepa.',
    'garden.strainNoSeed': 'Esa cepa no tiene semilla de la que crecer.',
    'garden.noSeedForStrain': 'No tienes una semilla para cultivar esa cepa.',
    'garden.notReady': 'Esa planta aún no está lista para cosechar.',
    'garden.harvest': 'Cosechas {name}.',
    'garden.discovered': 'Has descubierto la cepa {name}.',
    'garden.tooFarChamber': 'Estás demasiado lejos de la Cámara de Cría.',
    'garden.pickTwo': 'Elige dos cepas distintas para cruzar.',
    'garden.noBothStrains': 'No tienes ambas cepas.',
    'garden.libraryFull': 'Tu biblioteca de cepas está llena. Libera una cepa primero.',
    'garden.crossed': 'Cruzas {a} y {b} para crear la nueva cepa {child}.',
    'garden.released': 'Liberas la cepa {name}.',
    'garden.repTooLow': 'La comuna aún no confía lo suficiente en ti para eso.',
    ...
    'garden.needEpicBuds':
      'Necesitas dos Cogollos épicos para cruzar cepas. Cuida un cultivo para conseguir uno.',
    'garden.refine': 'Refinas {target} con {donor}.',
    'garden.refineNothing': 'Esa cepa no aporta nada. Elige un donante más fuerte.',
    'garden.refinePickDifferent': 'Elige una cepa distinta para refinar.',
    'cup.tooFar': 'Estás demasiado lejos del Mayordomo de la Copa.',
    'cup.already': 'Ya has participado en esta temporada de la Copa del Valle.',
    'cup.needBuds': 'La Copa se juzga por cogollos. Trae una cosecha para participar.',
    'cup.notEnough': 'No tienes cogollos suficientes para entrar en la Copa del Valle.',
    'cup.entered': 'Presentas {strain} a la Copa del Valle con {bud} y logras {score} puntos.',
  ...
  fr_FR: {
    'trade.cutNoRoom': "Échec de l'échange : pas de place pour cette bouture.",
    'garden.noSuchPlot': "Cette parcelle de jardin n'existe pas.",
    'garden.plotEmpty': 'Cette parcelle est vide.',
    'garden.plotOccupied': 'Quelque chose pousse déjà sur cette parcelle.',
    'garden.notPlantable': "Ce n'est pas une graine plantable.",
    'garden.noSeed': "Vous n'avez pas cette graine.",
    'garden.plant': 'Vous plantez {name}.',
    'garden.noStrain': "Vous n'avez pas cette souche.",
    'garden.strainNoSeed': "Cette souche n'a pas de graine dont pousser.",
    'garden.noSeedForStrain': "Vous n'avez pas de graine pour cultiver cette souche.",
    'garden.notReady': "Cette plante n'est pas encore prête à être récoltée.",
    'garden.harvest': 'Vous récoltez {name}.',
    'garden.discovered': 'Vous avez découvert la souche {name}.',
    'garden.tooFarChamber': 'Vous êtes trop loin de la Chambre de Croisement.',
    'garden.pickTwo': 'Choisissez deux souches différentes à croiser.',
    'garden.noBothStrains': "Vous n'avez pas ces deux souches.",
    'garden.libraryFull': 'Votre bibliothèque de souches est pleine. Libérez-en une.',
    'garden.crossed': 'Vous croisez {a} et {b} pour créer la nouvelle souche {child}.',
    'garden.released': 'Vous libérez la souche {name}.',
    'garden.repTooLow': 'La commune ne vous fait pas encore assez confiance pour cela.',
    ...
    'garden.needEpicBuds':
      'Il vous faut deux Bourgeons épiques pour croiser des souches. Soignez une culture pour en obtenir un.',
    'garden.refine': 'Vous affinez {target} avec {donor}.',
    'garden.refineNothing': "Cette souche n'apporte rien. Choisissez un donneur plus fort.",
    'garden.refinePickDifferent': 'Choisissez une souche différente pour affiner.',
    'cup.tooFar': "Vous etes trop loin de l'Intendant de la Coupe.",
    'cup.already': 'Vous avez deja participe a cette saison de la Coupe du Val.',
    'cup.needBuds': 'La Coupe se juge sur les bourgeons. Apportez une recolte pour participer.',
    'cup.notEnough': "Vous n'avez pas assez de bourgeons pour entrer a la Coupe du Val.",
    'cup.entered': 'Vous presentez {strain} a la Coupe du Val avec {bud} et marquez {score}.',
  ...
  it_IT: {
    'trade.cutNoRoom': 'Scambio fallito: non c’è spazio per quella talea.',
    'garden.noSuchPlot': 'Non esiste quella parcella.',
    'garden.plotEmpty': 'Quella parcella è vuota.',
    'garden.plotOccupied': 'In quella parcella cresce già qualcosa.',
    'garden.notPlantable': 'Quello non è un seme piantabile.',
    'garden.noSeed': 'Non hai quel seme.',
    'garden.plant': 'Pianti {name}.',
    'garden.noStrain': 'Non hai quel ceppo.',
    'garden.strainNoSeed': 'Quel ceppo non ha un seme da cui crescere.',
    'garden.noSeedForStrain': 'Non hai un seme per coltivare quel ceppo.',
    'garden.notReady': 'Quella pianta non è ancora pronta da raccogliere.',
    'garden.harvest': 'Raccogli {name}.',
    'garden.discovered': 'Hai scoperto il ceppo {name}.',
    'garden.tooFarChamber': 'Sei troppo lontano dalla Camera di Incrocio.',
    'garden.pickTwo': 'Scegli due ceppi diversi da incrociare.',
    'garden.noBothStrains': 'Non hai entrambi quei ceppi.',
    'garden.libraryFull': 'La tua libreria di ceppi è piena. Libera prima un ceppo.',
    'garden.crossed': 'Incroci {a} e {b} creando il nuovo ceppo {child}.',
    'garden.released': 'Liberi il ceppo {name}.',
    'garden.repTooLow': 'La comune non si fida ancora abbastanza di te per questo.',
    ...
    'garden.needEpicBuds':
      'Ti servono due Cime epiche per incrociare i ceppi. Cura un raccolto per ottenerne una.',
    'garden.refine': 'Raffini {target} con {donor}.',
    'garden.refineNothing': 'Quel ceppo non aggiunge nulla. Scegli un donatore più forte.',
    'garden.refinePickDifferent': 'Scegli un ceppo diverso da raffinare.',
    'cup.tooFar': 'Sei troppo lontano dal Custode della Coppa.',
    'cup.already': 'Hai gia partecipato a questa stagione della Coppa della Valle.',
    'cup.needBuds': 'La Coppa si giudica sulle cime. Porta un raccolto per partecipare.',
    'cup.notEnough': 'Non hai abbastanza cime per entrare nella Coppa della Valle.',
    'cup.entered': 'Presenti {strain} alla Coppa della Valle con {bud}, totalizzando {score}.',
  ...
  de_DE: {
    'trade.cutNoRoom': 'Handel fehlgeschlagen: kein Platz für diesen Steckling.',
    'garden.noSuchPlot': 'Ein solches Gartenbeet gibt es nicht.',
    'garden.plotEmpty': 'Dieses Beet ist leer.',
    'garden.plotOccupied': 'Auf diesem Beet wächst bereits etwas.',
    'garden.notPlantable': 'Das ist kein pflanzbarer Samen.',
    'garden.noSeed': 'Ihr habt diesen Samen nicht.',
    'garden.plant': 'Ihr pflanzt {name}.',
    'garden.noStrain': 'Ihr habt diese Sorte nicht.',
    'garden.strainNoSeed': 'Diese Sorte hat keinen Samen zum Anbauen.',
    'garden.noSeedForStrain': 'Ihr habt keinen Samen, um diese Sorte anzubauen.',
    'garden.notReady': 'Diese Pflanze ist noch nicht erntereif.',
    'garden.harvest': 'Ihr erntet {name}.',
    'garden.discovered': 'Ihr habt die Sorte {name} entdeckt.',
    'garden.tooFarChamber': 'Ihr seid zu weit von der Zuchtkammer entfernt.',
    'garden.pickTwo': 'Wählt zwei verschiedene Sorten zum Kreuzen.',
    'garden.noBothStrains': 'Ihr habt nicht beide Sorten.',
    'garden.libraryFull': 'Eure Sortensammlung ist voll. Gebt zuerst eine Sorte frei.',
    'garden.crossed': 'Ihr kreuzt {a} und {b} zur neuen Sorte {child}.',
    'garden.released': 'Ihr gebt die Sorte {name} frei.',
    'garden.repTooLow': 'Die Kommune vertraut Euch dafür noch nicht genug.',
    ...
    'garden.needEpicBuds':
      'Ihr braucht zwei Epische Blüten, um Sorten zu kreuzen. Pflegt eine Ernte, um eine zu erhalten.',
    'garden.refine': 'Ihr verfeinert {target} mit {donor}.',
    'garden.refineNothing': 'Diese Sorte bringt nichts ein. Wählt einen stärkeren Spender.',
    'garden.refinePickDifferent': 'Wählt eine andere Sorte zum Verfeinern.',
    'cup.tooFar': 'Ihr seid zu weit vom Verwalter des Pokals entfernt.',
    'cup.already': 'Ihr habt in dieser Saison des Talpokals bereits teilgenommen.',
    'cup.needBuds': 'Der Pokal wird nach Blueten bewertet. Bringt eine Ernte mit.',
    'cup.notEnough': 'Ihr habt nicht genug Blueten fuer den Talpokal.',
    'cup.entered': 'Ihr meldet {strain} mit {bud} zum Talpokal an und erzielt {score}.',
  ...
  zh_CN: {
    'trade.cutNoRoom': '交易失败：没有空间容纳该插枝。',
    'garden.noSuchPlot': '没有这块园圃。',
    'garden.plotEmpty': '那块园圃是空的。',
    'garden.plotOccupied': '那块园圃里已经种了东西。',
    'garden.notPlantable': '那不是可种植的种子。',
    'garden.noSeed': '你没有那种种子。',
    'garden.plant': '你种下了{name}。',
    'garden.noStrain': '你没有那个品系。',
    'garden.strainNoSeed': '那个品系没有可种植的种子。',
    'garden.noSeedForStrain': '你没有种植那个品系所需的种子。',
    'garden.notReady': '那株植物还不能收获。',
    'garden.harvest': '你收获了{name}。',
    'garden.discovered': '你发现了{name}品系。',
    'garden.tooFarChamber': '你离育种室太远了。',
    'garden.pickTwo': '请选择两个不同的品系来杂交。',
    'garden.noBothStrains': '你并不同时拥有这两个品系。',
    'garden.libraryFull': '你的品系库已满。请先释放一个品系。',
    'garden.crossed': '你将{a}与{b}杂交，得到新品系{child}。',
    'garden.released': '你释放了{name}品系。',
    'garden.repTooLow': '公社对你的信任还不足以做到这一点。',
    'garden.tend': '你照料了{name}。',
    'garden.finished': '这株植物已经成熟了。收获它吧。',
    'garden.alreadyTended': '这株植物暂时已经照料过了。',
    'garden.needEpicBuds': '杂交品系需要两枚史诗花苞。照料作物即可获得。',
    'garden.refine': '你用{donor}精炼了{target}。',
    'garden.refineNothing': '那个品系没有可增益之处。换一个更强的供体。',
    'garden.refinePickDifferent': '请选择另一个品系来精炼。',
    'cup.tooFar': '你离山谷杯司仪太远了。',
    'cup.already': '本赛季的山谷杯你已经参赛过了。',
    'cup.needBuds': '山谷杯以花苞评判。带上一季收获再来参赛。',
    'cup.notEnough': '你的花苞不足以参加山谷杯。',
    'cup.entered': '你以{bud}让{strain}参加山谷杯，得分 {score}。',
  ...
  zh_TW: {
    'trade.cutNoRoom': '交易失敗：沒有空間容納該插枝。',
    'garden.noSuchPlot': '沒有這塊園圃。',
    'garden.plotEmpty': '那塊園圃是空的。',
    'garden.plotOccupied': '那塊園圃裡已經種了東西。',
    'garden.notPlantable': '那不是可種植的種子。',
    'garden.noSeed': '你沒有那種種子。',
    'garden.plant': '你種下了{name}。',
    'garden.noStrain': '你沒有那個品系。',
    'garden.strainNoSeed': '那個品系沒有可種植的種子。',
    'garden.noSeedForStrain': '你沒有種植那個品系所需的種子。',
    'garden.notReady': '那株植物還不能收穫。',
    'garden.harvest': '你收穫了{name}。',
    'garden.discovered': '你發現了{name}品系。',
    'garden.tooFarChamber': '你離育種室太遠了。',
    'garden.pickTwo': '請選擇兩個不同的品系來雜交。',
    'garden.noBothStrains': '你並不同時擁有這兩個品系。',
    'garden.libraryFull': '你的品系庫已滿。請先釋放一個品系。',
    'garden.crossed': '你將{a}與{b}雜交，得到新品系{child}。',
    'garden.released': '你釋放了{name}品系。',
    'garden.repTooLow': '公社對你的信任還不足以做到這一點。',
    'garden.tend': '你照料了{name}。',
    'garden.finished': '這株植物已經成熟了。收穫它吧。',
    'garden.alreadyTended': '這株植物暫時已經照料過了。',
    'garden.needEpicBuds': '雜交品系需要兩枚史詩花苞。照料作物即可獲得。',
    'garden.refine': '你用{donor}精煉了{target}。',
    'garden.refineNothing': '那個品系沒有可增益之處。換一個更強的供體。',
    'garden.refinePickDifferent': '請選擇另一個品系來精煉。',
    'cup.tooFar': '你離山谷盃司儀太遠了。',
    'cup.already': '本賽季的山谷盃你已經參賽過了。',
    'cup.needBuds': '山谷盃以花苞評判。帶上一季收穫再來參賽。',
    'cup.notEnough': '你的花苞不足以參加山谷盃。',
    'cup.entered': '你以{bud}讓{strain}參加山谷盃，得分 {score}。',
  ...
  ko_KR: {
    'trade.cutNoRoom': '거래 실패: 그 꺾꽂이를 넣을 자리가 없습니다.',
    'garden.noSuchPlot': '그런 텃밭은 없습니다.',
    'garden.plotEmpty': '그 텃밭은 비어 있습니다.',
    'garden.plotOccupied': '그 텃밭에는 이미 뭔가 자라고 있습니다.',
    'garden.notPlantable': '심을 수 있는 씨앗이 아닙니다.',
    'garden.noSeed': '그 씨앗이 없습니다.',
    'garden.plant': '{name}을(를) 심었습니다.',
    'garden.noStrain': '그 품종이 없습니다.',
    'garden.strainNoSeed': '그 품종은 기를 씨앗이 없습니다.',
    'garden.noSeedForStrain': '그 품종을 기를 씨앗이 없습니다.',
    'garden.notReady': '그 식물은 아직 수확할 수 없습니다.',
    'garden.harvest': '{name}을(를) 수확했습니다.',
    'garden.discovered': '{name} 품종을 발견했습니다.',
    'garden.tooFarChamber': '교배실에서 너무 멀리 떨어져 있습니다.',
    'garden.pickTwo': '교배할 서로 다른 품종 두 개를 고르세요.',
    'garden.noBothStrains': '그 두 품종을 모두 가지고 있지 않습니다.',
    'garden.libraryFull': '품종 보관함이 가득 찼습니다. 먼저 품종을 하나 방출하세요.',
    'garden.crossed': '{a}와(과) {b}을(를) 교배해 새 품종 {child}을(를) 얻었습니다.',
    'garden.released': '{name} 품종을 방출했습니다.',
    'garden.repTooLow': '아직 공동체의 신뢰가 부족합니다.',
    'garden.tend': '{name}을(를) 돌봤습니다.',
    'garden.finished': '그 식물은 다 자랐습니다. 수확하세요.',
    'garden.alreadyTended': '그 식물은 지금은 이미 돌봤습니다.',
    'garden.needEpicBuds':
      '품종을 교배하려면 영웅 꽃봉오리 두 개가 필요합니다. 작물을 돌보면 얻을 수 있습니다.',
    'garden.refine': '{donor}(으)로 {target}을(를) 정제했습니다.',
    'garden.refineNothing': '그 품종은 보탤 것이 없습니다. 더 강한 공여 품종을 고르세요.',
    'garden.refinePickDifferent': '정제할 다른 품종을 고르세요.',
    'cup.tooFar': '밸리 컵 관리인에게서 너무 멀리 떨어져 있습니다.',
    'cup.already': '이번 시즌 밸리 컵에는 이미 출품했습니다.',
    'cup.needBuds': '컵은 꽃봉오리로 심사합니다. 수확물을 가져오세요.',
    'cup.notEnough': '밸리 컵에 출품할 꽃봉오리가 부족합니다.',
    'cup.entered': '{bud}(으)로 {strain}을(를) 밸리 컵에 출품해 {score}점을 얻었습니다.',
  ...
  ja_JP: {
    'trade.cutNoRoom': '取引失敗：その挿し穂を入れる空きがない。',
    'garden.noSuchPlot': 'そのような菜園区画はない。',
    'garden.plotEmpty': 'その区画は空だ。',
    'garden.plotOccupied': 'その区画にはすでに何か育っている。',
    'garden.notPlantable': 'それは植えられる種ではない。',
    'garden.noSeed': 'その種を持っていない。',
    'garden.plant': '{name}を植えた。',
    'garden.noStrain': 'その品種を持っていない。',
    'garden.strainNoSeed': 'その品種には育てる種がない。',
    'garden.noSeedForStrain': 'その品種を育てる種がない。',
    'garden.notReady': 'その株はまだ収穫できない。',
    'garden.harvest': '{name}を収穫した。',
    'garden.discovered': '{name}の品種を発見した。',
    'garden.tooFarChamber': '育種室から離れすぎている。',
    'garden.pickTwo': '交配する異なる品種を二つ選べ。',
    'garden.noBothStrains': 'その二つの品種を両方は持っていない。',
    'garden.libraryFull': '品種ライブラリが満杯だ。先に一つ手放せ。',
    'garden.crossed': '{a}と{b}を交配し、新品種{child}を得た。',
    'garden.released': '{name}の品種を手放した。',
    'garden.repTooLow': 'コミューンの信頼がまだ足りない。',
    'garden.tend': '{name}の世話をした。',
    'garden.finished': 'その株はもう育ちきっている。収穫しろ。',
    'garden.alreadyTended': 'その株は今のところもう世話をした。',
    'garden.needEpicBuds':
      '品種を交配するにはエピックな花蕾が二つ必要だ。作物の世話をすれば手に入る。',
    'garden.refine': '{donor}で{target}を精錬した。',
    'garden.refineNothing': 'その品種に足せるものはない。もっと強い提供元を選べ。',
    'garden.refinePickDifferent': '精錬する別の品種を選べ。',
    'cup.tooFar': 'ヴェイル・カップの世話役から離れすぎている。',
    'cup.already': '今季のヴェイル・カップにはもう出品している。',
    'cup.needBuds': 'カップは花蕾で審査される。収穫を持ってこい。',
    'cup.notEnough': 'ヴェイル・カップに出品するには花蕾が足りない。',
    'cup.entered': '{bud}で{strain}をヴェイル・カップに出品し、{score}点を得た。',
  ...
  pt_BR: {
    'trade.cutNoRoom': 'Troca falhou: sem espaço para essa muda.',
    'garden.noSuchPlot': 'Não existe esse canteiro.',
    'garden.plotEmpty': 'Esse canteiro está vazio.',
    'garden.plotOccupied': 'Nesse canteiro já cresce algo.',
    'garden.notPlantable': 'Isso não é uma semente plantável.',
    'garden.noSeed': 'Você não tem essa semente.',
    'garden.plant': 'Você planta {name}.',
    'garden.noStrain': 'Você não tem essa linhagem.',
    'garden.strainNoSeed': 'Essa linhagem não tem semente para cultivar.',
    'garden.noSeedForStrain': 'Você não tem uma semente para cultivar essa linhagem.',
    'garden.notReady': 'Essa planta ainda não está pronta para a colheita.',
    'garden.harvest': 'Você colhe {name}.',
    'garden.discovered': 'Você descobriu a linhagem {name}.',
    'garden.tooFarChamber': 'Você está longe demais da Câmara de Cruzamento.',
    'garden.pickTwo': 'Escolha duas linhagens diferentes para cruzar.',
    'garden.noBothStrains': 'Você não tem as duas linhagens.',
    'garden.libraryFull': 'Sua biblioteca de linhagens está cheia. Libere uma primeiro.',
    'garden.crossed': 'Você cruza {a} e {b} criando a nova linhagem {child}.',
    'garden.released': 'Você libera a linhagem {name}.',
    'garden.repTooLow': 'A comuna ainda não confia o bastante em você para isso.',
    ...
    'garden.needEpicBuds':
      'Você precisa de dois Botões épicos para cruzar linhagens. Cuide de uma plantação para ganhar um.',
    'garden.refine': 'Você refina {target} com {donor}.',
    'garden.refineNothing': 'Essa linhagem não acrescenta nada. Escolha um doador mais forte.',
    'garden.refinePickDifferent': 'Escolha uma linhagem diferente para refinar.',
    'cup.tooFar': 'Voce esta longe demais do Mordomo da Taca.',
    'cup.already': 'Voce ja participou desta temporada da Taca do Vale.',
    'cup.needBuds': 'A Taca e julgada por botoes. Traga uma colheita para participar.',
    'cup.notEnough': 'Voce nao tem botoes suficientes para entrar na Taca do Vale.',
    'cup.entered': 'Voce inscreve {strain} na Taca do Vale com {bud}, marcando {score}.',
  ...
  ru_RU: {
    'trade.cutNoRoom': 'Обмен не удался: нет места для этого черенка.',
    'garden.noSuchPlot': 'Такой грядки нет.',
    'garden.plotEmpty': 'Эта грядка пуста.',
    'garden.plotOccupied': 'На этой грядке уже что-то растёт.',
    'garden.notPlantable': 'Это не пригодное для посадки семя.',
    'garden.noSeed': 'У вас нет такого семени.',
    'garden.plant': 'Вы сажаете {name}.',
    'garden.noStrain': 'У вас нет такого штамма.',
    'garden.strainNoSeed': 'У этого штамма нет семени для посадки.',
    'garden.noSeedForStrain': 'У вас нет семени, чтобы вырастить этот штамм.',
    'garden.notReady': 'Это растение ещё не готово к сбору.',
    'garden.harvest': 'Вы собираете {name}.',
    'garden.discovered': 'Вы открыли штамм {name}.',
    'garden.tooFarChamber': 'Вы слишком далеко от Селекционной камеры.',
    'garden.pickTwo': 'Выберите два разных штамма для скрещивания.',
    'garden.noBothStrains': 'У вас нет обоих этих штаммов.',
    'garden.libraryFull': 'Библиотека штаммов заполнена. Сначала отпустите штамм.',
    'garden.crossed': 'Вы скрещиваете {a} и {b} и получаете новый штамм {child}.',
    'garden.released': 'Вы отпускаете штамм {name}.',
    'garden.repTooLow': 'Община пока не доверяет вам настолько.',
    ...
    'garden.needEpicBuds':
      'Для скрещивания нужны два Эпических бутона. Ухаживайте за посевом, чтобы получить один.',
    'garden.refine': 'Вы улучшаете {target} с помощью {donor}.',
    'garden.refineNothing': 'Этот штамм ничего не добавит. Выберите донора посильнее.',
    'garden.refinePickDifferent': 'Выберите другой штамм для улучшения.',
    'cup.tooFar': 'Вы слишком далеко от Распорядителя Кубка.',
    'cup.already': 'В этом сезоне Кубка Долины вы уже участвовали.',
    'cup.needBuds': 'Кубок судят по бутонам. Принесите урожай, чтобы участвовать.',
    'cup.notEnough': 'У вас не хватает бутонов для участия в Кубке Долины.',
    'cup.entered': 'Вы выставляете {strain} на Кубок Долины с {bud}, набрав {score}.',
...
export const QUEST_EXTRA: Record<SupportedLanguage, Record<QuestExtraKey, string>> = {
  en: {
    ...
    aldrenYell: '{name} yells, "None shall disturb the king\'s rest! For Thornreach!"',
  ...
  es: {
    ...
    aldrenYell: '{name} grita: "¡Nadie perturbará el descanso del rey! ¡Por Thornreach!"',
  ...
  fr_FR: {
    ...
    aldrenYell: '{name} crie: "Nul ne troublera le repos du roi! Pour Thornreach!"',
  ...
  it_IT: {
    ...
    aldrenYell: '{name} grida: "Nessuno disturberà il riposo del re! Per Thornreach!"',
  ...
  de_DE: {
    ...
    aldrenYell: '{name} ruft: "Niemand stört die Ruhe des Königs! Für Thornreach!"',
  ...
  zh_CN: {
    ...
    awakens: '{name}苏醒了！',
    aldrenYell: '{name}喊道：“谁也不得惊扰国王的安眠！为了 Thornreach！”',
  ...
  zh_TW: {
    ...
    awakens: '{name}甦醒了！',
    aldrenYell: '{name}喊道：「誰也不得驚擾國王的安眠！為了 Thornreach！」',
  ...
  ko_KR: {
    ...
    aldrenYell: '{name}이(가) 외칩니다. "누구도 왕의 안식을 방해할 수 없다! Thornreach를 위하여!"',
    malricYell:
  ...
  ja_JP: {
    ...
    awakens: '{name}が目覚めた！',
    aldrenYell: '{name}が叫ぶ。「王の眠りを乱す者は許さぬ！ Thornreachのために！」',
  ...
  pt_BR: {
    ...
    aldrenYell: '{name} grita: "Ninguém perturbará o descanso do rei! Por Thornreach!"',
  ...
  ru_RU: {
    ...
    aldrenYell: '{name} кричит: "Никто не потревожит покой короля! За Thornreach!"',
    malricYell:
...
const RULES: Rule[] = [
  ...
  {
    re: /^Fallen Captain Aldren yells, "None shall disturb the king's rest! For Thornreach!"$/,
  ...
  {
    re: /^You plant (.+)\.$/,
    build: (m) => tSim('garden.plant', { name: m[1] }),
  },
  {
    re: /^You harvest (.+)\.$/,
    build: (m) => tSim('garden.harvest', { name: m[1] }),
  },
  {
    re: /^You have discovered the (.+) strain\.$/,
    build: (m) => tSim('garden.discovered', { name: m[1] }),
  },
  {
    re: /^You cross (.+) and (.+) into a new (.+) strain\.$/,
    build: (m) => tSim('garden.crossed', { a: m[1], b: m[2], child: m[3] }),
  },
  {
    re: /^You release the (.+) strain\.$/,
    build: (m) => tSim('garden.released', { name: m[1] }),
  },
  {
    re: /^You refine (.+) with (.+)\.$/,
    build: (m) => tSim('garden.refine', { target: m[1], donor: m[2] }),
  },
  {
    re: /^You enter (.+) in the Vale Cup with (.+), scoring (\d+)\.$/,
    build: (m) => tSim('cup.entered', { strain: m[1], bud: m[2], score: m[3] }),
  },
  {
