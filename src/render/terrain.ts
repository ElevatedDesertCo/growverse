...
> = {
  // Bloomhaven Vale is a sun-baked desert: warm ochre "grass" base, bleached
  // highlights, packed reddish dirt, pale dune sand at the shoreline oases.
  vale: {
    grass: 0xc2a662,
    grassDark: 0x9c7f45,
    grassYellow: 0xd8c078,
    dirt: 0xa17a48,
    sand: 0xdcc793,
  },
  marsh: {
...
const ROCK_SLOPE_START: Record<BiomeId, number> = { vale: 0.5, marsh: 0.62, peaks: 0.45 };
