...
// Neutral fallbacks; a real deploy overrides these via GOOGLE_PLAY_INTEGRITY_PACKAGE_NAME
// (Android) and APPLE_BUNDLE_ID (iOS).
const DEFAULT_PACKAGE_NAME = 'com.elevateddesertco.growverse';
const DEFAULT_BUNDLE_ID = 'com.elevateddesertco.growverse';
