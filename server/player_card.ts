...
export const PUBLIC_CARD_COPY: Record<PublicCardLocale, PublicCardCopy> = {
  en: {
    ...
    description: '{name} is forging a legend in Growverse. Join the realm.',
  ...
  es: {
    ...
    description: '{name} está forjando una leyenda en Growverse. Únete al reino.',
    ...
    missingCta: 'Entrar en Growverse',
    classes: {
      warrior: 'Guerrero',
      paladin: 'Paladín',
      hunter: 'Cazador',
  ...
  fr_FR: {
    ...
    description: '{name} forge sa légende dans Growverse. Rejoignez le royaume.',
    ...
    missingCta: 'Entrer dans Growverse',
    classes: {
      warrior: 'Guerrier',
      paladin: 'Paladin',
      hunter: 'Chasseur',
  ...
  it_IT: {
    ...
    description: '{name} sta forgiando una leggenda in Growverse. Entra nel reame.',
  ...
  de_DE: {
    ...
    description: '{name} schmiedet eine Legende in Growverse. Betretet das Reich.',
  ...
  zh_CN: {
    ...
    description: '{name} 正在 Growverse 中铸就传奇。加入这个国度。',
    cta: '铸就你的传奇',
    missingTitle: '未找到卡片',
    missingHeading: '这张卡片已不可用。',
    missingDescription: '它可能已被撤下，或从未存在。',
    missingCta: '进入 Growverse',
    classes: {
      warrior: '战士',
      paladin: '圣骑士',
      hunter: '猎人',
  ...
  zh_TW: {
    ...
    description: '{name} 正在 Growverse 中鑄就傳奇。加入這個國度。',
    cta: '鑄就你的傳奇',
    missingTitle: '找不到卡片',
    missingHeading: '這張卡片已不可用。',
    missingDescription: '它可能已被移除，或從未存在。',
    missingCta: '進入 Growverse',
    classes: {
      warrior: '戰士',
      paladin: '聖騎士',
      hunter: '獵人',
  ...
  pt_BR: {
    ...
    description: '{name} está forjando uma lenda em Growverse. Entre no reino.',
    cta: 'Forje sua lenda',
    ...
    missingCta: 'Entrar em Growverse',
    classes: {
      warrior: 'Guerreiro',
      paladin: 'Paladino',
      hunter: 'Caçador',
  ...
  ru_RU: {
    ...
    description: '{name} создает легенду в Growverse. Присоединяйтесь к миру.',
